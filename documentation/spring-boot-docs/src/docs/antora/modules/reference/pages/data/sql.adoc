...
If the {url-spring-data-jpa-site}[`spring-data-envers`] module from Spring Data JPA is available, JPA repositories are auto-configured to support typical Envers queries.
