...
NOTE: The CNB builder used for the images is `paketobuildpacks/ubuntu-resolute-builder:latest`, and the run image defaults to `paketobuildpacks/ubuntu-resolute-run-tiny:latest`.
