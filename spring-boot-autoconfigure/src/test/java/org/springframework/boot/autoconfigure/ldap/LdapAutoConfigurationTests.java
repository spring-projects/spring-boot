...
public class LdapAutoConfigurationTests {
	...
	public void testContextSourceWithMoreProperties() {
		load("spring.ldap.urls:ldap://localhost:123", "spring.ldap.username:root", "spring.ldap.password:root",
	...
	private void load(String... properties) {
		...
		this.context.register(LdapAutoConfiguration.class, PropertyPlaceholderAutoConfiguration.class);
