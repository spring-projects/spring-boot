...
public class KafkaAutoConfigurationTests {
	...
	public void consumerProperties() {
		load("spring.kafka.bootstrap-servers=foo:1234", "spring.kafka.properties.foo=bar",
				...
				"spring.kafka.ssl.keystore-password=p2", "spring.kafka.ssl.truststore-location=classpath:tsLoc",
				"spring.kafka.ssl.truststore-password=p3", "spring.kafka.consumer.auto-commit-interval=123",
				...
				"spring.kafka.consumer.fetch-min-size=789", "spring.kafka.consumer.group-id=bar",
		...
		Map<String, Object> configs = (Map<String, Object>) new DirectFieldAccessor(consumerFactory)
	...
	public void producerProperties() {
		load("spring.kafka.clientId=cid", "spring.kafka.producer.acks=all", "spring.kafka.producer.batch-size=20",
		...
		@SuppressWarnings("unchecked")
		Map<String, Object> configs = (Map<String, Object>) new DirectFieldAccessor(producerFactory)
				.getPropertyValue("configs");
		// common
	...
	public void listenerProperties() {
		load("spring.kafka.template.default-topic=testTopic", "spring.kafka.listener.ack-mode=MANUAL",
