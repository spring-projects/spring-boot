...
public class GroovyTemplateAutoConfigurationTests {
	...
	public void disableViewResolution() throws Exception {
		EnvironmentTestUtils.addEnvironment(this.context, "spring.groovy.template.enabled:false");
		registerAndRefreshContext();
	...
	public void customConfiguration() throws Exception {
		...
		assertThat(this.context.getBean(GroovyMarkupConfigurer.class).isAutoIndent()).isEqualTo(true);
	}
