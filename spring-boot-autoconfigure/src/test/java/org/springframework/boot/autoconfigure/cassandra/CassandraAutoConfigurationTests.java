...
public class CassandraAutoConfigurationTests {
	...
	public void createCustomizeCluster() {
		...
		assertThat(this.context.getBeanNamesForType(Cluster.class).length).isEqualTo(1);
		assertThat(this.context.getBeanNamesForType(ClusterBuilderCustomizer.class).length).isEqualTo(1);
	}
	...
	private void load(Class<?> config, String... environment) {
		...
		ctx.register(PropertyPlaceholderAutoConfiguration.class, CassandraAutoConfiguration.class);
