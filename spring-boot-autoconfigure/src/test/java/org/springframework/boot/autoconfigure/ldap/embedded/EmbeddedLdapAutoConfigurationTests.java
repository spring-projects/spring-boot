...
public class EmbeddedLdapAutoConfigurationTests {
	...
	public void testRandomPortWithEnvironment() throws LDAPException {
		...
		assertThat(server.getListenPort())
				.isEqualTo(this.context.getEnvironment().getProperty("local.ldap.port", Integer.class));
	}
	...
	public void testRandomPortWithValueAnnotation() throws LDAPException {
		...
		this.context.register(EmbeddedLdapAutoConfiguration.class, LdapClientConfiguration.class,
	...
	public void testSetCredentials() throws LDAPException {
		load("spring.ldap.embedded.base-dn:dc=spring,dc=org", "spring.ldap.embedded.credential.username:uid=root",
	...
	public void testQueryEmbeddedLdap() throws LDAPException {
		EnvironmentTestUtils.addEnvironment(this.context, "spring.ldap.embedded.base-dn:dc=spring,dc=org");
		this.context.register(EmbeddedLdapAutoConfiguration.class, LdapAutoConfiguration.class,
				LdapDataAutoConfiguration.class, PropertyPlaceholderAutoConfiguration.class);
		this.context.refresh();
	...
	public void testDisableSchemaValidation() throws LDAPException {
		load("spring.ldap.embedded.validation.enabled:false", "spring.ldap.embedded.base-dn:dc=spring,dc=org");
		InMemoryDirectoryServer server = this.context.getBean(InMemoryDirectoryServer.class);
	...
	private void load(String... properties) {
		...
		this.context.register(EmbeddedLdapAutoConfiguration.class, PropertyPlaceholderAutoConfiguration.class);
		this.context.refresh();
	}
