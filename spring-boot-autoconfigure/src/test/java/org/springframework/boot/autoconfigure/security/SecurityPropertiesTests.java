...
public class SecurityPropertiesTests {
	...
	public void testDefaultPasswordAutogeneratedIfUnresolvedPlaceholder() {
		this.binder.bind(
				new MutablePropertyValues(Collections.singletonMap("security.user.password", "${ADMIN_PASSWORD}")));
		assertThat(this.binder.getBindingResult().hasErrors()).isFalse();
	...
	public void testCsrf() {
		...
		this.binder.bind(new MutablePropertyValues(Collections.singletonMap("security.enable-csrf", true)));
