...
public class ResourcePropertiesBindingTests {
	...
	public void staticLocationsExpandArray() {
		ResourceProperties properties = load("spring.resources.static-locations[0]=classpath:/one/",
		...
		assertThat(properties.getStaticLocations()).contains("classpath:/one/", "classpath:/two/", "classpath:/three/",
				"classpath:/four/", "classpath:/five/", "classpath:/six/");
	}
