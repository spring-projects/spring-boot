...
public class KafkaProperties {
	...
	public static class Listener {
		...
		/**
		 * The number of records between offset commits when ackMode is COUNT or COUNT_TIME.
		 */
		private Integer ackCount;

		/**
		 * The time in milliseconds between offset commits when ackMode is TIME or COUNT_TIME.
		 */
