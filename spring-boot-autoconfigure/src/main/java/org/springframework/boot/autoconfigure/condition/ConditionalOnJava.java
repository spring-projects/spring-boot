...
public @interface ConditionalOnJava {
	...
	/**
	 * Configures whether the value configued in {@link #value()} shall be considered the
	...
	/**
	 * The {@link JavaVersion} to check for. Use {@link #range()} to specifiy whether the
	 * configured value is upper exclusive or lower inclusive boundary.
	 * 
	 * @return
	 */
	JavaVersion value();
	...
	public enum Range {
		...
		public String getMessage(JavaVersion version) {
			return String.format(message, version);
		}
	}
