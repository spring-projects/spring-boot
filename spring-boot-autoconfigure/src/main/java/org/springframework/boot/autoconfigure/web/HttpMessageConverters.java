...
public class HttpMessageConverters implements Iterable<HttpMessageConverter<?>> {
	...
	public HttpMessageConverters(boolean addDefaultConverters, Collection<HttpMessageConverter<?>> converters) {
		List<HttpMessageConverter<?>> combined = getCombinedConverters(converters,
				addDefaultConverters ? getDefaultConverters() : Collections.<HttpMessageConverter<?>>emptyList());
	...
	private List<HttpMessageConverter<?>> getCombinedConverters(Collection<HttpMessageConverter<?>> converters,
		...
		List<HttpMessageConverter<?>> processing = new ArrayList<HttpMessageConverter<?>>(converters);
