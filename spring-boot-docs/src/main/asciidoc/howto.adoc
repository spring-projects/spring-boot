...
The values specified via the Java API override properties defined in external configuration
with the notable exception of the sources used to create the `ApplicationContext`. Let's
