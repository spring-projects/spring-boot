...
Add a `org.apache.catalina.connector.Connector` to the `TomcatEmbeddedServletContainerFactory`
which can allow multiple connectors eg a HTTP and HTTPS connector:
...
----
    ...
    public EmbeddedServletContainerFactory servletContainer() {
        ...
        final String keystoreFile = "src/ssl/keystore";
        final String keystorePass = "changeit";
        final String truststoreFile = "src/ssl/truststore";
        final String truststorePass = "changeit";
        final String privateKeyAlias = "tomcat";
