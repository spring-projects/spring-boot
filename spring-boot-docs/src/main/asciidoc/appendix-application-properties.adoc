...
----
	...
	# Mybatis ({sc-spring-boot-autoconfigure}/mybatis/MybatisProperties.{sc-ext}[MybatisProperties]
	spring.mybatis.config= # mybatis config file
	spring.mybatis.check-config-location= # check the mybatis configuration exists
	spring.mybatis.executor-type= # mode of execution. Default is SIMPLE
