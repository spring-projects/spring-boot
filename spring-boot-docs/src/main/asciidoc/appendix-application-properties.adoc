...
----
	...
	# Each of these properties apply to both producers and consumers, but can be specified at the producer or
	# consumer level.
	...
	spring.kafka.consumer.auto-commit-interval-ms=
	...
	spring.kafka.listener.pollTimeout=1000
	...
	spring.kafka.producer.timeout-ms=
