...
----
	...
	spring.cache.type= # ehcache, generic, guava, hazelcast, jcache, redis, simple
	spring.cache.config= #
	spring.cache.cache-names= #

	# SPRING JCACHE CACHE
	spring.cache.jcache.provider= # fully-qualified name from caching provider (i.e: com.hazelcast.cache.HazelcastCachingProvider)
