...
----
	...
	spring.mobile.devicedelegatingviewresolver.enabled=false # disabled by default
	spring.mobile.devicedelegatingviewresolver.enable-fallback=false # enable support for fallback resolution, default to false.
