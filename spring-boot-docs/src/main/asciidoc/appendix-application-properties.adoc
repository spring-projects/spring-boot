...
----
	...
	management.health.heapmemory.enabled=true # Enable heap memory health check
	management.health.heapmemory.memoryMXBean= # MemoryMXBean used to compute the available heap memory
	management.health.heapmemory.threshold=0.05 # Minimum heap memory that should be available as a ratio
	management.health.jms.enabled=true # Enable JMS health check.
	management.health.mail.enabled=true # Enable Mail health check.
	management.health.mongo.enabled=true # Enable MongoDB health check.
	management.health.nonheapmemory.enabled=true # Enable non-heap memory health check
	management.health.nonheapmemory.memoryMXBean= # MemoryMXBean used to compute the available non-heap memory
	management.health.nonheapmemory.threshold=0.05 # Minimum non-heap memory that should be available as a ratio
