...
----
	...
	spring.data.neo4j.indexes.dump.filename=generated_indexes.cql # Configure the file where constraints and indexes will be generated.
	spring.data.neo4j.indexes.dump.dir=. # Configure the directory where constraints and indexes will be generated.
