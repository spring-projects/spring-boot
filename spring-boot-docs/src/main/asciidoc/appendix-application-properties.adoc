...
----
	...
	spring.kafka.bootstrap-servers=localhost:9092 # A comma-delimited list of host:port pairs.
	spring.kafka.client-id= # An id to pass to the server when making requests; used for server-side logging.
	spring.kafka.ssl-key-password= # The password of the private key in the key store file.
	spring.kafka.ssl-keystore-location= # The location (resource) of the key store file (e.g. file:my.ks).
	spring.kafka.ssl-keystore-password= # The store password for the key store file.
	spring.kafka.ssl-truststore-location= # The location (resource) of the trust store file (e.g. file:my.ts).
	spring.kafka.ssl-truststore-password= # The store password for the trust store file.
	# Consumer-specific properties:
	spring.kafka.consumer.auto-commit-interval-ms= # The frequency in milliseconds that the consumer offsets are auto-committed.
	...
	spring.kafka.consumer.bootstrap-servers= # A comma-delimited list of host:port pairs.
	spring.kafka.consumer.client-id= # An id to pass to the server when making requests; used for server-side logging.
	spring.kafka.consumer.enable-auto-commit= # If true the consumer's offset will be periodically committed in the background.
	spring.kafka.consumer.fetch-max-wait-ms= # The maximum amount of time the server will block before answering the fetch request.
	spring.kafka.consumer.fetch-min-bytes= # The minimum amount of data the server should return for a fetch request.
	spring.kafka.consumer.group-id= # A unique string that identifies the consumer group this consumer belongs to.
	spring.kafka.consumer.heartbeat-interval-ms= # The expected time between heartbeats to the consumer coordinator.
	spring.kafka.consumer.key-deserializer=StringDeserializer # Deserializer class for keys.
	spring.kafka.consumer.ssl-key-password= # The password of the private key in the key store file.
	spring.kafka.consumer.ssl-keystore-location= # The location (resource) of the key store file (e.g. file:my.ks).
	spring.kafka.consumer.ssl-keystore-password= # The store password for the key store file.
	spring.kafka.consumer.ssl-truststore-location= # The location (resource) of the trust store file (e.g. file:my.ts).
	spring.kafka.consumer.ssl-truststore-password= # The store password for the trust store file.
	...
	spring.kafka.listener.ack-mode=BATCH # The AckMode - see the spring-kafka documentation.
	spring.kafka.listener.ack-count= # The number of records between offset commits when ack-mode is COUNT or COUNT_TIME.
	spring.kafka.listener.ack-time= # The time in milliseconds between offset commits when ack-mode is TIME or COUNT_TIME.
	spring.kafka.listener.concurrency=1 # The number of threads to run in the listener container(s).
	spring.kafka.listener.pollTimeout=1000 # The timeout in milliseconds to use when polling the consumer.
	# Producer-specific properties:
	spring.kafka.producer.acks= # The number of acknowledgments the producer requires the leader to have received.
	spring.kafka.producer.batch-size= # The number of records to batch before sending.
	spring.kafka.producer.bootstrap-servers= # A comma-delimited list of host:port pairs.
	spring.kafka.producer.buffer-memory= # The total bytes of memory the producer can use to buffer records waiting to be sent to the server.
	spring.kafka.producer.client-id= # An id to pass to the server when making requests; used for server-side logging.
	spring.kafka.producer.compression-type= # The compression type for all data generated by the producer.
	spring.kafka.producer.key-serializer=StringSerializer # Serializer class for keys.
	spring.kafka.producer.retries= # When greater than zero, enables retrying of failed sends.
	spring.kafka.producer.ssl-key-password= # The password of the private key in the key store file.
	spring.kafka.producer.ssl-keystore-location= # The location (resource) of the key store file (e.g. file:my.ks).
	spring.kafka.producer.ssl-keystore-password= # The store password for the key store file.
	spring.kafka.producer.ssl-truststore-location= # The location (resource) of the trust store file (e.g. file:my.ts).
	spring.kafka.producer.ssl-truststore-password= # The store password for the trust store file.
