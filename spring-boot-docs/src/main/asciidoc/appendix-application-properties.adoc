...
----
	...
	# KAFKA ({sc-spring-boot-autoconfigure}/kafka/KafkaProperties.{sc-ext}[KafkaProperties])
	...
	# Listener properties - Refer to the Spring Kafka documentation
	spring.kafka.listener.ackMode=BATCH # The AckMode - see the spring-kafka documentation.
	...
	# template properties
	spring.kafka.template.defaultTopic= # default topic to which messages are sent
