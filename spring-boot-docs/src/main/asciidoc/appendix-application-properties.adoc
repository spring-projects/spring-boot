...
----
	...
	# SPRING MVC ({sc-spring-boot-autoconfigure}/web/WebMvcProperties.{sc-ext}[WebMvcProperties], {sc-spring-boot-autoconfigure}/web/ResourceProperties.{sc-ext}[ResourceProperties])
