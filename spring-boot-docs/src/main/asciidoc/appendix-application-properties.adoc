...
----
    ...
    spring.gson.version= # Configures Gson to enable versioning support.
    spring.gson.exclude-fields-with-modifiers= # Configures Gson to excludes all class fields that have the specified modifiers.
