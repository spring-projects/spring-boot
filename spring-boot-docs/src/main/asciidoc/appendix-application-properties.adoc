...
----
	...
	# SPRING SOCIAL GOOGLE ({sc-spring-boot-autoconfigure}/social/GoogleAutoConfiguration.{sc-ext}[GoogleAutoConfiguration])
	spring.social.google.app-id= # your application's Google App ID
	spring.social.google.app-secret= # your application's Google App Secret
