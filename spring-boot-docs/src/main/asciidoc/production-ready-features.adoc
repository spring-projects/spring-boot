...
particular, it will not work with Jersey unless you enable Spring MVC as well (see the
<<howto.adoc#howto-make-actuator-and-jersey-work, how-to>> section for some details related to that).
--
