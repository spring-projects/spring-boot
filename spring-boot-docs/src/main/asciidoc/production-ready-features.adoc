...
|{sc-spring-boot-actuator}/health/HeapMemoryHealthIndicator.{sc-ext}[`HeapMemoryHealthIndicator`]
|Checks for low heap memory space.
...
|{sc-spring-boot-actuator}/health/NonHeapMemoryHealthIndicator.{sc-ext}[`NonHeapMemoryHealthIndicator`]
|Checks for low non-heap memory space.
