...
It is also possible to use Infinispan Spring Boot Starter to bootstrap application easier.
For more information, check https://github.com/infinispan/infinispan-spring-boot[the documentation].
