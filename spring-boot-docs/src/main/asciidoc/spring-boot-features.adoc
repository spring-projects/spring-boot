...
If you prefer your test to run against a real Mongo instance, you can use the 
`@AutoConfigureEmbeddedTestMongod` annotation as follows:

[source,java,indent=0]
----
	import org.junit.runner.RunWith;
	import org.springframework.beans.factory.annotation.Autowired;
    import org.springframework.boot.test.autoconfigure.data.mongo.AutoConfigureEmbeddedTestMongod;
    import org.springframework.boot.test.autoconfigure.data.mongo.DataMongoTest;
	import org.springframework.data.mongodb.core.MongoTemplate;
	import org.springframework.test.context.junit4.SpringRunner;
