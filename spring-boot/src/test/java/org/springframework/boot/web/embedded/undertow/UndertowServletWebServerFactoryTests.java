...
public class UndertowServletWebServerFactoryTests
	...
	public void defaultContextPath() throws Exception {
		...
		factory.addDeploymentInfoCustomizers(
				(UndertowDeploymentInfoCustomizer) deploymentInfo -> contextPath.set(deploymentInfo.getContextPath()));
		this.webServer = factory.getWebServer();
	...
	protected void addConnector(final int port, AbstractServletWebServerFactory factory) {
		((UndertowServletWebServerFactory) factory)
				.addBuilderCustomizers((UndertowBuilderCustomizer) builder -> builder.addHttpListener(port, "0.0.0.0"));
	}
