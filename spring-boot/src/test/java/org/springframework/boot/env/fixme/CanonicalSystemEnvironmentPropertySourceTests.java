...
import org.springframework.boot.env.fixme.SystemEnvironmentCanonicalPropertySource;
...
/**
 * Tests for {@link SystemEnvironmentCanonicalPropertySource}.
 * @author Madhura Bhave
 */
@RunWith(Parameterized.class)
public class CanonicalSystemEnvironmentPropertySourceTests {

	private SystemEnvironmentCanonicalPropertySource propertySource;
	...
	public void setUp() throws Exception {
		this.propertySource = new SystemEnvironmentCanonicalPropertySource("test", input.asMap());
	}
