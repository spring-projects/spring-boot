...
public class ColorConverterTests {
	...
	@Before
	public void setUp() {
		event = new TestLogEvent();
	}

	private ColorConverter newConverter(String styling) {
		return ColorConverter.newInstance(null, new String[] { in, styling });
	}

	@Test
	public void faint() {
		StringBuilder output = new StringBuilder();
		newConverter("faint").format(event, output);
	...
	public void red() {
		StringBuilder output = new StringBuilder();
		newConverter("red").format(event, output);
	...
	public void green() throws Exception {
		StringBuilder output = new StringBuilder();
		newConverter("green").format(event, output);
	...
	public void yellow() throws Exception {
		StringBuilder output = new StringBuilder();
		newConverter("yellow").format(event, output);
	...
	public void blue() throws Exception {
		StringBuilder output = new StringBuilder();
		newConverter("blue").format(event, output);
	...
	public void magenta() throws Exception {
		StringBuilder output = new StringBuilder();
		newConverter("magenta").format(event, output);
	...
	public void cyan() throws Exception {
		StringBuilder output = new StringBuilder();
		newConverter("cyan").format(event, output);
	...
	public void highlightFatal() throws Exception {
		...
		StringBuilder output = new StringBuilder();
		newConverter(null).format(event, output);
		assertThat(output.toString(), equalTo("\033[31min\033[0;39m"));
	}
