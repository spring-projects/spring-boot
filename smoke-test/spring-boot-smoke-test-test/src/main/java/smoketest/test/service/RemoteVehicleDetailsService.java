...
public class RemoteVehicleDetailsService implements VehicleDetailsService {
	...
	public RemoteVehicleDetailsService(ServiceProperties properties, RestClient.Builder restClientBuilder) {
		this.restClient = restClientBuilder.baseUrl(properties.getVehicleServiceRootUrl()).build();
	}
