...
[Maven](../spring-boot-maven-plugin/README.html) or
[Gradle](../spring-boot-gradle-plugin/README.html) plugins
...
[spring-boot-maven-plugin](../spring-boot-maven-plugin/README.html) or
[spring-boot-gradle-plugin](../spring-boot-gradle-plugin/README.html). If you are not using
Maven or Gradle [spring-boot-loader-tools](../spring-boot-loader-tools/README.html) provides
