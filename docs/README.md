...
[compendium of micro HOWTO guides](docs/howto.html) covering many common
use cases.
...
project with Maven is available in the [starter docs](spring-boot-starters/README.html).
...
_Also see [CONTRIBUTING.md](CONTRIBUTING.html) if you wish to submit
...
[spring-boot-cli/samples]({{ site.github_repo_url }}/tree/master/spring-boot-cli/samples). To run the CLI samples type
`spring run <sample>.groovy` from samples directory.

Java samples are available in [spring-boot-samples]({{ site.github_repo_url }}/tree/master/spring-boot-samples) and should
be built with maven and run by invoking `java -jar target/<sample>.jar`. The following java
samples are provided:

* [spring-boot-sample-simple]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-simple) -
A simple command line application
* [spring-boot-sample-tomcat]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-tomcat) -
Embedded Tomcat
* [spring-boot-sample-jetty]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-jetty) -
Embedded Jetty
* [spring-boot-sample-actuator]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-actuator) -
Simple REST service with production features
* [spring-boot-sample-actuator-ui]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-actuator-ui) -
A web UI example with production features
* [spring-boot-sample-web-ui]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-web-ui) -
A thymeleaf web application
* [spring-boot-sample-web-static]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-web-static) -
A web application service static files
* [spring-boot-sample-batch]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-batch) -
Define and run a Batch job in a few lines of code
* [spring-boot-sample-data-jpa]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-data-jpa) -
Spring Data JPA + Hibernate + HSQLDB
* [spring-boot-sample-integration]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-integration) -
A spring integration application
* [spring-boot-sample-profile]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-profile) -
example showing Spring's `@profile` support
* [spring-boot-sample-traditional]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-traditional) -
shows more traditional WAR packaging
(but also executable using `java -jar`)
* [spring-boot-sample-xml]({{ site.github_repo_url }}/tree/master/spring-boot-samples/spring-boot-sample-xml) -
