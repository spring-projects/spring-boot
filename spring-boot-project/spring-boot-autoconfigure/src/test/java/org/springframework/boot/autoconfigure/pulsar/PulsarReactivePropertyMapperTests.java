...
class PulsarReactivePropertyMapperTests {
	...
	void reactiveMessageSenderBuilderCustomizer() {
		...
		PulsarReactivePropertyMapper.messageSenderBuilderCustomizer(properties).customize(builder);
	...
	@Test
	@SuppressWarnings("unchecked")
	void messageConsumerBuilderCustomizer() {
		PulsarProperties properties = new PulsarProperties();
		...
		PulsarReactivePropertyMapper.messageConsumerBuilderCustomizer(properties).customize(builder);
	...
	void messageReaderSpecCustomizer() {
		...
		PulsarReactivePropertyMapper.messageReaderBuilderCustomizer(properties).customize(builder);
