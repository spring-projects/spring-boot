...
public class UndertowCustomizerTest {
	...
	@Mock
	private ConfigurableUndertowWebServerFactory configurableUndertowWebServerFactory;
	...
	public void shouldNotSetBufferSizeWhileItIsNull() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(0)).setBufferSize(anyInt());
	}
	...
	public void shouldSetBufferSizeWhileItIsNotNull() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setBufferSize(anyInt());
	}
	...
	public void shouldNotSetIoThreadWhileItIsNull() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(0)).setIoThreads(any());
	}
	...
	public void shouldSetIoThreadWhileItIsNotNull() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setIoThreads(any());
	}
	...
	public void shouldNotSetWorkerThreadsWhileItIsNull() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(0)).setWorkerThreads(any());
	}
	...
	public void shouldSetWorkerThreadsWhileItIsNotNull() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setWorkerThreads(any());
	}
	...
	public void shouldNotSetDirectBuffersWhileItIsNull() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(0)).setUseDirectBuffers(anyBoolean());
	}
	...
	public void shouldSetDirectBuffersWhileItIsNotNull() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setUseDirectBuffers(anyBoolean());
	}
	...
	public void shouldNotSetAccesslogWhileItIsNull() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(0)).setAccessLogEnabled(any());
	}
	...
	public void shouldSetAccesslogWhileItIsNotNull() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setAccessLogEnabled(any());
	}
	...
	public void shouldAlwaysSetAccessLogDirectory() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setAccessLogDirectory(any());
	}
	...
	public void shouldAlwaysSetAccessLogPattern() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setAccessLogPattern(any());
	}
	...
	public void shouldAlwaysSetAccessLogPrefix() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setAccessLogPrefix(any());
	}
	...
	public void shouldAlwaysSetAccessLogSuffix() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setAccessLogSuffix(any());
	}
	...
	public void shouldAlwaysSetAccessLogRotate() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setAccessLogRotate(any());
	}
	...
	public void shouldSetUserForwardHeaderWhenItIsTrue() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setUseForwardHeaders(Boolean.TRUE);
	}
	...
	public void shouldSetUserForwardHeaderWhenItIsNUll() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).setUseForwardHeaders(any());
	}
	...
	public void shouldCustomizeMaxHttpHeaderSizeWhenItIsGreaterThanZero() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).addBuilderCustomizers(any());
	}
	...
	public void shouldNotCustomizeMaxHttpHeaderSizeWhenItIsEqualZero() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(0)).addBuilderCustomizers(any());
	}
	...
	public void shouldAlwaysCallAddDeploymentInfoCustomizers() throws Exception {
		...
		UndertowCustomizer.customizeUndertow(this.serverProperties, this.environment, this.configurableUndertowWebServerFactory);
		verify(this.configurableUndertowWebServerFactory, times(1)).addDeploymentInfoCustomizers(any());
	}
