...
public class CassandraProperties {
	...
	/**
	 * Returns the Controlconnection object associated with this CassandraProperties
	 * instance.
	...
	public static class Pool {
		 ...
		 * @param idleTimeout the duration of idle time after which an object in the pool
		 * is considered idle
		 */
