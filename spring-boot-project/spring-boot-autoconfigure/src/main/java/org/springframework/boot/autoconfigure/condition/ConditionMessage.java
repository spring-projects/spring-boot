...
public final class ConditionMessage {
	...
	/**
	 * Constructs a new ConditionMessage object with the given prior ConditionMessage and
	 * message. If the prior ConditionMessage is empty, the message is set as the new
	 * ConditionMessage's message. Otherwise, the new ConditionMessage's message is set as
	 * the concatenation of the prior ConditionMessage's message and the given message,
	 ...
	 * @return true if the specified object is equal to this ConditionMessage object,
	 * false otherwise
	 */
	@Override
	...
	public final class ItemsBuilder {
		...
		/**
		 * Constructs a new ItemsBuilder with the given condition, reason, singular, and
		 * plural values.
	...
	public enum Style {
		...
		QUOTE {
			 ...
			 * @return the applied item as a String enclosed in single quotes, or null if
			 * the item is null
			 */
			@Override
		...
		/**
		 * Applies the specified condition to each item in the given collection and
		 * returns a new collection containing the results.
		 * @param items the collection of items to apply the condition to
		 * @return a new collection containing the results of applying the condition to
		 * each item in the given collection, or null if the input collection is null
		 */
