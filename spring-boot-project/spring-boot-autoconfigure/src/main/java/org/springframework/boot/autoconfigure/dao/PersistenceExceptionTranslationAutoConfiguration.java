...
public class PersistenceExceptionTranslationAutoConfiguration {
	...
	/**
	 * Creates a new instance of {@link PersistenceExceptionTranslationPostProcessor} if
	 * no other bean of the same type is present. This bean is conditionally created based
	 * on the property "spring.dao.exceptiontranslation.enabled" in the application's
	 * configuration. If the property is not present, the default value is true.
	 * @param environment the environment object used to retrieve the property
