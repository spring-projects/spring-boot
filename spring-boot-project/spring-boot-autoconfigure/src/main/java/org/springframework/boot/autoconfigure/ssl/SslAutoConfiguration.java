...
public class SslAutoConfiguration {
	...
	/**
     * Creates a new instance of {@link SslPropertiesBundleRegistrar} with the provided {@link SslProperties} and {@link FileWatcher}.
     * 
     * @param sslProperties the {@link SslProperties} to be used for SSL configuration
     * @param fileWatcher the {@link FileWatcher} to be used for monitoring SSL properties file changes
	...
	/**
     * Creates a default {@link SslBundleRegistry} bean if no other beans of type {@link SslBundleRegistry} or {@link SslBundles} are present.
     * 
     * This method uses an {@link ObjectProvider} to obtain all available {@link SslBundleRegistrar} beans and registers their bundles with the {@link DefaultSslBundleRegistry}.
     * 
     * @param sslBundleRegistrars the {@link ObjectProvider} of {@link SslBundleRegistrar} beans
