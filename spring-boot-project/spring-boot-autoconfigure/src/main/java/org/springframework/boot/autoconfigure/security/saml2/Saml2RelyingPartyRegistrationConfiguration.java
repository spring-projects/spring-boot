...
class Saml2RelyingPartyRegistrationConfiguration {
	...
	/**
	 * Creates a new instance of RelyingPartyRegistrationRepository based on the provided
	 * Saml2RelyingPartyProperties.
	 * @param properties the Saml2RelyingPartyProperties containing the configuration for
	 * the relying party registrations
	...
	/**
	 * Converts a Map.Entry object containing a key-value pair of String and Registration
	 * into a RelyingPartyRegistration object.
	...
	/**
	 * Converts the given registration properties into a {@link RelyingPartyRegistration}
	 * object.
	...
	/**
	 * Creates a RelyingPartyRegistration.Builder using the metadata provided by the
	 * AssertingParty.
	 ...
	 * @throws IllegalStateException If no relying party with the specified Entity ID is
	 * found.
	 */
	 ...
	 * @param candidate the RelyingPartyRegistration.Builder object to extract the entity
	 * ID from
	...
	/**
	 * Maps the properties of an AssertingParty object to an AssertingPartyDetails.Builder
	 * object.
	 * @param assertingParty the AssertingParty object to be mapped
	 * @return a Consumer function that maps the properties of the AssertingParty object
	 * to the AssertingPartyDetails.Builder object
	 */
	 ...
	 * @param properties the registration properties
	 * @param signRequest flag indicating whether the authentication requests require
	 * signing
	 * @throws IllegalArgumentException if signRequest is true and the signing credentials
	 * are empty
	 */
	 ...
	 * @param properties the Signing.Credential object containing the private key and
	...
	/**
	 * Returns a Saml2X509Credential object for decryption based on the provided
	 * properties.
	 * @param properties The Decryption.Credential object containing the private key and
	 * certificate locations.
	...
	/**
	 * Converts the given Verification.Credential properties into a Saml2X509Credential
	 * object for verification purposes.
	 * @param properties the Verification.Credential properties containing the certificate
	 * location
	 ...
	 * @throws IllegalArgumentException if the private key location is not specified or
	 * does not exist, or if an error occurs while reading the private key
	 */
	 ...
	 * @throws IllegalArgumentException if the location is null or does not exist, or if
	 * an error occurs while reading the certificate
	 */
