...
public class GraphQlRSocketAutoConfiguration {
	...
	/**
	 * Creates a new instance of {@link GraphQlRSocketHandler} if no other bean of the
	 * same type is present.
	 * @param graphQlService the {@link ExecutionGraphQlService} to be used by the handler
	 * @param interceptors an {@link ObjectProvider} of {@link RSocketGraphQlInterceptor}
	 * to be applied to the handler
	...
	/**
	 * Creates a new instance of {@link GraphQlRSocketController} if no other bean of the
	 * same type is present.
