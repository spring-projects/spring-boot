...
class R2dbcInitializationConfiguration {
	 ...
	 * @param connectionFactory the {@link ConnectionFactory} to use for database
	 * connections
	 * @param properties the {@link SqlInitializationProperties} containing initialization
	 * properties
	...
	/**
	 * Determines the appropriate ConnectionFactory based on the provided
	 * connectionFactory, username, and password. If both the username and password are
	 * provided, a new ConnectionFactory is derived from the provided connectionFactory
	 * with the specified username and password. Otherwise, the original connectionFactory
	 * is returned.
