 ...
 * @since 1.5.10
 */
public class DefaultJooqExceptionTranslator implements JooqExceptionTranslator {

	// Based on the jOOQ-spring-example from https://github.com/jOOQ/jOOQ

	private static final Log logger = LogFactory.getLog(DefaultJooqExceptionTranslator.class);
