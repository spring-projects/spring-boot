...
public class CassandraReactiveDataAutoConfiguration {
	...
	/**
	 * Creates a new instance of ReactiveSession if no other bean of type ReactiveSession
	 * is present.
	...
	/**
	 * Creates a new instance of ReactiveSessionFactory if no other bean of the same type
	 * is present.
	 * @param reactiveCassandraSession the ReactiveSession bean used to create the
	...
	/**
	 * Creates a new instance of ReactiveCassandraTemplate if there is no existing bean of
	 * type ReactiveCassandraOperations.
	 * @param reactiveCassandraSession the ReactiveSession used for Cassandra operations
	 * @param converter the CassandraConverter used for converting objects to Cassandra
	 * types
