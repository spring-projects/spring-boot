...
public class DispatcherServletRegistrationBean extends ServletRegistrationBean<DispatcherServlet>
	 ...
	 * @throws UnsupportedOperationException if attempting to change the URL mapping on a
	 ...
	 * @throws UnsupportedOperationException if URL mapping cannot be changed on a
	 * DispatcherServlet registration
	 */
	@Override
