...
class ReactiveOAuth2ResourceServerOpaqueTokenConfiguration {
	...
	static class OpaqueTokenIntrospectionClientConfiguration {
		...
		/**
		 * Creates a bean for the SpringReactiveOpaqueTokenIntrospector class. This bean
		 * is conditional on the presence of the property
		 * "spring.security.oauth2.resourceserver.opaquetoken.introspection-uri".
		 * @param properties The OAuth2ResourceServerProperties object containing the
