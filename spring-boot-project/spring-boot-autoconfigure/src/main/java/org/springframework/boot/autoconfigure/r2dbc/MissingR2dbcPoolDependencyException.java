...
class MissingR2dbcPoolDependencyException extends RuntimeException {
	...
	/**
	 * Constructs a new MissingR2dbcPoolDependencyException with a detail message
	 * indicating that R2DBC connection pooling has been configured but the
	 * io.r2dbc.pool.ConnectionPool class is not present.
	 */
