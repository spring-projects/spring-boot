...
class OnClassCondition extends FilteringSpringBootCondition {
	...
	/**
     * Retrieves the outcomes for the given auto configuration classes and auto configuration metadata.
     * If there are more than one auto configuration classes and more than one processor is available,
     * the work is split and performed in a background thread. Otherwise, the outcomes are resolved
     * in the current thread.
     *
     * @param autoConfigurationClasses    the auto configuration classes to retrieve outcomes for
	...
	/**
     * Creates an instance of {@link OutcomesResolver} by initializing a {@link StandardOutcomesResolver} with the given parameters.
     * The {@link StandardOutcomesResolver} is then wrapped in a {@link ThreadedOutcomesResolver} to enable multi-threaded resolution of outcomes.
     * 
	...
	/**
     * Determines the outcome of a condition check based on the presence or absence of certain classes.
     * 
	...
	/**
     * Retrieves the candidates from the given metadata based on the specified annotation type.
     * 
    ...
    private static final class StandardOutcomesResolver implements OutcomesResolver {
		...
		/**
         * Retrieves the outcomes for a range of auto configuration classes based on their conditional on class metadata.
         * 
         * @param autoConfigurationClasses an array of auto configuration class names
         * @param start the starting index of the range
         * @param end the ending index of the range
         * @param autoConfigurationMetadata the auto configuration metadata
         * @return an array of condition outcomes for the specified range of auto configuration classes
         */
		...
		/**
         * Retrieves the outcome of a condition based on the provided class name and class loader.
         * 
