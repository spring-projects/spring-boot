...
public class CouchbaseAutoConfiguration {
	...
	/**
	 * Constructs a new instance of CouchbaseAutoConfiguration with the specified
	 * CouchbaseProperties.
	...
	/**
	 * Creates a new instance of {@link PropertiesCouchbaseConnectionDetails} if no bean
	 * of type {@link CouchbaseConnectionDetails} is present.
	 *
	 * This method retrieves the connection details from the properties and initializes a
	 * new instance of {@link PropertiesCouchbaseConnectionDetails} with the retrieved
	 * values.
	 * @return a new instance of {@link PropertiesCouchbaseConnectionDetails} initialized
	 * with the connection details from the properties
	 */
	@Bean
	 ...
	 * @param couchbaseClusterEnvironment The ClusterEnvironment bean for configuring the
	 * Couchbase cluster.
	 * @param connectionDetails The CouchbaseConnectionDetails bean containing the
	...
	/**
	 * Initializes the ClusterEnvironment.Builder with the provided
	 * CouchbaseConnectionDetails and SslBundles.
	 * @param connectionDetails The CouchbaseConnectionDetails containing the connection
	 ...
	 * @return the TrustManagerFactory from the SslBundle, or null if the SslBundle is
	 * null
	 */
	...
	static class JacksonConfiguration {
		...
		/**
		 * Returns a customizer for the ClusterEnvironmentBuilder that configures it with
		 * a Jackson ObjectMapper. This customizer is only applied if there is a single
		 * candidate for the ObjectMapper bean. The customizer creates a new instance of
		 * JacksonClusterEnvironmentBuilderCustomizer with a modified ObjectMapper that
		 * registers the JsonValueModule module.
		 * @param objectMapper the ObjectMapper bean to be used for customizing the
		 * ClusterEnvironmentBuilder
		 * @return a customizer for the ClusterEnvironmentBuilder that configures it with
		 * the modified ObjectMapper
		 */
		@Bean
	...
	private static final class JacksonClusterEnvironmentBuilderCustomizer
		...
		/**
		 * Constructs a new JacksonClusterEnvironmentBuilderCustomizer with the specified
		 * ObjectMapper.
		...
		/**
		 * Customizes the JacksonClusterEnvironmentBuilder by configuring the JSON
		 * serializer with the provided ObjectMapper.
	...
	static final class PropertiesCouchbaseConnectionDetails implements CouchbaseConnectionDetails {
		...
		/**
		 * Initializes a new instance of the PropertiesCouchbaseConnectionDetails class
		 * with the specified CouchbaseProperties.
		 * @param properties The CouchbaseProperties object containing the connection
		 * details.
		 */
