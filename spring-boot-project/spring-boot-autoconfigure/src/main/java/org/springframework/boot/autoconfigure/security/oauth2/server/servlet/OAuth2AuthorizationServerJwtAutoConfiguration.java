...
public class OAuth2AuthorizationServerJwtAutoConfiguration {
	...
	/**
	 * Creates a JwtDecoder bean if the JwtDecoder class is present and no other bean of
	 * type JwtDecoder is already defined.
	...
	/**
	 * Creates a JWKSource bean for providing JSON Web Key (JWK) set. This bean is
	 * responsible for generating and providing the RSA key for JWT token signing. If a
	 * custom JWKSource bean is already defined, this method will not be executed.
