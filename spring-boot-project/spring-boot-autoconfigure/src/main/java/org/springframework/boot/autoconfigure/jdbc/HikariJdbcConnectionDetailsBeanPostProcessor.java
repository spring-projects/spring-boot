...
class HikariJdbcConnectionDetailsBeanPostProcessor extends JdbcConnectionDetailsBeanPostProcessor<HikariDataSource> {
	...
	/**
	 * Constructs a new HikariJdbcConnectionDetailsBeanPostProcessor with the specified
	...
	/**
	 * Sets the JDBC URL, username, password, and driver class name for the given
	 * HikariDataSource object.
	 * @param dataSource the HikariDataSource object to be processed
	 * @param connectionDetails the JdbcConnectionDetails object containing the connection
	 * details
