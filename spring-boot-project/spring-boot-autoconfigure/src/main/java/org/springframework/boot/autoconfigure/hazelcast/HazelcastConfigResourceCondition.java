...
public abstract class HazelcastConfigResourceCondition extends ResourceCondition {
	...
	/**
	 * Constructs a new HazelcastConfigResourceCondition with the specified config system
	 * property and resource locations.
	 * @param configSystemProperty the system property used to specify the Hazelcast
	 * configuration file
	...
	/**
	 * Determines the outcome of the resource condition based on the presence of a system
	 * property.
