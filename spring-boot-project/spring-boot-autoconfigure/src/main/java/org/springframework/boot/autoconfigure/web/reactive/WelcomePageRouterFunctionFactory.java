...
final class WelcomePageRouterFunctionFactory {
	 ...
	 * check the availability of templates
	 * @param applicationContext the ApplicationContext used to retrieve resources and
	 * beans
	 ...
	 * @return the RouterFunction<ServerResponse> that handles requests for the welcome
	 * page
	 */
