...
public class CassandraDataAutoConfiguration {
	...
	/**
	 * Constructs a new instance of the CassandraDataAutoConfiguration class with the
	 * specified CqlSession.
	...
	/**
	 * Returns the CassandraManagedTypes bean if it is not already present in the
	 * application context. This bean is responsible for scanning the packages for
	 * Cassandra entity classes and returning the managed types. If no packages are
	 * specified, it will scan the packages from the EntityScanPackages and
	 * AutoConfigurationPackages. If no packages are found, it will return an empty
	 * CassandraManagedTypes object.
	...
	/**
	 * Creates and configures a {@link CassandraMappingContext} bean if no other bean of
	...
	/**
	 * Creates a {@link CassandraConverter} bean if no other bean of the same type is
	 * present.
	 * @param mapping the {@link CassandraMappingContext} used for mapping entities to
	 * Cassandra tables
	 * @param conversions the {@link CassandraCustomConversions} used for custom type
	 * conversions
	...
	/**
	 * Creates a Cassandra Session Factory if no other bean of type SessionFactory is
	 * present.
	...
	/**
	 * Creates a new instance of CassandraTemplate if there is no existing bean of type
	 * CassandraOperations.
	 * @param sessionFactory the SessionFactory used for creating Cassandra sessions
	 * @param converter the CassandraConverter used for converting between Java objects
	 * and Cassandra entities
	...
	/**
	 * Creates a new instance of {@link CassandraCustomConversions} if no other bean of
	 * the same type is present.
