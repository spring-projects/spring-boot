...
public class Neo4jDriverProperties {
	...
	/**
	 * The uri this driver should connect to. The driver supports bolt or neo4j as
	 * schemes. Defaults to bolt://localhost:7687.
	 */
	...
	public Config asDriverConfig() {
		...
		String scheme = (this.uri != null) ? this.uri.getScheme() : "bolt";
		...
		AuthToken asAuthToken() {
			...
			if (hasUsername && hasKerberosTicket) {
				throw new InvalidConfigurationPropertyValueException("org.neo4j.driver.authentication",
						"username=" + this.username + ",kerberos-ticket=" + this.kerberosTicket,
