...
public class DefaultJerseyApplicationPath implements JerseyApplicationPath {
	...
	/**
	 * Constructs a new DefaultJerseyApplicationPath with the specified application path
	...
	/**
	 * Resolves the application path for the DefaultJerseyApplicationPath class. If the
	 * application path is already set, it returns the existing value. Otherwise, it
	 * checks for the @ApplicationPath annotation on the configured application class. If
	 * the annotation is present, it returns the value specified in the annotation. If the
	 * annotation is not present, it returns "/*" as a fallback.
