...
public class FlywayProperties {
	...
	/**
	 * Returns the value indicating whether the execution should fail if any locations are
	 * missing.
	 * @return {@code true} if the execution should fail on missing locations,
	 ...
	 * @param failOnMissingLocations true to fail if missing locations are encountered,
	 * false otherwise
	 */
	 ...
	 * @param placeholderReplacement true to enable placeholder replacement, false
	 * otherwise
	 */
	 ...
	 * @param sqlMigrationSeparator the separator to be used for separating SQL migration
	 * scripts
	 */
	...
	/**
	 * Returns a boolean value indicating whether the baseline should be applied during
	 * migration.
	...
	/**
	 * Returns a boolean value indicating whether the clean operation should be performed
	 * on validation error.
	 * @return true if the clean operation should be performed on validation error, false
	 * otherwise
	 */
	 ...
	 * @param cleanOnValidationError the flag indicating whether to clean the database on
	 * validation error
	 */
	 ...
	 * @param validateMigrationNaming true to enable validation, false to disable
	 * validation
	 */
	...
	/**
	 * Sets the flag to determine whether to validate migrations against the schema
	 * history table during migration.
	...
	/**
	 * Returns a boolean value indicating whether the execution should be performed within
	 * a transaction.
	 * @return true if the execution should be performed within a transaction, false
	 * otherwise
	 */
	 ...
	 * @param executeInTransaction true if the execution should be performed within a
	 ...
	 *
	 * This property has been deprecated since version 3.2.0 and will be removed in a
	 * future release. It is recommended to use the replacement property
	 * "spring.flyway.oracle.sqlplus" instead.
	 * @return the value of the deprecated configuration property "oracleSqlplus"
	 * @deprecated This property has been deprecated since version 3.2.0 and will be
	 * removed in a future release. It is recommended to use the replacement property
	 * "spring.flyway.oracle.sqlplus" instead.
	 */
	 ...
	 * @deprecated This method is deprecated since version 3.2.0 and will be removed in a
	 * future release. Use the replacement property "spring.flyway.oracle.sqlplus-warn"
	 * instead.
	 *
	 * @see FlywayProperties#getOracle()
	 ...
	 * in a future release. Use {@link #getOracle().getWalletLocation()} instead. For more
	 * information, refer to the replacement property
	 * {@code spring.flyway.oracle.wallet-location}.
	 *
	 * @see FlywayProperties#getOracle()
	 ...
	 * @param cherryPick an array of strings representing the cherry-picked migrations to
	 * apply
	 */
	 ...
	 * @deprecated This configuration property has been deprecated since version 3.2.0.
	 * Please use 'spring.flyway.oracle.kerberos-cache-file' instead.
	 *
	 * @since 3.2.0
	 * @deprecated This method has been deprecated since version 3.2.0 and is scheduled
	 * for removal.
	 */
	 ...
	 * @deprecated This method has been deprecated since version 3.2.0 and will be removed
	 * in a future release. Please use the replacement property
	 * "spring.flyway.sqlserver.kerberos-login-file" instead.
	 */
	 ...
	 * @param skipExecutingMigrations the flag indicating whether to skip executing
	 * migrations
	 */
	 ...
	 * @param detectEncoding the flag indicating whether to enable or disable automatic
