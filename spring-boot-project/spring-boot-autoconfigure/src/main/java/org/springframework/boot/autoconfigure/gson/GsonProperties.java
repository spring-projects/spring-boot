...
public class GsonProperties {
	 ...
	 * @param generateNonExecutableJson the flag indicating whether to generate
	 * non-executable JSON
	 */
	 ...
	 * @param excludeFieldsWithoutExposeAnnotation the flag indicating whether to exclude
	 * fields without the @Expose annotation
	 */
	 ...
	 * @param enableComplexMapKeySerialization the flag indicating whether complex map key
	 * serialization is enabled or disabled
	 */
	 ...
	 * @param disableInnerClassSerialization the flag indicating whether inner class
	 * serialization should be disabled
	 */
	 ...
	 * @param prettyPrinting the flag indicating whether pretty printing should be enabled
	 * or not
	 */
	 ...
	 * @param disableHtmlEscaping the flag indicating whether HTML escaping should be
	 * disabled
	 */
