...
public class AutoConfigurationImportEvent extends EventObject {
	...
	/**
	 * Constructs a new AutoConfigurationImportEvent with the specified source, candidate
	 * configurations, and exclusions.
	 * @param source the object that triggered the event
	 * @param candidateConfigurations the list of candidate configurations for
	 * auto-configuration
