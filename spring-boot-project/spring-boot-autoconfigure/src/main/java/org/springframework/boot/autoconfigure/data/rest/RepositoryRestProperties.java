...
public class RepositoryRestProperties {
	 ...
	 * @param returnBodyOnCreate the value indicating whether the body should be returned
	 * on create operation
	 */
	...
	/**
	 * Sets the flag indicating whether the body of the updated resource should be
	 * returned.
	 * @param returnBodyOnUpdate the flag indicating whether the body of the updated
	 ...
	 * @param enableEnumTranslation the flag indicating whether to enable or disable enum
	 * translation
	 */
