...
public class JmsPoolConnectionFactoryProperties {
	...
	/**
	 * Returns a boolean value indicating whether the connection factory should block if
	 * the connection pool is full.
	 * @return true if the connection factory should block if the connection pool is full,
	 * false otherwise
	 */
	 ...
	 * @param blockIfFull the flag indicating whether to block if the connection pool is
	 * full
	 */
	 ...
	 * @param blockIfFullTimeout the timeout duration for blocking if the connection pool
	 * is full
	 */
	...
	/**
	 * Returns the maximum number of connections allowed by this
	 ...
	 * @param maxSessionsPerConnection the maximum number of sessions per connection to
	 * set
	 */
