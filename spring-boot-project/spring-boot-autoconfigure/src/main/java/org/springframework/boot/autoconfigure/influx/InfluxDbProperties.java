...
public class InfluxDbProperties {
	 ...
	 * @deprecated the new InfluxDb Java client provides Spring Boot integration and this
	 * property is no longer needed. Starting from version 3.2.0, it is recommended to use
	 * the new client for InfluxDB integration.
	 */
	 ...
	 * @deprecated the new InfluxDb Java client provides Spring Boot integration since
	 * version 3.2.0. Use the new client for connecting to the InfluxDB server instead.
	 */
	@DeprecatedConfigurationProperty(reason = "the new InfluxDb Java client provides Spring Boot integration",
			since = "3.2.0")
	 ...
	 * @deprecated the new InfluxDb Java client provides Spring Boot integration and this
	 * property is no longer needed since version 3.2.0
	 */
	@DeprecatedConfigurationProperty(reason = "the new InfluxDb Java client provides Spring Boot integration",
			since = "3.2.0")
