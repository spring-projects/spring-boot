...
class ArtemisEmbeddedConfigurationFactory {
	...
	/**
	 * Constructs a new ArtemisEmbeddedConfigurationFactory object with the provided
	 * ArtemisProperties.
	 * @param properties the ArtemisProperties object containing the configuration
	 * properties for the embedded Artemis server
	 */
	...
	/**
	 * Returns the data directory for the ArtemisEmbeddedConfigurationFactory. If the data
	 * directory is set in the properties, it will be returned. Otherwise, a temporary
	 * directory will be used with the name "artemis-data".
