...
public class QuartzDataSourceScriptDatabaseInitializer extends DataSourceScriptDatabaseInitializer {
	...
	/**
	 * Constructs a new QuartzDataSourceScriptDatabaseInitializer with the specified
	 * DataSource, DatabaseInitializationSettings, and commentPrefixes.
	 * @param dataSource the DataSource to be used for database initialization
	 * @param settings the DatabaseInitializationSettings to be used for database
	 * initialization
	 * @param commentPrefixes the list of comment prefixes to be used for database
