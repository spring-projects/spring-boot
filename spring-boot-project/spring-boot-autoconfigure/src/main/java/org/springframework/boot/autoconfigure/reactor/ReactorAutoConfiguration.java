...
public class ReactorAutoConfiguration {
	...
	/**
	 * Configures the Reactor auto-configuration based on the provided properties. If the
	 * context propagation mode is set to AUTO, enables automatic context propagation
	 * using Reactor Hooks.
