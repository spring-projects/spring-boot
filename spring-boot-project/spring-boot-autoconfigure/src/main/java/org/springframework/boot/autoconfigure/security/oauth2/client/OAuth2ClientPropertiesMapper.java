...
public final class OAuth2ClientPropertiesMapper {
	...
	/**
	 * Retrieves the client registration based on the provided registration ID,
	...
	/**
	 * Returns a Builder object based on the provided registrationId,
	 * configuredProviderId, and providers map.
	 ...
	 * @throws IllegalStateException if the provider is not found in the common providers
	 * or the providers map
	 */
	...
	/**
	 * Retrieves the builder object and maps the properties from the provider object to
	 * the builder object.
	 ...
	 * @return the CommonOAuth2Provider object for the given provider ID, or null if the
	 * conversion fails
	 */
