...
public class MustacheProperties {
	...
	public static class Servlet {
		 ...
		 * @return {@code true} if the request override is allowed, {@code false}
		 * otherwise.
		 */
		 ...
		 * @param allowRequestOverride true if the servlet allows request override, false
		 * otherwise
		 */
		 ...
		 * @param allowSessionOverride true if the session can be overridden, false
		 * otherwise
		 */
		 ...
		 * @param exposeRequestAttributes true to expose request attributes, false
		 * otherwise
		 */
		 ...
		 * @param exposeSessionAttributes true to expose session attributes, false
		 * otherwise
		 */
		...
		/**
		 * Returns a boolean value indicating whether the Spring macro helpers are
		 * exposed.
		 ...
		 * @param exposeSpringMacroHelpers true to expose Spring macro helpers, false
		 * otherwise
		 */
