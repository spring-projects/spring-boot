...
public class Neo4jReactiveDataAutoConfiguration {
	...
	/**
	 * Creates a ReactiveDatabaseSelectionProvider bean if no other bean of the same type
	 * is present. This bean is responsible for providing the database selection for
	 * reactive Neo4j data operations. The database selection is determined based on the
	 * value of the 'database' property in the Neo4jDataProperties. If the 'database'
	 * property is not set, the default selection provider is used.
	 * @param dataProperties the Neo4jDataProperties object containing the configuration
	 * properties
	...
	/**
	 * Creates a new instance of ReactiveNeo4jTemplate using the provided
	 * ReactiveNeo4jClient and Neo4jMappingContext.
	 * @param neo4jClient The ReactiveNeo4jClient used for executing queries.
	 * @param neo4jMappingContext The Neo4jMappingContext used for mapping entities to the
	 * database.
