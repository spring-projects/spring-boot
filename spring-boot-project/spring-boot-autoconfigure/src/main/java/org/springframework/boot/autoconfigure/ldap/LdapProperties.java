...
public class LdapProperties {
	...
	/**
     * Sets the flag indicating whether anonymous users are allowed to read LDAP properties.
     * 
     * @param anonymousReadOnly the flag indicating whether anonymous users are allowed to read LDAP properties
     */
	...
	/**
     * Determines the URLs for the LDAP server based on the given environment.
     * If the URLs are not set, it will default to "ldap://localhost" with the determined port.
     * 
	...
	public static class Template {
         ...
         * 
         * @return {@code true} if the partial result exception should be ignored, {@code false} otherwise
         */
         ...
         * 
         * @param ignorePartialResultException true to ignore the PartialResultException, false otherwise
         */
		...
		/**
         * Returns a boolean value indicating whether the NameNotFoundException should be ignored.
         * 
         ...
         * 
         * @param ignoreNameNotFoundException the flag indicating whether to ignore NameNotFoundException
         */
		...
		/**
         * Returns a boolean value indicating whether the ignoreSizeLimitExceededException flag is set.
         * 
         * @return true if the ignoreSizeLimitExceededException flag is set, false otherwise
         */
         ...
         * 
         * @param ignoreSizeLimitExceededException the flag indicating whether to ignore the SizeLimitExceededException
         */
