...
class SslBundleRabbitConnectionFactoryBean extends RabbitConnectionFactoryBean {
	...
	/**
	 * Sets up SSL for the RabbitMQ connection factory. If an SSL bundle is provided, it
	 * creates an SSL context using the bundle and sets it as the protocol for the
	 * connection factory. If hostname verification is enabled, it enables hostname
	 * verification for the connection factory. If no SSL bundle is provided, it calls the
	 * superclass method to set up SSL.
	 */
	@Override
