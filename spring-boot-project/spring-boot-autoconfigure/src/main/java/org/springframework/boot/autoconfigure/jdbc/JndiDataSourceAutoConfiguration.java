...
public class JndiDataSourceAutoConfiguration {
	...
	/**
	 * Creates a DataSource bean using the provided DataSourceProperties and
	 * ApplicationContext. If a DataSource bean with the same name already exists, it will
	 * not be created. The JNDI name specified in the DataSourceProperties is used to
	 * lookup the DataSource. If necessary, the MBean for the created DataSource is
	 * excluded from the ApplicationContext.
