...
public class IntegrationProperties {
	...
	public static class Channel {
		...
		/**
		 * Sets the flag indicating whether the channel should automatically create new
		 * instances.
		 * @param autoCreate the flag indicating whether the channel should automatically
		...
		/**
		 * Returns a boolean value indicating whether auto creation is enabled for the
		 * channel.
		 ...
		 * @param maxBroadcastSubscribers the maximum number of subscribers allowed for a
		 * broadcast
		 */
	...
	public static class Endpoint {
		 ...
		 * @param throwExceptionOnLateReply true if an exception should be thrown, false
		 * otherwise
		 */
		...
		/**
		 * Returns a boolean value indicating whether an exception should be thrown on a
		 * late reply.
		...
		/**
		 * Returns a list of strings representing the endpoints that are not set to
		 * auto-startup.
		 * @return a list of strings representing the endpoints that are not set to
		 * auto-startup
		 */
	...
	public static class RSocket {
		...
		public static class Server {
			 ...
			 * @param messageMappingEnabled true if message mapping is enabled, false
			 * otherwise
			 */
	...
	public static class Poller {
		 ...
		 * @param maxMessagesPerPoll the maximum number of messages to be processed per
		 * poll
		 */
	...
	public static class Management {
		 ...
		 * @param defaultLoggingEnabled the flag indicating whether default logging is
		 * enabled or not
		 */
