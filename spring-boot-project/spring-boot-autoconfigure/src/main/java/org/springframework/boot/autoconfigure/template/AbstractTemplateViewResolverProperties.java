...
public abstract class AbstractTemplateViewResolverProperties extends AbstractViewResolverProperties {
	...
	/**
	 * Constructs a new AbstractTemplateViewResolverProperties object with the specified
	...
	/**
	 * Returns a boolean value indicating whether the request attributes should be
	 * exposed.
	 * @return {@code true} if the request attributes should be exposed, {@code false}
	 * otherwise
	 */
	 ...
	 * @param exposeRequestAttributes a boolean value indicating whether to expose request
	 * attributes
	 */
	 ...
	 * @param exposeSessionAttributes the flag indicating whether to expose session
	 * attributes
	 */
	 ...
	 * @param allowSessionOverride true if session override is allowed, false otherwise
	 */
	 ...
	 * @return {@code true} if the Spring macro helpers are exposed, {@code false}
	 * otherwise
	 */
	 ...
	 * @param exposeSpringMacroHelpers the flag indicating whether to expose Spring macro
	 * helpers
	 */
