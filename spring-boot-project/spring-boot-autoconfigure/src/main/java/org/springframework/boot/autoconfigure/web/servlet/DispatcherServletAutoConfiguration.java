...
public class DispatcherServletAutoConfiguration {
	...
	protected static class DispatcherServletRegistrationConfiguration {
		...
		public DispatcherServletRegistrationConfiguration(ServerProperties serverProperties,
				WebMvcProperties webMvcProperties, ObjectProvider<MultipartConfigElement> multipartConfigProvider) {
