...
class RetryTemplateFactory {
	...
	/**
	 * Constructs a new RetryTemplateFactory with the specified list of
	 * RabbitRetryTemplateCustomizer objects.
	 * @param customizers the list of RabbitRetryTemplateCustomizer objects to customize
	 * the RetryTemplate
	 */
	...
	/**
	 * Creates a RetryTemplate based on the provided RabbitProperties.Retry and
	 * RabbitRetryTemplateCustomizer.Target.
	 * @param properties the RabbitProperties.Retry object containing the retry
	 * configuration properties
	 * @param target the RabbitRetryTemplateCustomizer.Target object specifying the target
	 * for customization
	 * @return a RetryTemplate object configured with the provided properties and
	 * customizations
	 */
