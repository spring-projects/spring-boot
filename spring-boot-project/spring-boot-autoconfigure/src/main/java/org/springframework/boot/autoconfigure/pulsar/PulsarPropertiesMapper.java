...
final class PulsarPropertiesMapper {
	...
	/**
	 * Customizes the given {@link ClientBuilder} with the provided
	 * {@link PulsarConnectionDetails} and {@link PulsarProperties.Client}.
	 * @param clientBuilder the {@link ClientBuilder} to customize
	 * @param connectionDetails the {@link PulsarConnectionDetails} to use for
	 * customization
	...
	/**
	 * Customizes the service URL provider builder based on the provided properties and
	 * connection details.
	 * @param serviceUrlConsumer A consumer function to accept the service URL.
	 * @param serviceUrlProviderConsumer A consumer function to accept the service URL
	 * provider.
	...
	/**
	 * Retrieves the secondary authentications for failover clusters based on the provided
	 * properties.
	 * @param properties the failover properties containing the backup clusters
	 * @return a map of service URLs to authentication instances for the secondary
	 * clusters
	 */
	...
	/**
	 * Customizes the PulsarAdminBuilder with the provided connection details and
	 * properties.
	...
	/**
	 * Generates a JSON string representation of the authentication parameters. The
	 * parameters are sorted alphabetically by key before being converted to JSON.
	 * @param params a map of authentication parameters
	 * @return a JSON string representation of the authentication parameters
	 * @throws IllegalStateException if the authentication parameters cannot be converted
	...
	/**
	 * Customizes the given {@link ProducerBuilder} with the properties defined in
	 * {@link PulsarProperties}.
	...
	/**
	 * Customizes the ConsumerBuilder with the properties specified in the
	 * PulsarProperties.
	...
	/**
	 * Customizes the subscription settings of the given consumer builder based on the
	 * properties defined in the PulsarProperties.
	 ...
	 * @param containerProperties the PulsarContainerProperties object representing the
	...
	/**
	 * Customizes the provided {@link ReaderBuilder} with the properties defined in the
	 * {@link PulsarProperties.Reader}.
	 ...
	 * @param readerContainerProperties the Pulsar reader container properties to be
	 * customized
	 */
	 ...
	 * @return a Consumer function that accepts a Duration and sets the timeout property
