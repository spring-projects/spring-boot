...
public class SpringApplicationAdminJmxAutoConfiguration {
	...
	/**
	 * Registers the SpringApplicationAdminMXBeanRegistrar bean if it is missing. This
	 * bean is responsible for registering the SpringApplicationAdminMXBean in the JMX
	 * server. The JMX name is retrieved from the environment property
	 * "spring.application.admin.jmx-name", or it falls back to the default name
	 * "org.springframework.boot:type=Admin,name=SpringApplication". If there are any
	 * MBeanExporters available, the JMX name is added to their excluded beans list to
