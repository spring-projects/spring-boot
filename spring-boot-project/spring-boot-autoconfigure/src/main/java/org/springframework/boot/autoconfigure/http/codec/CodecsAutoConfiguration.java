...
public class CodecsAutoConfiguration {
	...
	static class JacksonCodecConfiguration {
		...
		/**
		 * Creates a Jackson codec customizer bean that configures the default codecs for
		 * JSON decoding and encoding. This customizer is conditional on the presence of
		 * an ObjectMapper bean. The customizer sets the Jackson2JsonDecoder and
		 * Jackson2JsonEncoder with the provided ObjectMapper.
		 * @param objectMapper the ObjectMapper bean to be used for JSON decoding and
		 * encoding
		 * @return the codec customizer that configures the default codecs with the
	...
	static class DefaultCodecsConfiguration {
		...
		/**
		 * Returns a CodecCustomizer bean that configures the default codecs for the
		 * application. The order of execution is set to 0.
