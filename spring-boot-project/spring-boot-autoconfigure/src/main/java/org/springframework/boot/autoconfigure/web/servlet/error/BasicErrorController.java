...
public class BasicErrorController extends AbstractErrorController {
	...
	/**
	 * Handles the error and returns a ModelAndView object with the error information in
	 * HTML format.
	...
	/**
	 * Handles error requests and returns a ResponseEntity with the appropriate status
	 * code and error attributes.
	...
	/**
	 * Handles HttpMediaTypeNotAcceptableException and returns a ResponseEntity with the
	...
	/**
	 * Returns the ErrorAttributeOptions based on the provided HttpServletRequest and
	 * MediaType.
