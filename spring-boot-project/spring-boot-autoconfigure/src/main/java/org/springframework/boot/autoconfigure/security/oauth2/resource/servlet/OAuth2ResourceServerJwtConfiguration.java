...
class OAuth2ResourceServerJwtConfiguration {
	...
	static class JwtDecoderConfiguration {
		...
		/**
         * Constructs a new JwtDecoderConfiguration with the specified OAuth2ResourceServerProperties and additionalValidators.
         * 
         * @param properties the OAuth2ResourceServerProperties containing the JWT configuration properties
		...
		/**
         * Creates a JwtDecoder bean based on the JWK Set URI property.
         * The bean is conditionally created if the property "spring.security.oauth2.resourceserver.jwt.jwk-set-uri" is present.
         * 
		...
		/**
         * Creates a SupplierJwtDecoder bean with conditional configuration based on the IssuerUriCondition.
         * The SupplierJwtDecoder is responsible for decoding JWT tokens.
         * 
         * @param customizers ObjectProvider of JwkSetUriJwtDecoderBuilderCustomizer to customize the JwkSetUriJwtDecoderBuilder
	...
	static class JwtConverterConfiguration {
         ...
         * 
         * This method creates a JwtGrantedAuthoritiesConverter object and sets its properties using the values from the JwtConverterConfiguration properties object.
         * The authority prefix, authorities claim delimiter, and authorities claim name are set using the values from the properties object.
         * The principal claim name is set using the value from the properties object.
         * 
         * The JwtAuthenticationConverter object is then created and its principal claim name is set using the value from the properties object.
         * The JwtGrantedAuthoritiesConverter object is set as the JwtAuthenticationConverter's JwtGrantedAuthoritiesConverter.
         * 
