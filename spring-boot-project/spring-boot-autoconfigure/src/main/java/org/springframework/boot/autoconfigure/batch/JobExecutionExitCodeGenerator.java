...
public class JobExecutionExitCodeGenerator implements ApplicationListener<JobExecutionEvent>, ExitCodeGenerator {
	...
	/**
	 * This method is called when a JobExecutionEvent is triggered. It adds the
	 * JobExecution object from the event to the list of executions.
	 ...
	 * @return the exit code of the job execution. If any of the executions have a status
	 * ordinal greater than 0, the highest ordinal value is returned. If all executions
	 * have a status ordinal of 0, 0 is returned.
	 */
	@Override
