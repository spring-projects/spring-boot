...
public class ConditionEvaluationReportLoggingListener
	...
	/**
     * Constructs a new ConditionEvaluationReportLoggingListener with the default log level of DEBUG.
     */
	...
	/**
     * Constructs a new ConditionEvaluationReportLoggingListener with the specified log level for report.
     * 
	...
	/**
     * Initializes the ConditionEvaluationReportLoggingListener by adding an ApplicationListener to the given ApplicationContext.
     * This ApplicationListener is responsible for logging the condition evaluation report.
     * 
     * @param applicationContext The ConfigurableApplicationContext to which the ApplicationListener will be added.
     */
    @Override
    ...
    private final class ConditionEvaluationReportListener implements GenericApplicationListener {
		...
		/**
         * Constructs a new ConditionEvaluationReportListener with the given ConfigurableApplicationContext.
         * 
		...
		/**
         * Returns the ConditionEvaluationReport generated by the ConditionEvaluationReportListener.
         * 
         * @return the ConditionEvaluationReport generated by the ConditionEvaluationReportListener
         */
		...
		/**
         * Returns the order in which this listener should be invoked during the condition evaluation process.
         * The listener with the lowest precedence will be invoked first.
         *
		...
		/**
         * This method is an implementation of the onApplicationEvent method declared in the ConditionEvaluationReportListener class.
         * It is called when an application event is triggered.
         * 
