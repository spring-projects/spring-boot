...
class OracleUcpJdbcConnectionDetailsBeanPostProcessor
	...
	/**
	 * Constructs a new OracleUcpJdbcConnectionDetailsBeanPostProcessor with the specified
	...
	/**
	 * Sets the URL, username, password, and connection factory class name of the given
	 * data source.
	 * @param dataSource the data source to be processed
	 * @param connectionDetails the JDBC connection details containing the URL, username,
	 * password, and driver class name
	 * @return the processed data source
	 * @throws RuntimeException if failed to set the URL, username, or password of the
	 * data source
	 */
	@Override
