...
public class ReactiveElasticsearchClientAutoConfiguration {
	...
	/**
	 * Creates a new instance of ReactiveElasticsearchClient if there is no existing bean
	 * of the same type. This method is conditionally executed only if there is a bean of
	 * type ElasticsearchTransport present.
	 * @param transport the ElasticsearchTransport bean used for creating the
