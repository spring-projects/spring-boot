...
/**
 * MustacheReactiveWebConfiguration class.
 */
...
class MustacheReactiveWebConfiguration {
	...
	/**
     * Creates a MustacheViewResolver bean if it is missing and the property "spring.mustache.enabled" is not set or set to true.
     * 
