...
public class ServerProperties {
	...
	public static class Servlet {
		...
		/**
		 * Cleans the given context path by removing any leading or trailing whitespace
		 ...
		 * @param registerDefaultServlet true to register the default servlet, false
		 * otherwise
		 */
	...
	public static class Tomcat {
		...
		/**
		 * Sets the maximum size of the HTTP form post data that will be accepted by this
		 * Tomcat instance.
		 ...
		 * @param redirectContextRoot the flag indicating whether to redirect the context
		 * root
		 */
		...
		/**
		 * Sets the maximum number of requests that can be queued when all request
		...
		/**
		 * Sets the maximum number of keep-alive requests allowed for this Tomcat
		 * instance.
		 ...
		 * @param additionalTldSkipPatterns the list of additional top-level domain skip
		 * patterns to be set
		 */
		 ...
		 * @param relaxedPathChars the list of characters to be considered as relaxed path
		 * characters
		 */
		 ...
		 * @param relaxedQueryChars the list of characters to be considered as relaxed
		 * query characters
		 */
		 ...
		 * removed in a future release. The setting has been deprecated in Tomcat. Please
		 * use an alternative method or property instead. This method may throw
		 * UnsupportedOperationException in future releases. Please refer to the Tomcat
		 ...
		 * @param rejectIllegalHeader the flag indicating whether to reject illegal
		 * headers
		 * @deprecated This method has been deprecated since version 3.2.0 and will be
		 * removed in a future release. Please use an alternative method instead.
		 */
		@Deprecated(since = "3.2.0", forRemoval = true)
		...
		public static class Accesslog {
			...
			/**
			 * Returns a boolean value indicating whether the file should be renamed on
			 * rotation.
			...
			/**
			 * Returns a boolean value indicating whether the IPv6 address is in canonical
			 * form.
			...
			/**
			 * Sets the flag indicating whether the IPv6 address should be displayed in
			 * canonical form.
			 * @param ipv6Canonical true if the IPv6 address should be displayed in
			...
			/**
			 * Returns a boolean value indicating whether the request attributes are
			 * enabled.
			 ...
			 * @param requestAttributesEnabled true if request attributes are enabled,
			 * false otherwise
			 */
			...
			/**
			 * Returns a boolean value indicating whether the Accesslog is buffered or
			 * not.
			 ...
			 * @param buffered the value indicating whether the Accesslog is buffered or
			 * not
			 */
		...
		public static class Resource {
			...
			/**
			 * Returns a boolean value indicating whether caching is allowed for this
			 * resource.
			 ...
			 * @param cacheTtl the duration of time that the cache should be considered
			 * valid
			 */
		...
		public static class Remoteip {
			 ...
			 * @param protocolHeaderHttpsValue the value of the protocol header for HTTPS
			 * requests
			 */
	...
	public static class Jetty {
		 ...
		 * @param connectionIdleTimeout the duration of idle time after which a connection
		 * will be closed
		 */
		...
		public static class Accesslog {
			 ...
			 * @param append the boolean value indicating whether to append to an existing
			 * log file or create a new one
			 */
	...
	public static class Netty {
		...
		/**
		 * Sets the maximum content length for HTTP/2 cleartext (non-encrypted)
		 * connections.
		 * @param h2cMaxContentLength the maximum content length for HTTP/2 cleartext
		 * connections
		 */
		 ...
		 * @param idleTimeout the duration of idle time after which the connection will be
		 * closed
		 */
		public void setIdleTimeout(Duration idleTimeout) {
			this.idleTimeout = idleTimeout;
	...
	public static class Undertow {
		...
		/**
		 * Returns the maximum size of an HTTP POST request that can be handled by the
		 * server.
		...
		/**
		 * Sets the maximum size of an HTTP POST request that can be processed by the
		 * server.
		...
		/**
		 * Returns a boolean value indicating whether the eager filter initialization is
		 * enabled.
		 * @return {@code true} if eager filter initialization is enabled, {@code false}
		 * otherwise
		 */
		...
		/**
		 * Sets the flag indicating whether the filter initialization should be eager or
		 * lazy.
		 * @param eagerFilterInit the flag indicating whether the filter initialization
		 * should be eager or lazy
		 */
		 ...
		 * @deprecated This property is deprecated and will be removed in version 3.0.3.
		 * Use the replacement property "server.undertow.decode-slash" instead.
		 * @since 3.0.3
		 */
		 ...
		 * @param alwaysSetKeepAlive true to always set the keep-alive header, false
		 * otherwise
		 */
		...
		/**
		 * Returns a boolean value indicating whether the path should be preserved on
		 * forward.
		 ...
		 * @param preservePathOnForward true to preserve the path on forward, false
		 * otherwise
		 */
