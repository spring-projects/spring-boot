...
public class ServerProperties {
	...
	/**
	 * Time that connectors wait for another HTTP request before closing the connection. When not set,
	 * the connector's container-specific default is used. Use a value of -1 to indicate no (that is,
	 * an infinite) timeout.
	 */
	...
	public static class Tomcat {
		...
		/**
		 * Whether HTTP 1.1 and later location headers generated by a call to sendRedirect will use
		...
		/**
		 * Maximum number of connections that the server accepts and processes at any given time. Once
		...
		/**
		 * Maximum number of idle processors that will be retained in the cache and reused with a
		 * subsequent request.
		 */
		private int processorCache = 200;

		/**
		 * Comma-separated list of additional patterns that match jars to ignore for TLD scanning. The
		 * special '?' and '*' characters can be used in the pattern to match one and only one character
		...
		public static class Accesslog {
			...
			/**
			 * Directory in which log files are created. Can be absolute or relative to the Tomcat base
			 * dir.
			 */
			...
			/**
			 * Set request attributes for the IP address, Hostname, protocol, and port used for the
			 * request.
			 */
	...
	public static class Jetty {
		...
		/**
		 * Number of acceptor threads to use. When the value is -1, the default, the number of acceptors
		 * is derived from the operating environment.
		 */
		private Integer acceptors = -1;

		/**
		 * Number of selector threads to use. When the value is -1, the default, the number of selectors
		 * is derived from the operating environment.
		 */
	...
	public static class Undertow {
		...
		/**
		 * Maximum size of the HTTP post content. When the value is -1, the default, the size is
		 * unlimited.
		 */
		private DataSize maxHttpPostSize = DataSize.ofBytes(-1);

		/**
		 * Size of each buffer. The default is derived from the maximum amount of memory that is
		 * available to the JVM.
		 */
		private DataSize bufferSize;

		/**
		 * Number of I/O threads to create for the worker. The default is derived from the number of
		...
		/**
		 * Whether to allocate buffers outside the Java heap. The default is derived from the maximum
