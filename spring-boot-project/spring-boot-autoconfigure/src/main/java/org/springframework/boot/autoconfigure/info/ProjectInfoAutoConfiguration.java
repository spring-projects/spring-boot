...
public class ProjectInfoAutoConfiguration {
	...
	/**
	 * Constructs a new instance of ProjectInfoAutoConfiguration with the specified
	...
	/**
	 * Creates a new instance of GitProperties by loading the properties from the
	 * specified location. This method is conditionally executed based on the availability
	 * of GitResourceAvailableCondition and the absence of a bean of type GitProperties.
	...
	/**
	 * Creates a bean of type {@link BuildProperties} if the specified resource is
	 * available and no bean of the same type exists. The resource location is determined
	 * by the property "spring.info.build.location" and defaults to
	...
	/**
	 * Loads properties from a given resource location with a specified prefix and
	 * encoding.
