...
public class Neo4jDataAutoConfiguration {
	...
	/**
	 * Creates a new instance of Neo4jConversions if no other bean of the same type is
	 * present.
	 ...
	 * This bean is responsible for scanning the application context and identifying the
	 * initial entity classes. The initial entity classes are determined by scanning for
	 * classes annotated with @Node or @RelationshipProperties.
	 * @param applicationContext the application context
	 * @return the Neo4jManagedTypes bean
	 * @throws ClassNotFoundException if a class cannot be found during the scanning
	 * process
	 */
	@Bean
	@ConditionalOnMissingBean
	...
	/**
	 * Creates a new instance of {@link Neo4jMappingContext} if no other bean of the same
	 * type is present.
	...
	/**
	 * Creates a {@link DatabaseSelectionProvider} bean if no other bean of the same type
	 * is present. The bean is created based on the provided {@link Neo4jDataProperties}
	 * instance. If the database property is not null, a {@link DatabaseSelectionProvider}
	 * is created using the provided database name. Otherwise, the default
	 * {@link DatabaseSelectionProvider} is returned.
	 * @param properties the {@link Neo4jDataProperties} instance used to determine the
	 * database name
	 ...
	 * @param databaseNameProvider The provider for selecting the database to be used by
	 * the client.
	...
	/**
	 * Creates a new instance of Neo4jTemplate using the provided Neo4jClient and
	 * Neo4jMappingContext.
	...
	/**
	 * Creates a Neo4jTransactionManager bean if no other TransactionManager bean is
	 * present.
