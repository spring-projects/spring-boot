...
public class PropertiesMongoConnectionDetails implements MongoConnectionDetails {
	...
	/**
	 * Constructs a new instance of PropertiesMongoConnectionDetails with the specified
	 * MongoProperties.
	...
	/**
	 * Returns the ConnectionString object based on the properties provided. The
	 * ConnectionString follows the format:
	 * mongodb://[username:password@]host1[:port1][,host2[:port2],...[,hostN[:portN]]][/[database.collection][?options]]
	 * If the URI property is provided, it will be used to create the ConnectionString.
	 * Otherwise, the ConnectionString will be constructed using the individual
	 * properties.
