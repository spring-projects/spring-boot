...
public class SpringIntegrationMetricsIntegrationTests {
	...
	public void springIntegrationMetrics() {
		...
		assertThat(this.registry.mustFind("spring.integration.channel.sends")
				.tags("channel", "convert.input").functionCounter().count()).isEqualTo(1);
		this.registry.mustFind("spring.integration.handler.duration.min").gauge();
		this.registry.mustFind("spring.integration.sourceNames").meter();
	}
