...
public class ReadinessStateHealthIndicator extends AvailabilityStateHealthIndicator {
	...
	/**
	 * Constructs a new ReadinessStateHealthIndicator with the given
	 * ApplicationAvailability.
	 * @param availability the ApplicationAvailability to use for checking the readiness
	 * state
	 */
	...
	/**
	 * Returns the state of the application's readiness based on the provided
	 * ApplicationAvailability object.
	 * @param applicationAvailability the ApplicationAvailability object containing the
	 * availability state of the application
