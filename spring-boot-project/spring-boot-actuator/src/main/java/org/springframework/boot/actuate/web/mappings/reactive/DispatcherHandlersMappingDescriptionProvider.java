...
public class DispatcherHandlersMappingDescriptionProvider implements MappingDescriptionProvider {
	...
	/**
     * Returns a map of handler names to their corresponding list of DispatcherHandlerMappingDescriptions.
     * 
     * @param context the ApplicationContext to retrieve the DispatcherHandlers from
     * @return a map of handler names to their corresponding list of DispatcherHandlerMappingDescriptions
     */
    @Override
	...
	/**
     * Returns a list of DispatcherHandlerMappingDescription objects that describe the mappings of the given DispatcherHandler.
     *
     * @param dispatcherHandler the DispatcherHandler whose mappings need to be described
     * @return a list of DispatcherHandlerMappingDescription objects describing the mappings of the given DispatcherHandler
     */
	...
	/**
     * Describes a handler mapping by iterating through a list of description providers and returning the description provided by the matching provider.
     * 
     * @param handlerMapping the handler mapping to be described
     * @param <T> the type of the handler mapping
     * @return a stream of DispatcherHandlerMappingDescription objects representing the description of the handler mapping
     */
    ...
    private static final class RequestMappingInfoHandlerMappingDescriptionProvider
		...
		/**
         * Returns a list of DispatcherHandlerMappingDescription objects that describe the handler methods
         * in the given RequestMappingInfoHandlerMapping.
         *
    ...
    private static final class UrlHandlerMappingDescriptionProvider
		...
		/**
         * Returns a list of DispatcherHandlerMappingDescription objects that describe the given handler mapping.
         *
		...
		/**
         * Generates a description for a given mapping entry in the form of a DispatcherHandlerMappingDescription object.
         * 
         * @param mapping the mapping entry to describe
         * @return a DispatcherHandlerMappingDescription object containing the description of the mapping
         */
    ...
    private static final class RouterFunctionMappingDescriptionProvider
		...
		/**
         * Generates a list of DispatcherHandlerMappingDescription objects that describe the given RouterFunctionMapping.
         * 
    ...
    private static final class MappingDescriptionVisitor implements Visitor {
         ...
         * 
         * @param predicate the request predicate to be used for the nested mapping description
         */
        @Override
         ...
         * 
         * @param lookupFunction the function used to lookup resources based on the server request
         */
        @Override
    ...
    static class DispatcherHandlersMappingDescriptionProviderRuntimeHints implements RuntimeHintsRegistrar {
		...
		/**
         * Registers the runtime hints for the DispatcherHandlersMappingDescriptionProvider class.
         * 
