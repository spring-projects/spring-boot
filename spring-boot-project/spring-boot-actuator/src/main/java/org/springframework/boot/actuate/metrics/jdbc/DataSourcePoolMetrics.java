...
public class DataSourcePoolMetrics implements MeterBinder {
	 ...
	 * @param metadataProviders the collection of DataSourcePoolMetadataProvider objects
	 * to provide metadata for the DataSource
	...
	/**
	 * Constructs a new DataSourcePoolMetrics object with the specified DataSource,
	 * DataSourcePoolMetadataProvider, name, and tags.
	 * @param dataSource the DataSource to monitor
	 * @param metadataProvider the DataSourcePoolMetadataProvider to retrieve metadata
	 * from
	 ...
	 * @param function the function to extract the pool metadata value from the
	...
	/**
	 * Binds a data source to the given MeterRegistry by creating a Gauge metric with the
	 * provided metricName, description, and function. The function is used to extract a
	 * numeric value from the data source. If the function returns a non-null value for
	 * the data source, the Gauge metric is registered with the MeterRegistry.
	...
	private static class CachingDataSourcePoolMetadataProvider implements DataSourcePoolMetadataProvider {
		...
		/**
		 * Constructs a new CachingDataSourcePoolMetadataProvider with the specified
		 * DataSourcePoolMetadataProvider.
		 * @param metadataProvider the DataSourcePoolMetadataProvider to be used for
		 * retrieving metadata
		 */
		...
		/**
		 * Returns a function that extracts a value of type N from a given DataSource. The
		 * function is obtained by applying the provided function to the
		 * DataSourcePoolMetadata obtained from the given DataSource.
