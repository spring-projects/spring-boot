...
public class MongoReactiveHealthIndicator extends AbstractReactiveHealthIndicator {
	...
	/**
	 * Constructs a new MongoReactiveHealthIndicator with the specified
	 * ReactiveMongoTemplate.
	 * @param reactiveMongoTemplate the ReactiveMongoTemplate to be used for health checks
	 * (must not be null)
	...
	/**
	 * Updates the health status of the application based on the provided builder and
	 * document.
