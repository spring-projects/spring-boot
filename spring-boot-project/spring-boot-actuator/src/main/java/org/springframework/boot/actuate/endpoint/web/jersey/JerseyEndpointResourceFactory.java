...
public class JerseyEndpointResourceFactory {
	 ...
	 * @param remainingPathSegmentProvider The remaining path segment provider for the
	 * resource.
	...
	private static final class OperationInflector implements Inflector<ContainerRequestContext, Object> {
		 ...
		 * @return a Map containing the extracted body arguments, or an empty Map if no
		 * arguments are found
		 */
		 ...
		 * @param requestContext The ContainerRequestContext containing the request
		 * information.
		...
		/**
		 * Retrieves the remaining path segments from the request context or path
		 * parameters.
		 * @param requestContext The container request context.
		 * @param pathParameters The map of path parameters.
		 * @param matchAllRemainingPathSegmentsVariable The variable name for matching all
		 ...
		 * @param requestContext the ContainerRequestContext containing the query
		 * parameters
		...
		/**
		 * Converts the given response object to a JAX-RS Response object based on the
		 * HTTP method.
	...
	private static final class ResourceBodyConverter implements Function<Object, Object> {
		...
		/**
		 * Converts the body of a request to an InputStream if it is an instance of
		 * org.springframework.core.io.Resource.
		 * @param body the body of the request
		 * @return the converted InputStream if the body is an instance of Resource,
		 * otherwise returns the original body
		 * @throws IllegalStateException if an IOException occurs while getting the
		 * InputStream from the Resource
		 */
		@Override
	...
	private static final class MonoBodyConverter implements Function<Object, Object> {
		...
		/**
		 * Applies the given body object. If the body is an instance of Mono, it blocks
		 * and returns the result. Otherwise, it returns the body as is.
	...
	private static final class FluxBodyConverter implements Function<Object, Object> {
		 ...
		 * @param body the body of the request
		 * @return the converted body as a Flux if it is a Flux, otherwise returns the
		 * body as is
		 */
		@Override
		public Object apply(Object body) {
	...
	private static final class EndpointLinksInflector implements Inflector<ContainerRequestContext, Response> {
		...
		/**
		 * Constructs a new instance of EndpointLinksInflector with the specified
