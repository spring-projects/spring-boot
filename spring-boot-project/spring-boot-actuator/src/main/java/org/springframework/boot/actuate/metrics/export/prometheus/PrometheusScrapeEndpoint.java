...
public class PrometheusScrapeEndpoint {
	 ...
	 * @param collectorRegistry the CollectorRegistry object to be used for scraping
	 * metrics
	 */
	...
	/**
	 * Scrapes the metrics from the collector registry and writes them in the specified
	 * format.
	 * @param format The output format to use for writing the metrics.
	 * @param includedNames The set of metric names to include in the scrape. If null, all
	 * metrics will be included.
	 * @return A WebEndpointResponse containing the scraped metrics in the specified
	 * format.
