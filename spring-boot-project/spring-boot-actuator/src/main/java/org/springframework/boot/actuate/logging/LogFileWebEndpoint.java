...
public class LogFileWebEndpoint {
     ...
     * 
     * @return The log file resource as a Resource object, or null if the resource is not available or not readable.
     * 
     * @since 1.0
     */
     ...
     * 
     * If the external file is set, it returns a FileSystemResource using the external file path.
     * If the external file is not set, it checks if the log file is null. If so, it logs a debug message and returns null.
     * If the log file is not null, it returns a FileSystemResource using the log file path.
     * 
     * @return the resource for the log file, or null if the log file is missing or not set
     */
