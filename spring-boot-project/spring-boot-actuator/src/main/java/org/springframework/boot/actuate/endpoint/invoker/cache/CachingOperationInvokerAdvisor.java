...
public class CachingOperationInvokerAdvisor implements OperationInvokerAdvisor {
	...
	/**
	 * Constructs a new CachingOperationInvokerAdvisor with the specified
	 * endpointIdTimeToLive function.
	 * @param endpointIdTimeToLive the function that provides the time to live for each
	 * endpointId
	 */
	...
	/**
	 * Applies the caching operation invoker to the given endpoint and operation type if
	 * applicable.
	 * @param endpointId the ID of the endpoint
	 * @param operationType the type of the operation
	 * @param parameters the operation parameters
	 * @param invoker the original operation invoker
	 * @return the operation invoker, either the original one or a caching operation
	 * invoker
	 */
	@Override
