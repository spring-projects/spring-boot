...
public class TomcatMetricsBinder implements ApplicationListener<ApplicationStartedEvent>, DisposableBean {
	...
	/**
	 * Constructs a new TomcatMetricsBinder with the specified MeterRegistry and an empty
	...
	/**
	 * This method is called when the application has started. It retrieves the
	 * application context from the event and finds the manager. It then creates a new
	 * instance of TomcatMetrics with the manager and tags provided. Finally, it binds the
	 * TomcatMetrics to the meter registry.
	 ...
	 * @param applicationContext the application context to search for the Tomcat web
	 * server
	...
	/**
	 * This method is called when the TomcatMetricsBinder is being destroyed. It closes
	 * the TomcatMetrics instance if it is not null.
	 */
	@Override
	public void destroy() {
