...
class MBeanInfoFactory {
	...
	/**
	 * Constructs a new instance of MBeanInfoFactory with the specified
	 * JmxOperationResponseMapper.
	 * @param responseMapper the JmxOperationResponseMapper to be used by this
	 * MBeanInfoFactory
	 */
	...
	/**
	 * Retrieves the MBean operations from the given ExposableJmxEndpoint and converts
	 * them into an array of ModelMBeanOperationInfo objects.
	 * @param endpoint the ExposableJmxEndpoint from which to retrieve the operations
	 * @return an array of ModelMBeanOperationInfo objects representing the MBean
	 * operations
	 */
	...
	/**
	 * Returns an array of MBeanParameterInfo objects representing the signature of the
	 * operation.
	 * @param parameters the list of JmxOperationParameter objects
	 * @return an array of MBeanParameterInfo objects representing the signature of the
	 * operation
	 */
	...
	/**
	 * Returns an instance of MBeanParameterInfo based on the provided
	 * JmxOperationParameter.
	 * @param parameter the JmxOperationParameter object to create MBeanParameterInfo from
	 * @return an instance of MBeanParameterInfo with the specified name, type, and
	 * description
	 */
	 ...
	 * <ul>
	 * <li>{@link MBeanOperationInfo#INFO} if the operation type is
	 * {@link OperationType#READ}</li>
	 * <li>{@link MBeanOperationInfo#ACTION} if the operation type is
	 * {@link OperationType#WRITE} or {@link OperationType#DELETE}</li>
