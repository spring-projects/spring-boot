...
final class RedisHealth {
	...
	/**
     * Returns a new instance of the Health.Builder class with the "version" detail set to the value of the "redis_version" property from the provided Properties object.
     * 
     ...
     * @return a new instance of the Health.Builder class with the "version" detail set and marked as "up"
     */
	...
	/**
     * Creates a new instance of the {@link Builder} class using the provided {@link Health.Builder} and {@link ClusterInfo} objects.
     * 
     * @param builder The {@link Health.Builder} object to use for building the health status.
     * @param clusterInfo The {@link ClusterInfo} object containing the cluster information.
     * @return A new instance of the {@link Builder} class with the health status set based on the cluster information.
     */
