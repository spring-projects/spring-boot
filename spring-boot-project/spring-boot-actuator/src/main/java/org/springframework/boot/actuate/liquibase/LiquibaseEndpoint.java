...
public class LiquibaseEndpoint {
	 ...
	 * @return The Liquibase beans descriptor containing information about the Liquibase
	...
	public static final class LiquibaseBeansDescriptor implements OperationResponseBody {
		 ...
		 * @param contexts the map of contexts to be associated with this
	...
	public static final class ContextLiquibaseBeansDescriptor {
		...
		/**
		 * Constructs a new ContextLiquibaseBeansDescriptor with the specified
		 * liquibaseBeans and parentId.
	...
	public static final class LiquibaseBeanDescriptor {
		...
		/**
		 * Constructs a new LiquibaseBeanDescriptor with the specified list of
		 * ChangeSetDescriptors.
		 * @param changeSets the list of ChangeSetDescriptors to be associated with this
		 * LiquibaseBeanDescriptor
		 */
	...
	public static class ChangeSetDescriptor {
		...
		/**
		 * Constructs a ChangeSetDescriptor object based on the provided RanChangeSet
		 * object.
		 * @param ranChangeSet the RanChangeSet object to create the ChangeSetDescriptor
		 * from
		 */
	...
	public static class ContextExpressionDescriptor {
		...
		/**
		 * Constructs a new ContextExpressionDescriptor with the specified set of
		 * contexts.
