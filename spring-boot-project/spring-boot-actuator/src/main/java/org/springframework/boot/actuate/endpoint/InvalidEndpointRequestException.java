...
public class InvalidEndpointRequestException extends RuntimeException {
	...
	/**
	 * Constructs a new InvalidEndpointRequestException with the specified message and
	 * reason.
	...
	/**
	 * Constructs a new InvalidEndpointRequestException with the specified detail message,
	 * reason, and cause.
