...
class PlainTextThreadDumpFormatter {
	 ...
	 *
	 * The preamble includes the current date and time, the VM name, version, and
	 * information.
	 ...
	 * @param lockedMonitors An array of MonitorInfo objects representing the locked
	 * monitors.
	 */
	 ...
	 * @param lockedMonitorsAtCurrentDepth The list of MonitorInfo objects representing
	 * the locked monitors at the current depth.
	 */
