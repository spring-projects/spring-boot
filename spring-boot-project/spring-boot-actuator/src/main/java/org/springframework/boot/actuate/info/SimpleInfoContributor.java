...
public class SimpleInfoContributor implements InfoContributor {
	...
	/**
	 * Contributes additional information to the provided Info.Builder object. If the
	 * detail is not null, it adds the detail to the builder with the specified prefix.
