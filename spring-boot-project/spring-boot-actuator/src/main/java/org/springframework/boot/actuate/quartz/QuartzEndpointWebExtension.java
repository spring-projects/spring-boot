...
public class QuartzEndpointWebExtension {
	...
	/**
	 * Constructs a new QuartzEndpointWebExtension with the specified delegate,
	...
	/**
	 * Handles the request for either "jobs" or "triggers" and returns the appropriate
	 * response.
	 ...
	 * @return a WebEndpointResponse object containing the value if it is not null,
	 * otherwise a WebEndpointResponse object with a status of STATUS_NOT_FOUND
	 */
