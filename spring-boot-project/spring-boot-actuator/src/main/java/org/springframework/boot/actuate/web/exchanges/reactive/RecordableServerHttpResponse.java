...
class RecordableServerHttpResponse implements RecordableHttpResponse {
	...
	/**
	 * Constructs a new RecordableServerHttpResponse object based on the provided
	 * ServerHttpResponse.
	 * @param response the ServerHttpResponse object to be used for constructing the
	 * RecordableServerHttpResponse
	 ...
	 * @return the headers of the server HTTP response as a map, where each key represents
	 * a header name and each value represents a list of header values
	 */
	@Override
