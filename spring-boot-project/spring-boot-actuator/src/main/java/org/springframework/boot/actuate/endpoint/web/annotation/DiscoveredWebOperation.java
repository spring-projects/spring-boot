...
class DiscoveredWebOperation extends AbstractDiscoveredOperation implements WebOperation {
	...
	/**
     * Returns the ID of the web operation based on the provided endpoint ID and operation method.
     * The ID is generated by concatenating the endpoint ID with the dash-separated names of the method parameters
