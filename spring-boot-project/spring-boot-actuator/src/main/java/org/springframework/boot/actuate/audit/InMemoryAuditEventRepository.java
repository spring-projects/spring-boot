...
public class InMemoryAuditEventRepository implements AuditEventRepository {
	 ...
	 * @param capacity the maximum number of AuditEvents that can be stored in the
	 * repository
	 */
	...
	/**
	 * Resolves the tail event from the InMemoryAuditEventRepository based on the given
	 * offset.
