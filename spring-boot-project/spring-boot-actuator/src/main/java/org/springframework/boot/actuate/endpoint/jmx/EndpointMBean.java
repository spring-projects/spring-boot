...
public class EndpointMBean implements DynamicMBean {
	...
	/**
	 * Constructs a new EndpointMBean with the specified response mapper, class loader,
	 * and endpoint.
	 * @param responseMapper the JmxOperationResponseMapper used to map JMX operation
	 * responses
	 ...
	 * @return a map of JMX operations, where the key is the operation name and the value
	 * is the {@link JmxOperation} object
	 */
	 ...
	 * @throws ReflectionException if a reflection-related exception occurs during the
	 ...
	 * @throws AttributeNotFoundException if the specified attribute is not found in the
	 * EndpointMBean
	 * @throws MBeanException if a problem occurs while retrieving the attribute
	 * @throws ReflectionException if a reflection-related problem occurs while retrieving
	 * the attribute
	 */
	@Override
	...
	private static final class ReactiveHandler {
		...
		/**
		 * Handles the result object by converting it to a list if it is a Flux, or
		 * blocking and returning the value if it is a Mono.
