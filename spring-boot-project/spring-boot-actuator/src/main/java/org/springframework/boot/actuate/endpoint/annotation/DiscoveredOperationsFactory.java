...
abstract class DiscoveredOperationsFactory<O extends Operation> {
	...
	/**
	 * Constructs a new DiscoveredOperationsFactory with the specified
	 * ParameterValueMapper and collection of OperationInvokerAdvisors.
	 * @param parameterValueMapper the ParameterValueMapper used for mapping parameter
	 * values
	 * @param invokerAdvisors the collection of OperationInvokerAdvisors used for advising
	 * operation invokers
	 */
	...
	/**
	 * Creates a new operation with the specified endpoint ID, operation method, and
	 * invoker.
	 * @param endpointId the ID of the endpoint
