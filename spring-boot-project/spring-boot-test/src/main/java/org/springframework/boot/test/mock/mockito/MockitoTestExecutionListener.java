...
public class MockitoTestExecutionListener extends AbstractTestExecutionListener {
	...
	/**
     * Returns the order value for this test execution listener.
     ...
     * 
     * This method is called before each test method is executed. It performs the following steps:
     * 1. Closes any existing mocks to ensure a clean state.
     * 2. Initializes the mocks for the test instance.
     * 3. Injects any required fields into the test instance.
     * 
     ...
     * It checks if the dependencies need to be reinjected and performs the necessary actions.
     * If the "REINJECT_DEPENDENCIES_ATTRIBUTE" attribute is set to true in the test context,
     * it closes the existing mocks, initializes new mocks, and reinjects the fields.
     * 
	...
	/**
     * Callback after a test method has been executed.
     * This method is responsible for closing any mocks that were created during the test.
     *
     ...
     * @param consumer The consumer function to apply to each Mockito field and post-processor.
     */
	...
	private static final class MockitoAnnotationCollection implements FieldCallback {
		...
		/**
         * Iterates over the annotations declared on a given field and adds the annotations
         * that belong to the Mockito framework to the collection of annotations.
         * 
         ...
         * 
         * @return true if the MockitoAnnotationCollection has annotations, false otherwise.
         */
    ...
    private static final class MockitoField {
		...
		/**
         * Constructs a new MockitoField object with the specified field, instance, and definition.
         * 
