...
public class LocalHostWebConnectionHtmlUnitDriver extends WebConnectionHtmlUnitDriver {
	...
	/**
	 * Constructs a new LocalHostWebConnectionHtmlUnitDriver with the specified
	 * environment.
	...
	/**
	 * Constructs a new LocalHostWebConnectionHtmlUnitDriver with the specified
	 * environment and enableJavascript flag.
	 * @param environment the environment to be used for the driver
	...
	/**
	 * Sends a GET request to the specified URL. If the URL starts with "/", it is assumed
	 * to be a relative path and the local server port is appended to it. The request is
	 * then sent using the super class's get method.
