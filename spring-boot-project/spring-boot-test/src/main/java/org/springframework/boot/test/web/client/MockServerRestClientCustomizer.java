...
public class MockServerRestClientCustomizer implements RestClientCustomizer {
	...
	/**
	 * Constructs a new MockServerRestClientCustomizer with the default
	...
	/**
	 * Customizes the RestClient.Builder by creating a MockRestServiceServer and a
	...
	/**
	 * Creates a new instance of RequestExpectationManager using the
	 ...
	 * @throws IllegalStateException if the MockServerRestClientCustomizer has not been
	 * bound to a RestClient
	 * @throws IllegalStateException if the MockServerRestClientCustomizer has been bound
	 * to more than one RestClient
	 */
	 ...
	 * @param restClientBuilder the RestClient.Builder for which to retrieve the
	...
	/**
	 * Returns an unmodifiable map of RestClient.Builder objects and their corresponding
	 * MockRestServiceServer objects.
	 * @return an unmodifiable map of RestClient.Builder objects and their corresponding
	 * MockRestServiceServer objects
	 */
