...
class SpringBootTestRandomPortEnvironmentPostProcessor implements EnvironmentPostProcessor {
	...
	/**
	 * This method is used to post-process the environment and application for the Spring
	 * Boot test. It checks if the test server port is fixed or if the test management
	 * port is already configured. If not, it sets the management port to 0 if it is not
	 * already set to -1 or 0. If the management port is the same as the server port, it
	 * sets the management port to an empty string.
	 ...
	 * @return {@code true} if the test management port is configured, {@code false}
	 * otherwise
	 */
	...
	/**
	 * Retrieves the value of the specified property as an Integer from the given
	 * ConfigurableEnvironment.
	 * @param environment the ConfigurableEnvironment from which to retrieve the property
	 * value
	 * @param property the name of the property to retrieve
	 * @param defaultValue the default value to return if the property is not found or
	 * cannot be converted to an Integer
	 * @return the value of the property as an Integer, or the defaultValue if the
	 * property is not found or cannot be converted
	 */
	...
	/**
	 * Retrieves the value of a property as an Integer from the given PropertySource. If
	 * the property is not found or cannot be converted to an Integer, null is returned.
	 ...
	 * @return the value of the property as an Integer, or null if not found or cannot be
	 * converted
	 ...
	 * @return the resolved and converted Integer value, or null if conversion is not
	 * possible
	 */
