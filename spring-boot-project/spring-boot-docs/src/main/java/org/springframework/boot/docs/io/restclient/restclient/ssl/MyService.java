...
public class MyService {
	...
	/**
	 * Constructs a new instance of MyService with the provided RestClient.Builder and
	 * RestClientSsl.
	 * @param restClientBuilder the RestClient.Builder used to build the RestClient
	 * instance
	 * @param ssl the RestClientSsl used to configure SSL settings for the RestClient
	 * instance
	 */
