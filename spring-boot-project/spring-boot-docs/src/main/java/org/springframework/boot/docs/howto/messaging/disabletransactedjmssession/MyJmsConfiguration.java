...
public class MyJmsConfiguration {
	...
	/**
	 * Creates a JMS listener container factory with the given connection factory and
	 * configurer.
	 * @param connectionFactory the connection factory to be used by the listener
	 * container factory
