...
public class MyHealthMetricsExportConfiguration {
	...
	/**
	 * Constructs a new MyHealthMetricsExportConfiguration with the given MeterRegistry
	 * and HealthEndpoint.
	 ...
	 * @return the status code: - 3 if the status is UP - 2 if the status is
	 * OUT_OF_SERVICE - 1 if the status is DOWN - 0 if the status is unknown or null
	 */
