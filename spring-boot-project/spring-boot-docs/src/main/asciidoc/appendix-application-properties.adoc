...
----
	...
	server.servlet.session.cookie.same-site= # The "SameSite" directive for the cookie.
	...
	# CONDITIONS REPORT ENDPOINT ({spring-boot-actuator-autoconfigure-module-code}/condition/ConditionsReportEndpoint.java[ConditionsReportEndpoint])
	...
	# ENVIRONMENT ENDPOINT ({spring-boot-actuator-module-code}/env/EnvironmentEndpoint.java[EnvironmentEndpoint], {spring-boot-actuator-autoconfigure-module-code}/env/EnvironmentEndpointProperties.java[EnvironmentEndpointProperties])
	...
	# FLYWAY ENDPOINT ({spring-boot-actuator-module-code}/flyway/FlywayEndpoint.java[FlywayEndpoint])
	...
	# HEAP DUMP ENDPOINT ({spring-boot-actuator-module-code}/management/HeapDumpWebEndpoint.java[HeapDumpWebEndpoint])
	management.endpoint.heapdump.cache.time-to-live=0ms # Maximum time that a response can be cached.
	management.endpoint.heapdump.enabled=true # Whether to enable the heapdump endpoint.

	# HTTP TRACE ENDPOINT ({spring-boot-actuator-module-code}/trace/http/HttpTraceEndpoint.java[HttpTraceEndpoint])
	...
	# INFO ENDPOINT ({spring-boot-actuator-module-code}/info/InfoEndpoint.java[InfoEndpoint])
	...
	# INTEGRATION GRAPH ENDPOINT ({spring-boot-actuator-module-code}/integration/IntegrationGraphEndpoint.java[IntegrationGraphEndpoint])
	...
	# JOLOKIA ENDPOINT ({spring-boot-actuator-autoconfigure-module-code}/jolokia/JolokiaProperties.java[JolokiaProperties])
	...
	# LIQUIBASE ENDPOINT ({spring-boot-actuator-module-code}/liquibase/LiquibaseEndpoint.java[LiquibaseEndpoint])
	...
	# LOG FILE ENDPOINT ({spring-boot-actuator-module-code}/logging/LogFileWebEndpoint.java[LogFileWebEndpoint], {spring-boot-actuator-autoconfigure-module-code}/logging/LogFileWebEndpointProperties.java[LogFileWebEndpointProperties])
	...
	# LOGGERS ENDPOINT ({spring-boot-actuator-module-code}/logging/LoggersEndpoint.java[LoggersEndpoint])
	...
	# REQUEST MAPPING ENDPOINT  ({spring-boot-actuator-module-code}/web/mappings/MappingsEndpoint.java[MappingsEndpoint])
	...
	# METRICS ENDPOINT ({spring-boot-actuator-module-code}/metrics/MetricsEndpoint.java[MetricsEndpoint])
	...
	# PROMETHEUS ENDPOINT ({spring-boot-actuator-module-code}/metrics/export/prometheus/PrometheusScrapeEndpoint.java[PrometheusScrapeEndpoint])
	...
	# SCHEDULED TASKS ENDPOINT ({spring-boot-actuator-module-code}/scheduling/ScheduledTasksEndpoint.java[ScheduledTasksEndpoint])
	...
	# SESSIONS ENDPOINT ({spring-boot-actuator-module-code}/session/SessionsEndpoint.java[SessionsEndpoint])
	management.endpoint.sessions.enabled=true # Whether to enable the sessions endpoint.

	# SHUTDOWN ENDPOINT ({spring-boot-actuator-module-code}/context/ShutdownEndpoint.java[ShutdownEndpoint])
	management.endpoint.shutdown.enabled=false # Whether to enable the shutdown endpoint.

	# THREAD DUMP ENDPOINT ({spring-boot-actuator-module-code}/management/ThreadDumpEndpoint.java[ThreadDumpEndpoint])
	...
	# HTTP TRACING ({spring-boot-actuator-autoconfigure-module-code}/trace/http/HttpTraceProperties.java[HttpTraceProperties])
	...
	# INFO CONTRIBUTORS ({spring-boot-actuator-autoconfigure-module-code}/info/InfoContributorProperties.java[InfoContributorProperties])
	...
	# DEVTOOLS ({spring-boot-devtools-module-code}/autoconfigure/DevToolsProperties.java[DevToolsProperties])
	...
	# REMOTE DEVTOOLS ({spring-boot-devtools-module-code}/autoconfigure/RemoteDevToolsProperties.java[RemoteDevToolsProperties])
