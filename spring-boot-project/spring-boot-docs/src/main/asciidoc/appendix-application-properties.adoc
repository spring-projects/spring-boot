...
----
	...
	spring.metrics.export.cloudwatch.namespace= # AWS CloudWatch namespace.
    spring.metrics.export.cloudwatch.batch-size= # Number of measurements per request to use for the backend. If more measurements are found, then multiple requests will be made. Max 20.
    spring.metrics.export.cloudwatch.connect-timeout= # Connection timeout for requests to the backend.
    spring.metrics.export.cloudwatch.enabled= # Whether exporting of metrics to this backend is enabled.
    spring.metrics.export.cloudwatch.num-threads= # Number of threads to use with the metrics publishing scheduler.
    spring.metrics.export.cloudwatch.read-timeout= # Read timeout for requests to the backend.
    spring.metrics.export.cloudwatch.step=1m # Step size (i.e. reporting frequency) to use.
