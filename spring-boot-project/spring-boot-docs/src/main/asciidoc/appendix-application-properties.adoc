...
----
	...
	spring.hazelcast.client.config= # The location of the configuration file to use to initialize Hazelcast client.
	spring.hazelcast.jet.config= # The location of the configuration file to use to initialize Hazelcast Jet.
