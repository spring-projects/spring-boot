...
.Kotlin
----
include::{code-examples}/configuration/kotlin/MySpringConfiguration.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/configuration/kotlin/CustomizedSpringConfiguration.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/builder/kotlin/SpringApplicationBuilderExample.kt[tag=hierarchy]
----
...
.Kotlin
----
include::{code-examples}/configuration/kotlin/MyBean.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/configuration/kotlin/CommandLineRunnerBean.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/KotlinExitCodeApplication.kt[tag=example]
----
...
.Kotlin
----
include::{code-examples}/configuration/kotlin/UsingExternalizedProperties.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/configuration/kotlin/Config.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/context/properties/bind/kotlin/AcmeProperties.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/context/properties/bind/kotlin/ImmutableAcmeProperties.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/MyApplication.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/configuration/kotlin/MyConfiguration.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/service/kotlin/MyService.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/configuration/kotlin/ThirdPartyConfiguration.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/context/properties/bind/kotlin/OwnerProperties.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/context/properties/bind/kotlin/ComplexAcmeProperties.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/context/properties/bind/kotlin/MapAcmeProperties.kt[tag=customizer]
----
Consider the following configuration:
...
.Kotlin
----
include::{code-examples}/context/properties/bind/kotlin/AppSystemProperties.kt[tag=example]
----
...
.Kotlin
----
include::{code-examples}/context/properties/bind/kotlin/AppIoProperties.kt[tag=example]
----
...
.Kotlin
----
include::{code-examples}/context/properties/bind/kotlin/ValidatedAcmeProperties.kt[tag=example]
----
...
.Kotlin
----
include::{code-examples}/context/properties/bind/kotlin/NestedValidatedAcmeProperties.kt[tag=example]
----
