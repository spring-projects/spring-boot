...
.Kotlin
----
include::{code-examples}/configuration/kotlin/AcmeProperties.kt[tag=customizer]
----
...
.Kotlin
----
include::{code-examples}/configuration/kotlin/ImmutableAcmeProperties.kt[tag=customizer]
----
