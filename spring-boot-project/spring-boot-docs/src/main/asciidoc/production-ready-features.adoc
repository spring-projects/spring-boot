...
can be customized by setting the `spring.metrics.web.server.requests-metrics-name` property.
...
can be customized by setting the `spring.metrics.web.client.requests-metrics-name` property.
...
Auto-configuration enables binding of a number of Spring Integration-related
metrics:
