...
----
include::{docs-kotlin}/howto/webserver/discoverport/MyWebIntegrationTests.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/webserver/configure/MyTomcatWebServerCustomizer.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/webserver/addservletfilterlistener/springbean/disable/MyFilterConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/webserver/enablemultipleconnectorsintomcat/MyTomcatConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/webserver/usetomcatlegacycookieprocessor/MyLegacyCookieProcessorConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/webserver/enablemultiplelistenersinundertow/MyUndertowConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/webserver/createwebsocketendpointsusingserverendpoint/MyWebSocketConfiguration.kt[]
----
