...
----
include::{docs-kotlin}/howto/testing/withspringsecurity/MySecurityTests.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/testing/testcontainers/vanilla/MyIntegrationTests.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/testing/testcontainers/dynamicproperties/MyIntegrationTests.kt[]
----
