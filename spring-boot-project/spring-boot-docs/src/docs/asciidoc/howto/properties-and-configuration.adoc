...
----
include::{docs-kotlin}/howto/propertiesandconfiguration/externalizeconfiguration/application/MyApplication.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/propertiesandconfiguration/externalizeconfiguration/builder/MyApplication.kt[]
----
