...
If you use the `spring-boot-starter-parent`, you can then see your Maven '`project properties`' with `@..@` placeholders, as shown in the following example:
...
You can then see your Gradle project's properties by using placeholders, as shown in the following example:
