...
----
include::{docs-kotlin}/howto/jersey/springsecurity/JerseySetStatusOverSendErrorConfig.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/jersey/alongsideanotherwebframework/JerseyConfig.kt[]
----