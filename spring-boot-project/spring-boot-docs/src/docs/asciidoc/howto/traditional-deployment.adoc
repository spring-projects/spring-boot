...
----
include::{docs-kotlin}/howto/traditionaldeployment/war/MyApplication.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/traditionaldeployment/convertexistingapplication/MyApplication.kt[tag=!main]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/traditionaldeployment/convertexistingapplication/both/MyApplication.kt[]
----
====
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/howto/traditionaldeployment/weblogic/MyApplication.kt[]
----
