...
| configprop:logging.pattern.console.simple[]
| `CONSOLE_LOG_PATTERN_SIMPLE`
| Boolean flag which indicates whether to use simple log pattern on the console (stdout) or not. Ignored, if `CONSOLE_LOG_PATTERN` is specified.
