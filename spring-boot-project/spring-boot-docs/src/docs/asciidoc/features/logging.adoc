...
TIP: When you deploy your application to a servlet container or application server, logging performed through the Java Util Logging API is not routed into your application's logs.
