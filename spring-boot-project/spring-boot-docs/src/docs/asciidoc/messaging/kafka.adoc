...
----
include::{docs-kotlin}/messaging/kafka/sending/MyBean.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/messaging/kafka/receiving/MyBean.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/messaging/kafka/streams/MyKafkaStreamsConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/messaging/kafka/embedded/property/MyTest.kt[tag=*]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/messaging/kafka/embedded/annotation/MyTest.kt[]
----
