...
If you want to take full control over the embedded broker, please take a look on https://activemq.apache.org/how-do-i-embed-a-broker-inside-a-connection.html[the ActiveMQ documentation].
