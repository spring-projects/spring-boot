...
----
include::{docs-kotlin}/using/usingthespringbootapplicationannotation/springapplication/MyApplication.kt[]
----
...
[source,java,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/using/usingthespringbootapplicationannotation/individualannotations/MyApplication.kt[]
----
