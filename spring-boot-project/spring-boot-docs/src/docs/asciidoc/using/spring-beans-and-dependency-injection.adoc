...
----
include::{docs-kotlin}/using/springbeansanddependencyinjection/singleconstructor/MyAccountService.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/using/springbeansanddependencyinjection/multipleconstructors/MyAccountService.kt[]
----
