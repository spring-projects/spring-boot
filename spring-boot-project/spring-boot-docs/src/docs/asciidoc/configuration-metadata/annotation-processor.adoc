...
----
include::{docs-kotlin}/configurationmetadata/annotationprocessor/automaticmetadatageneration/MyServerProperties.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/configurationmetadata/annotationprocessor/automaticmetadatageneration/MyMessagingProperties.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/configurationmetadata/annotationprocessor/automaticmetadatageneration/nestedproperties/MyServerProperties.kt[]
----
