...
Default values have to be provided statically. In particular, do not see a constant defined in another class.
...
If you see a property that has been detected automatically, the description, default value, and deprecation information are overridden, if specified.
