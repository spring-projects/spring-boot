...
----
include::{docs-kotlin}/features/security/springwebflux/MyWebFluxSecurityConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/features/security/oauth2/client/MyOAuthClientConfiguration.kt[]
----
