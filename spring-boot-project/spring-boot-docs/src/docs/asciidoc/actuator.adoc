...
|If enabled, <<spring-boot-features#features.graceful-shutdown,graceful shutdown processes in-flight requests>>.
...
- <<actuator.metrics.export.appoptics,AppOptics>>
- <<actuator.metrics.export.atlas,Atlas>>
- <<actuator.metrics.export.datadog,Datadog>>
- <<actuator.metrics.export.dynatrace,Dynatrace>>
- <<actuator.metrics.export.elastic,Elastic>>
- <<actuator.metrics.export.ganglia,Ganglia>>
- <<actuator.metrics.export.graphite,Graphite>>
- <<actuator.metrics.export.humio,Humio>>
- <<actuator.metrics.export.influx,Influx>>
- <<actuator.metrics.export.jmx,JMX>>
- <<actuator.metrics.export.kairos,KairosDB>>
- <<actuator.metrics.export.newrelic,New Relic>>
- <<actuator.metrics.export.prometheus,Prometheus>>
- <<actuator.metrics.export.signalfx,SignalFx>>
- <<actuator.metrics.export.simple,Simple (in-memory)>>
- <<actuator.metrics.export.stackdriver,Stackdriver>>
- <<actuator.metrics.export.statsd,StatsD>>
- <<actuator.metrics.export.wavefront,Wavefront>>
...
* <<actuator.process-monitoring.configuration,By Extending Configuration>>
