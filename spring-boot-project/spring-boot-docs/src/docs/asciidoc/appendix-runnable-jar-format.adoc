[appendix]
[[runnable-jar]]
= The Runnable Jar Format
include::attributes.adoc[]

The `spring-boot-loader` modules lets Spring Boot support runnable jar and war files.
If you use the Maven plugin or the Gradle plugin, runnable jars are automatically generated, and you generally do not need to know the details of how they work.

If you need to create runnable jars from a different build system or if you are just curious about the underlying technology, this appendix provides some background.



[[runnable-jar-nested-jars]]
== Nested JARs
...
[[runnable-jar-jar-file-structure]]
=== The Runnable Jar File Structure
...
[[runnable-jar-war-file-structure]]
=== The Runnable War File Structure
...
[[runnable-jar-war-index-files-classpath]]
=== Classpath Index
...
[[runnable-jar-war-index-files-layers]]
=== Layer Index
...
[[runnable-jar-jarfile-compatibility]]
...
[[runnable-jar-launching]]
== Launching Runnable Jars
The `org.springframework.boot.loader.Launcher` class is a special bootstrap class that is used as an runnable jar's main entry point.
...
[[runnable-jar-launcher-manifest]]
=== Launcher Manifest
...
The following example shows a typical `MANIFEST.MF` for an runnable jar file:
...
[[runnable-jar-property-launcher-features]]
...
[[runnable-jar-system-classloader]]
* System classLoader:
