...
public final class ItemMetadata implements Comparable<ItemMetadata> {
	...
	/**
     * Compares this ItemMetadata object to the specified object for equality.
     * Returns true if the specified object is also an ItemMetadata object and
     ...
     * @return true if the given object is equal to this ItemMetadata object, false otherwise
     */
    @Override
	...
	/**
     * Builds a string representation of a property and its value and appends it to the given StringBuilder.
     * 
	...
	/**
     * Compares this ItemMetadata object with the specified ItemMetadata object for order based on their names.
     * 
     * @param o the ItemMetadata object to be compared
     * @return a negative integer, zero, or a positive integer as this ItemMetadata object is less than, equal to, or greater than the specified ItemMetadata object
	...
	/**
     * Creates a new group item metadata with the specified name, type, source type, and source method.
     * 
     ...
     * The prefix is converted to lowercase using the English locale.
     * The suffix is converted to dashed case.
     * 
