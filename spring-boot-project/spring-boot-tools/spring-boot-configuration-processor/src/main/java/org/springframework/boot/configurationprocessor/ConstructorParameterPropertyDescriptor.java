...
class ConstructorParameterPropertyDescriptor extends PropertyDescriptor<VariableElement> {
	...
	/**
     * Constructs a new ConstructorParameterPropertyDescriptor with the specified parameters.
     * 
     * @param ownerElement the TypeElement representing the owner of the property descriptor
     * @param factoryMethod the ExecutableElement representing the factory method used to create the property descriptor
     * @param source the VariableElement representing the source of the property descriptor
    ...
    private static final class DefaultValueCoercionTypeVisitor extends TypeKindVisitor8<Object, String> {
		...
		/**
         * Visits a primitive type as a boolean and returns the corresponding boolean value.
         * 
