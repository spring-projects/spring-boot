...
class MetadataGenerationEnvironment {
	 ...
	 * @param configurationPropertiesAnnotation the fully qualified name of the annotation
	 * used for configuration properties
	 * @param nestedConfigurationPropertyAnnotation the fully qualified name of the
	 * annotation used for nested configuration properties
	 * @param deprecatedConfigurationPropertyAnnotation the fully qualified name of the
	 * annotation used for deprecated configuration properties
	 * @param constructorBindingAnnotation the fully qualified name of the annotation used
	 * for constructor binding
	 * @param autowiredAnnotation the fully qualified name of the annotation used for
	 * autowiring
	 * @param defaultValueAnnotation the fully qualified name of the annotation used for
	 * default values
	 * @param endpointAnnotations a set of fully qualified names of annotations used for
	 * defining endpoints
	 * @param readOperationAnnotation the fully qualified name of the annotation used for
	 * read operations
	 * @param nameAnnotation the fully qualified name of the annotation used for defining
	 * names
	 */
	 ...
	 * @return true if the ExecutableElement has the constructor binding annotation, false
	 * otherwise
	 */
	 ...
	 * @param element the ExecutableElement to check
	 * @return true if the ExecutableElement has the @Autowired annotation, false
	 * otherwise
	 */
	...
	/**
	 * Checks if the given annotation element or any of its meta-annotations have the
	 * specified type.
	 ...
	 * @return true if the annotation element or any of its meta-annotations have the
	...
	/**
	 * Recursively collects elements that are annotated or meta-annotated with the
	 ...
	 * @return true if an element annotated with the specified annotation type is found,
	 * false otherwise
	 */
	 ...
	 * @return the string representation of the object, or null if the object is null or
	 * empty
	 */
	...
	/**
	 * Returns the TypeElement representing the annotation used for configuration
	 * properties.
	...
	/**
	 * Retrieves the annotation mirror for the configuration properties annotation from
	 * the given element.
	 * @param element the element from which to retrieve the annotation mirror
	 * @return the annotation mirror for the configuration properties annotation, or null
	 * if not found
	 */
	...
	/**
	 * Retrieves the nested configuration property annotation mirror for the given
	 * element.
	...
	/**
	 * Retrieves the annotation mirror for the default value annotation of the specified
	 * element.
	 * @param element the element for which to retrieve the default value annotation
	 * @return the annotation mirror for the default value annotation, or null if not
	 * found
	 */
	...
	/**
	 * Returns a set of TypeElement objects representing the endpoint annotations used in
	 * the MetadataGenerationEnvironment.
	...
	/**
	 * Retrieves the annotation mirror for the read operation annotation on the specified
	 * element.
	 * @param element the element to retrieve the annotation mirror from
	 * @return the annotation mirror for the read operation annotation, or null if not
	 * found
	 */
	 ...
	 * @param element the element for which to retrieve the annotation mirror
	 * @return the annotation mirror for the element's name annotation, or null if not
	 * found
	 */
	 ...
	 * @return a Map containing the resolved field values, with field names as keys and
