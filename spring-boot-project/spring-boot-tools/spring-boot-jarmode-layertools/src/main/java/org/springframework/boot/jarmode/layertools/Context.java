...
class Context {
	...
	/**
	 * Deduces the relative directory path between the source directory and the working
	 * directory.
	 ...
	 * @return The relative directory path between the source directory and the working
	 * directory, or null if the source directory is the same as the working directory or
	 * if the source directory is not a subdirectory of the working directory.
	 */
