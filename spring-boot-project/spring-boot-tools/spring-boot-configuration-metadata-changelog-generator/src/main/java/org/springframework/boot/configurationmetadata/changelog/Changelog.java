...
record Changelog(String oldVersionNumber, String newVersionNumber, List<Difference> differences) {
	...
	/**
	 * Generates a changelog based on the differences between two versions of a
	 * configuration metadata repository.
	 * @param oldVersionNumber the version number of the old configuration metadata
	 * repository
	 * @param oldMetadata the old configuration metadata repository
	 * @param newVersionNumber the version number of the new configuration metadata
	 * repository
