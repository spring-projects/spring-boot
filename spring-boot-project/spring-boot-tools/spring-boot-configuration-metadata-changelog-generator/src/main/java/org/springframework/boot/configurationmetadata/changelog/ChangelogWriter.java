...
class ChangelogWriter implements AutoCloseable {
     ...
     * @return a Map object where the keys are DifferenceType and the values are lists of Difference objects
     */
	...
	/**
     * Returns a list of removed differences by filtering out the deprecated differences from the deleted differences.
     * 
     * @param deleted     the list of deleted differences
     * @param deprecated  the list of deprecated differences
     ...
     * @param extractor the function used to extract the ConfigurationMetadataProperty from each Difference object
	...
	/**
     * Returns the first non-null result obtained by applying the given extractors to the specified object.
     * 
     ...
     * @return the first non-null result obtained by applying the extractors, or null if all results are null
     * 
	...
	/**
     * Writes a table with the given header and rows using the provided action to process each row.
     * If the rows list is empty, it writes "_None_".
     * 
     ...
     * 
     * @param property the ConfigurationMetadataProperty object representing the deprecated property
     */
     ...
     * If the text is null, null is returned.
     * If the text contains a period ('.'), the first sentence is extracted using a BreakIterator.
     * If the text does not contain a period, the first line of the text is returned.
     * 
     * @param text the text from which to extract the first sentence
     * @return the first sentence of the text, or the first line if no period is found, or null if the text is null
     */
	...
	/**
     * Writes the content to a cell in the changelog table.
     * If the content is null, a new line is written.
     * Otherwise, the content is escaped and written with a preceding pipe character.
     *
	...
	/**
     * Escapes the given content for a table cell in a ChangelogWriter.
     ...
     * If the object is an array, it converts each element to its string representation and joins them with a comma.
     * 
