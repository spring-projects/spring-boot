...
public final class ChangelogGenerator {
	...
	/**
	 * Generates a Changelog file by reading the contents of a source file and writing it
	 ...
	 * @param oldDir The directory containing the old version of the configuration
	 * metadata.
	 * @param newDir The directory containing the new version of the configuration
	 * metadata.
	...
	/**
	 * Builds a ConfigurationMetadataRepository by scanning the given directory for jar
	 * files and extracting the spring-configuration-metadata.json file from each jar
	 * file.
