...
public class LaunchScriptConfiguration implements Serializable {
	 ...
	 * @param archiveTask The archive task for which the launch script configuration is
	 * being set.
	 */
	...
	/**
	 * Replaces line breaks in the given string with a newline character followed by a
	 * hash symbol and a space.
	 * @param string the string to be processed
	 * @return the processed string with augmented line breaks, or null if the input
	 * string is null
	 */
	 ...
	 * @param valueCandidates the array of candidate values to be added as the value for
	 * the key
	 */
