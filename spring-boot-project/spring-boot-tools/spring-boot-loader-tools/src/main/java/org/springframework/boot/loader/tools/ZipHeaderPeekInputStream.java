...
class ZipHeaderPeekInputStream extends FilterInputStream {
	...
	/**
     * Reads the next byte of data from the input stream. If the header stream is not null,
     * it reads from the header stream. If the header stream is null or the end of the header
     * stream is reached, it reads from the super class input stream.
     *
