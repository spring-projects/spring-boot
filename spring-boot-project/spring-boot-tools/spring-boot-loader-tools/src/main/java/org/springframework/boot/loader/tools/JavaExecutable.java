...
public class JavaExecutable {
	 ...
	 *
	 * This constructor retrieves the Java home directory using the 'java.home' system
	 * property. It checks if the Java home directory is not empty using the
	 * StringUtils.hasLength() method. If the Java home directory is empty, an
	 * IllegalStateException is thrown with the message "Unable to find java executable
	 * due to missing 'java.home'". Otherwise, it calls the findInJavaHome() method to
	 * find the Java executable file within the Java home directory.
	 */
	 ...
	 * @throws IllegalStateException if the Java executable file cannot be found in the
	 * specified Java home directory
	 */
