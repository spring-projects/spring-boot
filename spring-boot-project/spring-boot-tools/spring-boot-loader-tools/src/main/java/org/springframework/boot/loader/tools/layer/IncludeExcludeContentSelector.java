...
public class IncludeExcludeContentSelector<T> implements ContentSelector<T> {
	...
	/**
     * Constructs a new IncludeExcludeContentSelector with the specified layer, includes, excludes, and identity function.
     * 
	...
	/**
     * Adapts a list of objects of type S to a list of ContentFilter objects of type T using a mapper function.
     * 
     ...
     * @param mapper the mapper function to convert each object in the input list to a ContentFilter object
     * @return a list of ContentFilter objects generated by applying the mapper function to each object in the input list
     */
