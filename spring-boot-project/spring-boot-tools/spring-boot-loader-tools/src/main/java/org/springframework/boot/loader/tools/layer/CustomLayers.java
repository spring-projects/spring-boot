...
public class CustomLayers implements Layers {
	...
	/**
	 * Constructs a new CustomLayers object with the given layers, application selectors,
	 * and library selectors.
	...
	/**
	 * Validates the layers of the given content selectors against the provided list of
	 * layers.
	 ...
	 * @throws IllegalArgumentException if any of the content selectors have invalid
	 * layers
	 */
	...
	/**
	 * Validates the selector layers by checking if the given selector's layer is present
	 * in the list of layers.
	 * @param selector the content selector to validate
	 * @param layers the list of layers to check against
	 * @throws IllegalStateException if the selector's layer is missing or not found in
	 * the list of layers
	 */
	...
	/**
	 * Returns an iterator over the elements in this CustomLayers object in proper
	 * sequence.
	 * @return an iterator over the elements in this CustomLayers object in proper
	 * sequence
	 */
	@Override
	...
	/**
	 * Returns a sequential Stream with the layers of this CustomLayers object as its
	 * source.
