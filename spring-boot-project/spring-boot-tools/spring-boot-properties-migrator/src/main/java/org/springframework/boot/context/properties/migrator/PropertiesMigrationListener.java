...
class PropertiesMigrationListener implements ApplicationListener<SpringApplicationEvent> {
	 ...
	 * the event and performs specific actions accordingly. If the event is an instance of
	 * ApplicationPreparedEvent, it calls the onApplicationPreparedEvent method. If the
	 * event is an instance of ApplicationReadyEvent or ApplicationFailedEvent, it logs a
	 * legacy properties report.
	...
	/**
	 * This method is called when the application is prepared. It loads the configuration
	 * metadata repository and creates a PropertiesMigrationReporter object. The reporter
	 * is used to generate a report of properties migration.
	 * @param event The ApplicationPreparedEvent object representing the event. It
	 * contains the application context and environment information.
	 */
	 ...
	 * @param builder the ConfigurationMetadataRepositoryJsonBuilder used to build the
	 * repository
	 ...
	 * If the report is null or has already been reported, the method returns without
	 * doing anything.
	 *
