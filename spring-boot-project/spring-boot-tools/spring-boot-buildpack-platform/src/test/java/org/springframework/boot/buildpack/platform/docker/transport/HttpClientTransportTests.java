...
class HttpClientTransportTests {
	...
	@Test
	void deleteShouldExecuteHttpDelete() throws IOException, URISyntaxException {
		givenClientWillReturnResponse();
		given(this.entity.getContent()).willReturn(this.content);
		given(this.response.getCode()).willReturn(200);
	...
	void executeWhenClientThrowsIOExceptionRethrowsAsDockerException() throws IOException {
		given(this.client.execute(any(HttpHost.class), any(ClassicHttpRequest.class)))
	...
	private void givenClientWillReturnResponse() throws IOException {
		given(this.client.execute(any(HttpHost.class), any(ClassicHttpRequest.class))).willReturn(this.response);
	...
	static class TestHttpClientTransport extends HttpClientTransport {
		...
		protected TestHttpClientTransport(CloseableHttpClient client) throws URISyntaxException {
