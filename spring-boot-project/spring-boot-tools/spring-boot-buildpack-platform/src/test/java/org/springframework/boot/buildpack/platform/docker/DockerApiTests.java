...
class DockerApiTests {
	...
	void createDockerEngineAuthenticationHeaders() {
		...
		assertThat(new String(Base64Utils.decodeFromString(header.getValue()))).isEqualTo(
				"{\"username\": \"username\",\"password\": \"password\",\"email\": \"mock@spring.com\",\"serveraddress\": \"http://mock.docker.registry\"}");
	}
