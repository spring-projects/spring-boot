...
class AbstractSocket extends Socket {
     ...
     * @throws UnsupportedSocketOperationException if the operation is not supported by the socket implementation
     */
    @Override
     ...
     * <p>
     * This method is not supported and will always throw an {@link UnsupportedSocketOperationException}.
     * </p>
     *
     ...
     * 
     * @return the IP address of the remote endpoint, or {@code null} if the socket is not connected
     */
    @Override
     ...
     * 
     * @return the local IP address to which this socket is bound, or {@code null} if the socket is not bound
     */
    @Override
	...
	/**
     * Returns the local socket address to which this socket is bound, or {@code null} if it is not bound yet.
     *
     * @return the local socket address to which this socket is bound, or {@code null} if it is not bound yet.
     */
    @Override
    ...
    private static class UnsupportedSocketOperationException extends UnsupportedOperationException {
		...
		/**
         * Constructs a new UnsupportedSocketOperationException with the default message "Unsupported socket operation".
         */
