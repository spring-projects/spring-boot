...
public final class DockerConfiguration {
     ...
     * 
     * @param host the DockerHostConfiguration object representing the configuration for the Docker host
     * @param builderAuthentication the DockerRegistryAuthentication object representing the authentication configuration for the builder
     * @param publishAuthentication the DockerRegistryAuthentication object representing the authentication configuration for publishing
     * @param bindHostToBuilder a boolean indicating whether to bind the host to the builder
     */
     ...
     * @return a new DockerConfiguration object with the updated builder registry authentication
     ...
     * 
     * @param username the username for the builder registry user authentication (must not be null)
     * @param password the password for the builder registry user authentication (must not be null)
     ...
     * @return a new DockerConfiguration object with the specified builder registry user authentication
     ...
     * @return a new DockerConfiguration object with the updated authentication credentials
	...
	/**
     * Creates a new DockerConfiguration object with an empty publish registry authentication.
     * 
     * @return a new DockerConfiguration object with an empty publish registry authentication
     */
    ...
    public static class DockerHostConfiguration {
		...
		/**
         * Constructs a new DockerHostConfiguration with the specified address, context, secure flag, and certificate path.
         * 
         * @param address the address of the Docker host
         * @param context the context path of the Docker host
         * @param secure a flag indicating whether the connection to the Docker host is secure
         * @param certificatePath the path to the certificate file for secure connection
         */
		...
		/**
         * Returns a boolean value indicating whether the Docker host configuration is secure.
         *
         ...
         * 
         * @param address the address of the Docker host
         * @param secure true if the connection to the Docker host should be secure, false otherwise
         * @param certificatePath the path to the certificate file for secure connection (can be null if secure is false)
