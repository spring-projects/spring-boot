...
class BuildOwner implements Owner {
	...
	/**
	 * Retrieves the value associated with the given name from the provided environment
	 * map.
	...
	/**
	 * Returns a string representation of the BuildOwner object. The string representation
	 * consists of the uid and gid separated by a forward slash.
