...
public class SslContextFactory {
	...
	/**
	 * Returns a KeyManagerFactory initialized with the specified key and certificate
	 * paths.
	 ...
	 * @throws Exception if an error occurs while creating or initializing the
	 * KeyManagerFactory
	 */
	...
	/**
	 * Returns a TrustManagerFactory initialized with the specified CA certificate and key
	 * paths.
	 ...
	 * @throws NoSuchAlgorithmException if the default algorithm for TrustManagerFactory
	 * is not available
	 ...
	 * @throws IllegalStateException if any of the certificate files do not exist or are
	 * not regular files
	 */
