...
final class BuildpackCoordinates {
	...
	/**
	 * Constructs a new instance of the BuildpackCoordinates class with the specified ID
	 * and version.
	 ...
	 * id and version fields of the BuildpackCoordinates object.
	...
	/**
	 * Returns a string representation of the BuildpackCoordinates object. The string
	 * representation includes the id and version of the buildpack coordinates. If the
	 * version is not empty, it is appended to the id with an "@" symbol.
	 ...
	 * @throws IllegalArgumentException if the TOML file is empty or does not contain the
	 * required fields.
	 * @throws IllegalArgumentException if the TOML file contains both 'stacks' and
	 * 'order' fields.
	 */
