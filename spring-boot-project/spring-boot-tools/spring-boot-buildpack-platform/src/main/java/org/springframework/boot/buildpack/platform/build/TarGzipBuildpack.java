...
final class TarGzipBuildpack implements Buildpack {
	...
	/**
	 * Finds the coordinates of a buildpack by parsing the buildpack descriptor file
	 * 'buildpack.toml' from a given tar.gz file.
	 ...
	 * @throws IllegalArgumentException if the 'buildpack.toml' file is not found in the
	 * buildpack
