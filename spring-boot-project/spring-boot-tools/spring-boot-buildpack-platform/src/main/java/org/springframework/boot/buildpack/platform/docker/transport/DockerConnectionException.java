...
public class DockerConnectionException extends RuntimeException {
	...
	/**
	 * Returns the cause message of the given exception. If the cause of the exception is
	 * an instance of JNA_EXCEPTION_CLASS_NAME, then the cause message of the cause
	 * exception is returned. Otherwise, the message of the given exception is returned.
