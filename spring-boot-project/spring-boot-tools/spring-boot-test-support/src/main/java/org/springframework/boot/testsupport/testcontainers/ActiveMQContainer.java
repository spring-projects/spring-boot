...
public class ActiveMQContainer extends GenericContainer<ActiveMQContainer> {
	 ...
	 *
	 * This constructor initializes the ActiveMQContainer with the default Docker image
	 * name for ActiveMQ. It also adds the default port for ActiveMQ to the list of
	 * exposed ports.
	 */
