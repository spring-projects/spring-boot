...
class DisabledIfProcessUnavailableCondition implements ExecutionCondition {
	...
	/**
	 * Retrieves the value of the annotation "DisabledIfProcessUnavailable" from the given
	 * annotated element.
	 * @param testElement the annotated element from which to retrieve the annotation
	 * value
	 * @return a stream of string arrays representing the values of the
	 * "DisabledIfProcessUnavailable" annotation
	 */
