...
public class OutputCaptureExtension
	 ...
	 *
	 * This constructor is package private to prevent users from directly creating an
	 * instance.
	 */
	...
	/**
	 * This method is called before all test methods in the test class. It is an
	 * overridden method from the ExtensionContext class. It throws an Exception if an
	 * error occurs.
	...
	/**
	 * This method is called after all tests have been executed. It is used to pop the
	 * output capture from the context.
	...
	/**
	 * This method is executed before each test method in the test class. It is used to
	 * push the output capture for the current test context.
	...
	/**
	 * This method is called after each test execution to remove the captured output from
	 * the stack.
	 * @param context the extension context
	 * @throws Exception if an error occurs during the removal of captured output
	 */
	@Override
	...
	/**
	 * Determines if the given parameter is supported by the OutputCaptureExtension.
	 * @param parameterContext The parameter context.
	 * @param extensionContext The extension context.
	 * @return True if the parameter is supported, false otherwise.
	 * @throws ParameterResolutionException If there is an error resolving the parameter.
	 */
	@Override
	...
	/**
	 * Retrieves the OutputCapture instance from the ExtensionContext's store, or creates
	 * a new instance if it does not exist.
	 * @param context the ExtensionContext object representing the current extension
	 * context
	 * @return the OutputCapture instance retrieved from the store or a new instance if it
	 * does not exist
	 */
