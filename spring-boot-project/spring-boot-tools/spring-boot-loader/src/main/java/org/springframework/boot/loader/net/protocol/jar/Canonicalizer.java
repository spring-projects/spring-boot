...
final class Canonicalizer {
	...
	/**
	 * This method takes a path and a position as input and returns the canonicalized path
	 * after the given position.
	 * @param path The original path to be canonicalized.
	 * @param pos The position in the path after which the canonicalization should be
	 * performed.
	 ...
	 * @param path the path to be processed
	 * @return the path without the trailing "/." if it exists, otherwise the original
	 * path
	 */
