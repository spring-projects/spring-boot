...
class UrlNestedJarFile extends NestedJarFile {
	...
	/**
	 * Constructs a new UrlNestedJarFile with the specified file, nested entry name,
	 * version, and close action.
	 ...
	 * This method overrides the close() method in the superclass and throws an
	 * IOException. If a closeAction is set, it will be executed before closing the file.
