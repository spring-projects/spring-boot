...
record ZipDataDescriptorRecord(boolean includeSignature, int crc32, int compressedSize, int uncompressedSize) {
	...
	/**
	 * Returns the size of the data in the ZipDataDescriptorRecord. If the signature is
	 * not included, only the data size is returned. If the signature is included, the
	 * data size plus the signature size is returned.
