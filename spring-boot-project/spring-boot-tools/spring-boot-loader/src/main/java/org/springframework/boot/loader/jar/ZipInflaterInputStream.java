...
abstract class ZipInflaterInputStream extends InflaterInputStream {
	...
	/**
	 * Constructs a new ZipInflaterInputStream with the specified input stream, inflater,
	 * and size.
	...
	/**
	 * Returns the number of bytes that can be read from the current input stream without
	 * blocking.
	 * @return the number of bytes that can be read from the current input stream without
	 * blocking, or -1 if the number of bytes is unknown.
