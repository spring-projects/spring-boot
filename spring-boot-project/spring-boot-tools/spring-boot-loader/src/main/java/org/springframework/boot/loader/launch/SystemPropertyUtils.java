...
final class SystemPropertyUtils {
	...
	/**
	 * Parses the given value string, replacing any placeholders with their corresponding
	...
	/**
	 * Retrieves the value of a system property or environment variable based on the
	 * provided key. If the value is not found, the default value is returned.
	 ...
	 * @return the value of the system property or environment variable, or the default
	 * value if not found
