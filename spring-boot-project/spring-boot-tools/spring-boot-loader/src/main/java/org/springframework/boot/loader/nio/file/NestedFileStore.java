...
class NestedFileStore extends FileStore {
	...
	/**
	 * Returns a boolean value indicating whether the specified file attribute view is
	 * supported by the nested file store.
	 * @param type the class representing the file attribute view
	 * @return {@code true} if the specified file attribute view is supported,
	...
	/**
	 * Returns the file store attribute view of the specified type for the nested file
	 * store.
	 ...
	 * @throws UnsupportedOperationException if the attribute view is not available for
	 * the nested file store
	 * @throws IllegalArgumentException if the specified type is null
	 * @throws ClassCastException if the specified type does not implement the
	 ...
	 * @throws UncheckedIOException if an unchecked I/O error occurs while retrieving the
	 * attribute
