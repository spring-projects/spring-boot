...
class NestedByteChannel implements SeekableByteChannel {
	...
	/**
	 * Constructs a new NestedByteChannel object with the specified path and nested entry
	 * name.
	...
	/**
	 * Constructs a new NestedByteChannel with the specified path, nested entry name, and
	 * cleaner.
	 * @param path the path to the file containing the nested entry
	 * @param nestedEntryName the name of the nested entry within the file
	 ...
	 * @return the total number of bytes read, or 0 if the end of the channel has been
	 * reached
	 * @throws IOException if an I/O error occurs
	...
	static class Resources implements Runnable {
		...
		/**
		 * Constructs a new Resources object with the specified path and nested entry
		 * name.
		 * @param path the path to the zip file
		 * @param nestedEntryName the name of the nested entry within the zip file
		 * @throws IOException if an I/O error occurs while opening the zip file or
		 * accessing the nested entry
		 */
		...
		/**
		 * Releases all resources held by the Resources class. This method closes the data
		 * and zipContent streams. If an IOException occurs while closing the streams, it
		 * is caught and stored in the exception variable. If multiple IOExceptions occur,
		 * they are added as suppressed exceptions to the original exception. If an
		 * exception occurred, it is thrown as an UncheckedIOException.
		 */
