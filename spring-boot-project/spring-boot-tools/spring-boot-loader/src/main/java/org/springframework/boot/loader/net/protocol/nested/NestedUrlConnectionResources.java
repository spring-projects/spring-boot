...
class NestedUrlConnectionResources implements Runnable {
     ...
     * 
     * @throws IOException if an I/O error occurs while connecting or opening the zip content
     */
	...
	/**
     * Connects to the data by opening the raw zip data and setting the size and input stream.
     * 
     ...
     * If the zipContent is not null, it closes the inputStream and zipContent.
     * If any IOException occurs during the closing of resources, it adds the exception to an exception chain.
     * After closing the resources, it sets the size to -1.
     * If any exception occurred during the closing of resources, it throws an UncheckedIOException with the exception chain.
     */
