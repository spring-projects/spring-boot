...
abstract class LazyDelegatingInputStream extends InputStream {
	 ...
	 * bytes. This method delegates the call to the underlying input stream.
	 ...
	 * blocking. This method delegates the call to the underlying input stream's
	 * available() method.
	...
	/**
	 * Returns a boolean indicating whether or not this input stream supports the mark and
	 * reset methods.
	 * @return true if this input stream supports the mark and reset methods, false
	 * otherwise.
	 */
	@Override
	...
	/**
	 * Returns the input stream for this LazyDelegatingInputStream. If the input stream
	 * has not been initialized yet, it will be lazily initialized by calling the
	 * getDelegateInputStream() method.
