...
public class WarLauncher extends ExecutableArchiveLauncher {
	...
	/**
	 * Returns the entry path prefix for the web application. The entry path prefix is
	 * used to specify the location of the web application's resources. By default, the
	 * entry path prefix is set to "WEB-INF/".
