...
class ManifestInfo {
	...
	/**
	 * Constructs a new ManifestInfo object with the specified manifest and multiRelease
	 * flag.
	 * @param manifest the manifest object containing information about the JAR file
	 * @param multiRelease a boolean flag indicating whether the JAR file supports
	 * multiple releases
	 */
