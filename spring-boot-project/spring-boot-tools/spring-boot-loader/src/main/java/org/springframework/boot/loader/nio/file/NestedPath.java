...
final class NestedPath implements Path {
	...
	/**
	 * Constructs a new NestedPath object with the given NestedFileSystem and nested entry
	 * name.
	...
	/**
	 * Throws an UnsupportedOperationException indicating that it is unable to relativize
	 * a nested path.
	...
	/**
	 * Returns the URI representation of the nested path. The URI is constructed by
	 * appending the nested entry name to the jar path URI.
	...
	/**
	 * Registers the specified watcher to watch for the specified events on this nested
	 * path.
	 ...
	 * @return a negative integer, zero, or a positive integer as this NestedPath object
	 * is less than, equal to, or greater than the specified Path object
	 ...
	 * implementation of the {@code hashCode()} method. The hash code is computed based on
	 * the {@code fileSystem} and {@code nestedEntryName} properties of the object.
	...
	/**
	 * Returns a string representation of the NestedPath object. The string representation
	 * is the path of the JAR file in the file system, followed by the separator and the
	 * name of the nested entry if it exists.
	 ...
	 * @throws ProviderMismatchException if the provided path is not an instance of
	 * NestedPath
	 */
