...
public class RepackageMojo extends AbstractPackagerMojo {
	 ...
	 * @throws MojoExecutionException if an error occurs during the execution of the
	 * repackaging process.
	 ...
	 * @throws MojoExecutionException If the value for parameter 'outputTimestamp' is
	 * invalid.
	 */
	 ...
	 * @return The launch script for the current execution, or null if no launch script is
	 * available.
	 ...
	 * @return the description string with line breaks removed, or null if the input is
	 * null
	 */
	...
	/**
	 * Puts the specified key-value pair into the given Properties object if the key is
	 * missing.
