...
public class StopMojo extends AbstractMojo {
	 ...
	 * @throws MojoExecutionException if an error occurs during the execution of the stop
	 * operation.
	 ...
	 * @throws IOException if an I/O error occurs while communicating with the MBean
	 * server
	 * @throws MojoExecutionException if the Spring application lifecycle JMX bean is not
	 * found
	 */
