...
class JavaProcessExecutor {
	...
	/**
	 * Constructs a new JavaProcessExecutor with the specified MavenSession and
	 * ToolchainManager.
	...
	/**
	 * Constructs a new JavaProcessExecutor with the specified MavenSession,
	 * ToolchainManager, and runProcessCustomizer.
	 * @param mavenSession The MavenSession to be used by the JavaProcessExecutor.
	 * @param toolchainManager The ToolchainManager to be used by the JavaProcessExecutor.
	 * @param runProcessCustomizer The customizer function to be used by the
	 * JavaProcessExecutor for customizing the RunProcess object.
	 */
	...
	/**
	 * Runs a process with the specified working directory, arguments, and environment
	 * variables.
	 ...
	 * @throws MojoExecutionException if the process execution fails or if the process
