...
public class PropertiesMergingResourceTransformer implements ReproducibleResourceTransformer {
	...
	/**
     * Processes a resource with the given resource name, input stream, and list of relocators.
     * 
     ...
     * 
     * @deprecated This method has been deprecated since version 2.4.0 and will not be removed in future versions.
     *             Please use the overloaded method {@link #processResource(String, InputStream, List, int)} instead.
     */
    @Override
	...
	/**
     * Processes a resource by loading its properties from an input stream and applying relocator transformations.
     * 
     * @param resource the name of the resource being processed
	...
	/**
     * Processes the given name and value and updates the property in the data object.
     * If the property already exists, the value is appended to the existing value with a comma separator.
     * If the property does not exist, the value is set as the new value for the property.
     * 
