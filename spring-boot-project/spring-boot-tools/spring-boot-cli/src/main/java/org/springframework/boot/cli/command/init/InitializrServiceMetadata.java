...
class InitializrServiceMetadata {
	...
	/**
	 * Constructs a new InitializrServiceMetadata object with the specified default
	 * project type.
	...
	/**
	 * Parses the project types from the given JSON object and returns a MetadataHolder
	 * object containing the parsed project types.
	...
	/**
	 * Parses a group from the given JSONObject and adds the parsed dependencies to the
	 * provided map.
	...
	/**
	 * Returns the value of the specified key from the given JSONObject. If the key is
	 * present in the JSONObject, the corresponding value is returned. If the key is not
	 * present, the defaultValue is returned instead.
	 ...
	 * @throws JSONException if there is an error while retrieving the value from the
	 * JSONObject
	 */
	...
	private static final class MetadataHolder<K, T> {
		...
		/**
		 * Constructs a new instance of the MetadataHolder class. Initializes the content
		 * field with an empty HashMap.
		 */
