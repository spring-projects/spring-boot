...
class EscapeAwareWhiteSpaceArgumentDelimiter extends WhitespaceArgumentDelimiter {
	...
	/**
	 * Determines if the character at the specified position in the given buffer is
	 * escaped.
	...
	/**
	 * Checks if the character at the specified position in the given buffer is an escape
	 * character.
	 * @param buffer the character sequence buffer to check
	 * @param pos the position of the character to check
	 * @return {@code true} if the character at the specified position is an escape
	...
	/**
	 * Determines if the specified position in the given buffer is within a quoted
	 * section.
	...
	/**
	 * Searches backwards in the given buffer for the first occurrence of any of the
	 * specified characters.
	 * @param buffer the character sequence to search in
	 * @param pos the starting position for the search
	 * @param chars the characters to search for
	 * @return the index of the first occurrence of any of the specified characters, or -1
	 * if not found
	 */
	...
	/**
	 * Cleans the given array of arguments by removing any leading or trailing white
	 * spaces.
	...
	/**
	 * Cleans the given argument by removing any surrounding quotes and replacing escape
	 * sequences.
