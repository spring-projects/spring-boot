...
@ContextConfiguration(initializers = JdbcTestContextBootstrapperWithInitializersTests.CustomInitializer.class)
public class JdbcTestContextBootstrapperWithInitializersTests {
	...
	public void foundConfiguration() {
		Object bean = this.context
				.getBean(JdbcTestContextBootstrapperExampleConfig.class);
