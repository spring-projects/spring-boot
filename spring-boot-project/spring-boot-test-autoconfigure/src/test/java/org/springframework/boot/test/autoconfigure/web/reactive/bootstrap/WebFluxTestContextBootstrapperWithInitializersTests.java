...
/**
 * Integration tests for {@link WebFluxTestContextBootstrapper} with
...
@ContextConfiguration(initializers = WebFluxTestContextBootstrapperWithInitializersTests.CustomInitializer.class)
public class WebFluxTestContextBootstrapperWithInitializersTests {
	...
	public void foundConfiguration() {
		Object bean = this.context
				.getBean(WebFluxTestContextBootstrapperExampleConfig.class);
