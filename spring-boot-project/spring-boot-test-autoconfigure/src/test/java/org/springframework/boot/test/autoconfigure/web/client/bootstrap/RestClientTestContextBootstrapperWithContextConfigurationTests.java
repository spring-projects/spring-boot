...
/**
 * Tests for {@link RestClientTestContextBootstrapper} + {@code @ContextConfiguration} (in
...
public class RestClientTestContextBootstrapperWithContextConfigurationTests {

	@Autowired
	private ApplicationContext context;

	@Autowired
	private RestClientTestContextBootstrapperExampleConfig config;
