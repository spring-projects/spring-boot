...
class WebMvcTestContextBootstrapper extends SpringBootTestContextBootstrapper {
	...
	/**
	 * Retrieves the properties specified in the {@link WebMvcTest} annotation for the
	 * given test class.
	 * @param testClass the test class to retrieve the properties from
	 * @return an array of properties specified in the {@link WebMvcTest} annotation, or
