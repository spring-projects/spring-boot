...
public class SpringBootMockMvcBuilderCustomizer implements MockMvcBuilderCustomizer {
	...
	/**
	 * Customize the ConfigurableMockMvcBuilder by adding filters and print handler if
	 * specified.
	 ...
	 * @param registration the filter registration bean containing the filter and its
	 * configuration
	 */
	...
	/**
	 * Returns the MockMvcPrint object associated with this
	 * SpringBootMockMvcBuilderCustomizer.
	 * @return the MockMvcPrint object associated with this
	 * SpringBootMockMvcBuilderCustomizer
	 */
	...
	/**
	 * Returns a boolean value indicating whether the printOnlyOnFailure flag is enabled
	 * or not.
	...
	private static class LinesWritingResultHandler implements ResultHandler {
		...
		/**
		 * Handles the given MvcResult by delegating the handling to a
		 * LinesPrintingResultHandler. After handling the result, writes the result to the
		 * writer.
		...
		private static class LinesPrintingResultHandler extends PrintingResultHandler {
			...
			private static final class Printer implements ResultValuePrinter {
				...
				/**
				 * Prints the value with the given label. If the value is an array, it
				 * converts it to a list before printing.
	...
	static class DeferredLinesWriter implements LinesWriter {
		...
		/**
		 * Constructs a new DeferredLinesWriter with the specified WebApplicationContext
		 * and LinesWriter delegate.
		 ...
		 *
		 * This method retrieves the lines from the DeferredLinesWriter and writes them to
		 * the delegate.
		 ...
		 * DeferredLinesWriter instance
		 * @return the DeferredLinesWriter instance retrieved from the ApplicationContext,
	...
	private static class FilterRegistrationBeans extends ServletContextInitializerBeans {
		...
		/**
		 * Constructs a new FilterRegistrationBeans object with the specified
		 * ListableBeanFactory.
		 * @param beanFactory the ListableBeanFactory used to retrieve the filter
		 * registration beans
		 */
