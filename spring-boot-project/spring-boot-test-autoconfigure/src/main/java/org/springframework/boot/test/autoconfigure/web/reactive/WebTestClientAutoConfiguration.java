...
public class WebTestClientAutoConfiguration {
	...
	public WebTestClient webTestClient(ApplicationContext applicationContext,
		...
		WebTestClient.Builder builder = WebTestClient.bindToApplicationContext(applicationContext).configureClient();
	...
	public SpringBootWebTestClientBuilderCustomizer springBootWebTestClientBuilderCustomizer(
		...
		return new SpringBootWebTestClientBuilderCustomizer(codecCustomizers.getIfAvailable(Collections::emptyList));
	}
