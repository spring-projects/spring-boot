...
class MockRestServiceServerResetTestExecutionListener extends AbstractTestExecutionListener {
	...
	/**
	 * Returns the order in which this listener should be executed. The order is set to
	 * the lowest precedence minus 100.
	 ...
	 * MockRestServiceServer instances in the application context.
