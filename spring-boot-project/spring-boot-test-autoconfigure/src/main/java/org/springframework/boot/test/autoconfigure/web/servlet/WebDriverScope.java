...
public class WebDriverScope implements Scope {
	...
	/**
	 * Retrieves an object from the scope with the given name. If the object does not
	 * exist in the scope, it creates a new instance using the provided object factory.
	 * The created instance is then stored in the scope for future retrieval.
	 * @param name the name of the object to retrieve
	 * @param objectFactory the factory used to create a new instance if the object does
	 * not exist in the scope
	...
	/**
	 * This method is used to post-process the bean factory by setting the scope of
	 * certain bean definitions. It iterates over a list of bean classes and for each bean
	 * class, it retrieves the bean names from the bean factory that match the resolved
	 * class name. For each matching bean definition, if the scope is not already set, it
	 * sets the scope to "NAME".
