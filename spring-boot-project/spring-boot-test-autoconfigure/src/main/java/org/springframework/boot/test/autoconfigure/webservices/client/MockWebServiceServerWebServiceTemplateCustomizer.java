...
class MockWebServiceServerWebServiceTemplateCustomizer implements WebServiceTemplateCustomizer {
	...
	/**
	 * Constructs a new MockWebServiceServerWebServiceTemplateCustomizer with the
	 * specified TestMockWebServiceServer.
	 * @param mockServer the TestMockWebServiceServer to be used for mocking web service
	 * requests
	 */
	...
	/**
	 * Customizes the given WebServiceTemplate by setting the message sender to the mock
	 * server's mock message sender. This method is used by the @WebServiceClientTest and
	 * supports only a single WebServiceTemplate.
