...
class PropertyMappingContextCustomizer implements ContextCustomizer {
	...
	/**
	 * Constructs a new PropertyMappingContextCustomizer with the specified
	...
	/**
	 * Customize the application context by adding a property source and registering a
	 * bean post processor.
	...
	/**
	 * Compares this PropertyMappingContextCustomizer object to the specified object. The
	 * result is true if and only if the argument is not null and is of the same class as
	 * this object, and the propertySource of both objects are equal.
	 * @param obj the object to compare this PropertyMappingContextCustomizer against
	 * @return true if the given object represents a PropertyMappingContextCustomizer
	...
	/**
	 * Returns the hash code value for this PropertyMappingContextCustomizer object. The
	 * hash code is generated based on the hash code of the propertySource field.
	...
	static class PropertyMappingCheckBeanPostProcessor implements BeanPostProcessor {
		...
		/**
		 * This method is called before the initialization of a bean. It checks if the
		 * bean has both @Component and @PropertyMapping annotations. If both annotations
		 * are present, it throws an IllegalStateException.
		...
		/**
		 * This method is called after the initialization of a bean. It is a hook for
		 * post-processing the bean instance.
