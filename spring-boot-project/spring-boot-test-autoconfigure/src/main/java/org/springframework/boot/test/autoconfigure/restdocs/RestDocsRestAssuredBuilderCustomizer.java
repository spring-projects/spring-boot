...
class RestDocsRestAssuredBuilderCustomizer implements InitializingBean {
	...
	/**
	 * Constructs a new RestDocsRestAssuredBuilderCustomizer with the specified properties
	 * and delegate.
	 * @param properties the properties for configuring the
	 * RestDocsRestAssuredBuilderCustomizer
	 * @param delegate the delegate RequestSpecification to be used by the
	 * RestDocsRestAssuredBuilderCustomizer
	 */
	...
	/**
	 * This method is called after all the properties have been set and is used to
	 * configure the RestDocsRestAssuredBuilderCustomizer. It sets the base URI and port
	 * for the RestDocsRestAssuredBuilderCustomizer based on the properties provided.
