...
class TypeExcludeFiltersContextCustomizer implements ContextCustomizer {
	...
	/**
	 * Creates a new instance of TypeExcludeFiltersContextCustomizer with the specified
	 * test class and filter classes.
	 * @param testClass the test class for which the type exclude filters are being
	 * customized
	 * @param filterClasses the set of filter classes to be instantiated as type exclude
	 * filters
	 */
	...
	/**
	 * Instantiates a set of TypeExcludeFilter objects based on the provided filter
	 * classes.
	 ...
	 * @param testClass the test class to be used in the constructor of the
	 * TypeExcludeFilter
	 * @param filterClass the class of the TypeExcludeFilter to be instantiated
	 * @return the instantiated TypeExcludeFilter
	 * @throws IllegalStateException if unable to create the filter for the specified
	 * filterClass
	 */
	...
	/**
	 * Compares this TypeExcludeFiltersContextCustomizer with the specified object for
	 * equality.
	 * @param obj the object to compare with
	 * @return {@code true} if the specified object is equal to this
	 * TypeExcludeFiltersContextCustomizer, {@code false} otherwise
	 */
	@Override
	...
	/**
	 * Customize the application context by registering a type exclude filter if the
