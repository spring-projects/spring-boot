...
public class MockWebServiceServerAutoConfiguration {
	...
	/**
	 * Creates a new instance of TestMockWebServiceServer with a
	 * MockWebServiceMessageSender. This method is annotated with @Bean to indicate that
	 * it is a Spring bean.
	...
	/**
	 * Creates a {@link MockWebServiceServerWebServiceTemplateCustomizer} bean that
	 * customizes the {@link WebServiceTemplate} with a {@link MockWebServiceServer}
	 * instance.
	 * @param mockWebServiceServer the {@link TestMockWebServiceServer} instance to be
	 * used for customizing the {@link WebServiceTemplate}
