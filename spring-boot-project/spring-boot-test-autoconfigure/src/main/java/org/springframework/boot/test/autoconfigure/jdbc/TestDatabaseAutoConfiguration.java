...
public class TestDatabaseAutoConfiguration {
	...
	/**
     * Creates a DataSource bean if the property "spring.test.database.replace" is set to "AUTO_CONFIGURED" and no other bean of type DataSource is present.
     * 
	...
	/**
     * Creates a bean factory post processor for configuring an embedded data source.
     * This bean factory post processor is only enabled if the property "spring.test.database.replace" is set to "ANY",
	...
	static class EmbeddedDataSourceBeanFactoryPostProcessor implements BeanDefinitionRegistryPostProcessor {
         ...
         * Otherwise, it asserts that the registry is an instance of ConfigurableListableBeanFactory.
         * Then, it calls the process method passing the registry and the ConfigurableListableBeanFactory.
         * 
         ...
         * @param beanFactory the ConfigurableListableBeanFactory to retrieve the DataSource bean from
         */
		...
		/**
         * Creates a new embedded bean definition for the embedded data source factory bean.
         * 
		...
		/**
         * Retrieves the bean definition for the primary DataSource bean from the given bean factory.
         * If no DataSource beans are found, a warning message is logged and null is returned.
         * If only one DataSource bean is found, its bean definition is returned.
         * If multiple DataSource beans are found, the bean definition for the primary DataSource bean is returned.
         * If no primary DataSource bean is found, a warning message is logged and null is returned.
         *
         * @param beanFactory the bean factory to retrieve the DataSource bean definition from
         * @return the bean definition holder for the primary DataSource bean, or null if no DataSource beans are found or no primary DataSource bean is found
         */
    ...
    static class EmbeddedDataSourceFactoryBean implements FactoryBean<DataSource>, EnvironmentAware, InitializingBean {
		...
		/**
         * Initializes the embedded database by creating an instance of the embedded database using the factory.
         * 
         ...
         * @throws Exception if an error occurs while retrieving the embedded database object
         */
        @Override
         ...
         * 
         * @return the type of object created by this factory bean, which is EmbeddedDatabase.
         */
        @Override
    ...
    static class EmbeddedDataSourceFactory {
		...
		/**
         * Retrieves an embedded database based on the specified connection type.
         * If no connection type is specified, it will try to determine the connection type
         * based on the class loader. If no supported embedded database is found,
