...
class RestClientTestContextBootstrapper extends SpringBootTestContextBootstrapper {
	...
	/**
	 * Retrieves the properties specified in the {@link RestClientTest} annotation for the
	 * given test class.
	 * @param testClass the test class for which to retrieve the properties
	 * @return an array of properties specified in the {@link RestClientTest} annotation,
