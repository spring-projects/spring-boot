...
class ObservabilityContextCustomizerFactory implements ContextCustomizerFactory {
    ...
    private static class DisableObservabilityContextCustomizer implements ContextCustomizer {
		...
		/**
         * Customizes the application context based on the configuration provided.
         * If metrics are disabled in the environment, it sets the metrics export enabled property to false and the simple metrics export enabled property to true.
         * If tracing is disabled in the environment, it sets the tracing enabled property to false.
         * 
		...
		/**
         * Compares this DisableObservabilityContextCustomizer object to the specified object.
         * 
		...
		/**
         * Returns the hash code value for this DisableObservabilityContextCustomizer object.
         * 
