...
class OverrideAutoConfigurationContextCustomizerFactory implements ContextCustomizerFactory {
	 ...
	 * configuration attributes. If AOT detection is enabled, returns null. If the test
	 * class has the @OverrideAutoConfiguration annotation with enabled set to false,
	 * returns a DisableAutoConfigurationContextCustomizer. Otherwise, returns null.
	 ...
	 * @return the customizer for the test context, or null if AOT detection is enabled
	 * or @OverrideAutoConfiguration is disabled
	 */
	@Override
	...
	private static final class DisableAutoConfigurationContextCustomizer implements ContextCustomizer {
		...
		/**
		 * Customize the application context by disabling auto-configuration. This method
		 * is called during the initialization of the application context. It sets the
		 * property "spring.autoconfigure.enabled.override" to "false" in order to disable
		 * auto-configuration.
		 ...
		 * @return true if the specified object is of the same class as this object, false
		 * otherwise
		 */
		@Override
