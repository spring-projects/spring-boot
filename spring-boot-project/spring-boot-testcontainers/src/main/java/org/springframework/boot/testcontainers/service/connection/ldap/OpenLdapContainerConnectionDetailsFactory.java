...
class OpenLdapContainerConnectionDetailsFactory
	...
	/**
	 * Constructs a new OpenLdapContainerConnectionDetailsFactory with the specified image
	 * name.
	...
	private static final class OpenLdapContainerConnectionDetails extends ContainerConnectionDetails<Container<?>>
		...
		/**
		 * Constructs a new OpenLdapContainerConnectionDetails object with the specified
		 * ContainerConnectionSource.
		 * @param source the ContainerConnectionSource used to create the
		 * OpenLdapContainerConnectionDetails object
		 */
		...
		/**
		 * Returns an array of URLs for connecting to the LDAP server. The URLs are
		 * generated based on the environment variables of the container. If the LDAP_TLS
		 * environment variable is set to true, the URLs will use LDAPS protocol and the
		 * LDAPS_PORT environment variable. Otherwise, the URLs will use LDAP protocol and
		 * the LDAP_PORT environment variable. The host and port are obtained from the
		 * OpenLdapContainer instance.
		...
		/**
		 * Returns the username for the OpenLdapContainerConnectionDetails. The username
		 * is formatted as "cn=admin,%s", where %s is replaced with the base.
		...
		/**
		 * Returns the password for the LDAP admin. If the "LDAP_ADMIN_PASSWORD"
		 * environment variable is set, it will be returned. Otherwise, the default
		 * password "admin" will be returned.
