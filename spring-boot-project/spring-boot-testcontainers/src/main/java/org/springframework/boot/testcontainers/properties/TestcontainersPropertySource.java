...
public class TestcontainersPropertySource extends MapPropertySource {
	 ...
	 * @param applicationContext the ConfigurableApplicationContext to attach the dynamic
	 * property registry to
	...
	/**
	 * Attaches a dynamic property registry to the given environment and bean definition
	 * registry.
	 * @param environment the environment to attach the dynamic property registry to
	 * @param registry the bean definition registry to attach the dynamic property
	 * registry to
	 * @return the attached dynamic property registry
	 */
	...
	/**
	 * Attaches the TestcontainersPropertySource to the given environment, event
	 * publisher, and bean definition registry.
	 * @param environment The environment to attach the TestcontainersPropertySource to.
	 * Must be a ConfigurableEnvironment.
	 * @param eventPublisher The event publisher to add to the
	 * TestcontainersPropertySource. Can be null.
	 * @param registry The bean definition registry to register the
	 * EventPublisherRegistrar bean definition. Can be null.
	 * @return The DynamicPropertyRegistry associated with the
	 * TestcontainersPropertySource.
	...
	/**
	 * Retrieves the TestcontainersPropertySource from the given ConfigurableEnvironment,
	 * or adds it if it does not exist.
	 * @param environment the ConfigurableEnvironment from which to retrieve or add the
	 * TestcontainersPropertySource
	 * @return the TestcontainersPropertySource
	 * @throws IllegalStateException if the TestcontainersPropertySource type registered
	 * is incorrect
	 */
	...
	static class EventPublisherRegistrar implements BeanFactoryPostProcessor, ApplicationEventPublisherAware {
		 ...
		 * @param environment the environment in which the EventPublisherRegistrar
		 * operates
		 */
		...
		/**
		 * Post-processes the bean factory by adding the event publisher to the
		 * Testcontainers property source.
