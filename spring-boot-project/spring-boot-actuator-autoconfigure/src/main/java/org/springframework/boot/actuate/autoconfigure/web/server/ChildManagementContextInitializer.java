...
class ChildManagementContextInitializer implements BeanRegistrationAotProcessor, SmartLifecycle {
	...
	/**
	 * Constructs a new ChildManagementContextInitializer with the specified
	 * ManagementContextFactory, parentContext, and additional arguments.
	 * @param managementContextFactory the ManagementContextFactory used to create the
	 * management context
	 ...
	 *
	 * This method checks if the parent context is an instance of
	 * WebServerApplicationContext. If not, it returns without performing any action. If
	 * the management context is null, it creates a new ConfigurableApplicationContext for
	 * management, registers beans, refreshes the context, and assigns it to the
	 * managementContext variable. If the management context is not null, it starts the
	 * management context.
	 */
	@Override
	public void start() {
	 ...
	 *
	 * This method stops the ChildManagementContextInitializer by stopping the management
	 * context associated with it. If the management context is not null, it will be
	 * stopped.
	 */
	@Override
	public void stop() {
	...
	/**
	 * Returns the phase of the ChildManagementContextInitializer. The phase is calculated
	 * by adding 512 to the phase of the WebServerGracefulShutdownLifecycle.
	 ...
	 * @throws IllegalArgumentException if the parent context is not an instance of
	 ...
	 * @return {@code false} if the bean is not excluded from AOT processing, {@code true}
	 * otherwise.
	 */
	@Override
	 ...
	 * @throws IllegalArgumentException if the management context is not an instance of
	...
	/**
	 * Creates a new ChildManagementContextInitializer with the specified
	...
	private static class AotContribution implements BeanRegistrationAotContribution {
		 ...
		 * @param managementContext the ConfigurableApplicationContext to be used as the
		 * management context
		 * @throws IllegalArgumentException if the managementContext is not an instance of
		...
		/**
		 * Applies the AOT (Ahead of Time) configuration to the given generation context
		 * and bean registration code.
		 * @param generationContext The generation context to apply the AOT configuration
		 * to.
		 * @param beanRegistrationCode The bean registration code to apply the AOT
		 * configuration to.
		 */
		@Override
	...
	private static class CloseManagementContextListener implements ApplicationListener<ApplicationEvent> {
		...
		/**
		 * Constructs a new CloseManagementContextListener with the specified parent and
		...
		/**
		 * This method is called when an application event is triggered. It checks the
		 * type of the event and calls the corresponding handler method.
		...
		/**
		 * Adds a child context to the parent context and registers a
		 * CloseManagementContextListener to handle the closing of the child context.
		 * @param parentContext the parent context to which the child context will be
		 * added
