...
public class PrometheusMetricsExportAutoConfiguration {
	 ...
	 * @param prometheusProperties the PrometheusProperties object used to configure the
	 * PrometheusConfig bean
	...
	/**
	 * Creates a PrometheusMeterRegistry bean if there is no existing bean of the same
	 * type.
	 ...
	 * @param exemplarSamplerProvider The ObjectProvider for ExemplarSampler, used for
	 * sampling exemplars.
	...
	/**
	 * Creates a new instance of CollectorRegistry if no other bean of type
	...
	/**
	 * Creates a new instance of DefaultExemplarSampler if no other bean of type
	 * ExemplarSampler is present and a bean of type SpanContextSupplier is present.
	 * @param spanContextSupplier the bean of type SpanContextSupplier used to create the
	 * DefaultExemplarSampler instance
	...
	public static class PrometheusScrapeEndpointConfiguration {
		...
		/**
		 * Creates a PrometheusScrapeEndpoint bean if no other bean of the same type is
		 * present.
		 * @param collectorRegistry the CollectorRegistry to be used by the
	...
	public static class PrometheusPushGatewayConfiguration {
		...
		/**
		 * Creates a PrometheusPushGatewayManager bean if no other bean of the same type
		 * is present. This bean is responsible for managing the push gateway for
		 * Prometheus metrics.
		 * @param collectorRegistry The CollectorRegistry used to register metrics.
		 * @param prometheusProperties The PrometheusProperties containing the push
		 * gateway configuration.
		 * @param environment The Environment object containing the application's
		 * environment details.
		...
		/**
		 * Retrieves the job name from the PrometheusProperties.Pushgateway object or the
		 * Spring environment. If the job name is not found in either, a fallback job name
		 * is returned.
		 * @param properties the PrometheusProperties.Pushgateway object containing the
		 * job name
