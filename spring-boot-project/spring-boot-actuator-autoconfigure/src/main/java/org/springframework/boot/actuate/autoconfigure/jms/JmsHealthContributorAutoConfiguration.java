...
public class JmsHealthContributorAutoConfiguration
	 ...
	 *
	 * This constructor initializes the JmsHealthContributorAutoConfiguration by calling
	 * the super constructor with the JmsHealthIndicator class as the argument.
	 *
	...
	/**
	 * Creates a JMS health contributor if no existing bean with the names
	 * "jmsHealthIndicator" and "jmsHealthContributor" is found.
