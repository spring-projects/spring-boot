...
class InfluxPropertiesConfigAdapter extends StepRegistryPropertiesConfigAdapter<InfluxProperties>
	...
	/**
	 * Returns the prefix for the InfluxDB metrics export configuration properties. The
	 * prefix is used to group the properties related to InfluxDB metrics export.
	 ...
	 * If the value is not present in the InfluxProperties configuration, it falls back to
	 * the default value provided by the InfluxConfig interface.
	...
	/**
	 * Returns the bucket value from the InfluxProperties or the default value from the
	 * InfluxConfig.
