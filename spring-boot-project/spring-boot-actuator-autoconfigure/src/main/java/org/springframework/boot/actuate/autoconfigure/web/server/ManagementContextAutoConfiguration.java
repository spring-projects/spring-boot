...
public class ManagementContextAutoConfiguration {
	...
	static class SameManagementContextConfiguration implements SmartInitializingSingleton {
		...
		/**
		 * Constructs a new SameManagementContextConfiguration object with the specified
		 * environment.
		...
		/**
		 * This method is called after all singleton beans have been instantiated in the
		 * application context. It verifies the SSL configuration and address
		 * configuration. If the environment is an instance of ConfigurableEnvironment, it
		 * adds a local management port property alias.
		 */
		@Override
		 ...
		 *
		 * This method checks if the management-specific SSL is enabled and throws an
		 * exception if it is. The management server should not be configured with SSL as
		 * it is not listening on a separate port.
		 ...
		 *
		 * This method checks if the management-specific server address is configured. If
		 * the management server is not listening on a separate port, the address should
		 * not be configured.
		 * @throws IllegalStateException if the management-specific server address is
		 * configured when the management server is not listening on a separate port
		 */
	...
	static class DifferentManagementContextConfiguration {
		...
		/**
		 * Creates a ChildManagementContextInitializer object with the given management
		 * context factory and parent application context.
		 * @param managementContextFactory the management context factory used to create
		 * the child management context
