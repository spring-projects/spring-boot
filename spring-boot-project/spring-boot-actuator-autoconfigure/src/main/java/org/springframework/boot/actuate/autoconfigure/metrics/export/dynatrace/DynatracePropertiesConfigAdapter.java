...
class DynatracePropertiesConfigAdapter extends StepRegistryPropertiesConfigAdapter<DynatraceProperties>
	...
	/**
     * Constructs a new DynatracePropertiesConfigAdapter with the specified DynatraceProperties.
     * 
	...
	/**
     * Returns the URI value from DynatracePropertiesConfigAdapter.
     * If the value is not present, it falls back to the default URI value from DynatraceConfig.
     *
     ...
     * 
     * @return a map containing the default dimensions, where the key is the dimension name and the value is the dimension value
     */
    @Override
     ...
     * 
     * @return true if the configuration is enriched with Dynatrace metadata, false otherwise
     */
    @Override
     ...
     * 
     * @param getter the function used to extract the value of V1 from a DynatraceProperties object
	...
	/**
     * Returns a function that extracts a value of type V from a DynatraceProperties object by applying the provided getter function to the V2 property of the DynatraceProperties object.
     * 
     * @param getter the function that extracts a value of type V from a V2 object
     * @return a function that extracts a value of type V from a DynatraceProperties object
