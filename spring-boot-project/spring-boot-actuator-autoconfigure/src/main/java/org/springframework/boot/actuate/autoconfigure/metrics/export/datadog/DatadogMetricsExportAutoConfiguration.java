...
public class DatadogMetricsExportAutoConfiguration {
	...
	/**
	 * Constructs a new {@code DatadogMetricsExportAutoConfiguration} with the specified
	 * {@code properties}.
	...
	/**
	 * Creates a new instance of {@link DatadogConfig} if no other bean of the same type
	 * is present. This method is annotated with {@link ConditionalOnMissingBean} to
	 * ensure that it is only executed if there is no other bean of type
	 * {@link DatadogConfig} already defined.
	 * @return a new instance of {@link DatadogConfig} created using the properties
	 * defined in {@link DatadogPropertiesConfigAdapter}
	 */
	@Bean
	...
	/**
	 * Creates a new instance of DatadogMeterRegistry if no other bean of the same type is
	 * present.
