...
public class LiquibaseEndpointAutoConfiguration {
	...
	/**
	 * Creates a new instance of {@link LiquibaseEndpoint} if a bean of type
	 * {@link SpringLiquibase} is present in the application context and no bean of type
	 * {@link LiquibaseEndpoint} is already defined.
	...
	/**
	 * Bean post processor that prevents the DataSource from being closed after Liquibase
	 * migration. This post processor is conditional on the presence of a SpringLiquibase
	 * bean. It sets the 'closeDataSourceOnceMigrated' property of the
	 * DataSourceClosingSpringLiquibase bean to false.
