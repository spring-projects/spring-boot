...
public class InfoEndpointAutoConfiguration {
	...
	/**
	 * Creates an instance of the {@link InfoEndpoint} class if no other bean of the same
	 * type is present.
	 * @param infoContributors the object provider for {@link InfoContributor} instances
	 * @return an instance of {@link InfoEndpoint} with the provided
	 * {@link InfoContributor} instances
	 */
	@Bean
