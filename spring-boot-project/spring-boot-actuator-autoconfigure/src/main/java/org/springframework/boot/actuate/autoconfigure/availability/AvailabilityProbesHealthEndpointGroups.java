...
class AvailabilityProbesHealthEndpointGroups implements HealthEndpointGroups {
	...
	/**
     * Constructs an instance of AvailabilityProbesHealthEndpointGroups with the specified HealthEndpointGroups and addAdditionalPaths flag.
     * 
     * @param groups the HealthEndpointGroups to be used
     * @param addAdditionalPaths flag indicating whether additional paths should be added to the probe groups
     ...
     * 
     * @param addAdditionalPaths a boolean indicating whether additional paths should be added to the probe groups
     * @return a map of probe groups, with liveness and readiness as keys and corresponding HealthEndpointGroup objects as values
     */
     ...
     * 
     * @param addAdditionalPath true if an additional path should be added, false otherwise
     * @param path the path for the additional health endpoint
     * @param group the existing health endpoint group
     * @return the health endpoint group with the additional path added, or the original group if no additional path is added
     */
