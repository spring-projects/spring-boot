...
public class CloudFoundryActuatorAutoConfiguration {
	...
	/**
	 * Creates a CloudFoundryHealthEndpointWebExtension bean if there is no existing bean
	 * of the same type. This bean is conditional on the availability of the
	 * HealthEndpoint and HealthEndpointWebExtension beans.
	 * @param healthEndpointWebExtension The HealthEndpointWebExtension bean to be used by
	 * the CloudFoundryHealthEndpointWebExtension bean.
	...
	/**
	 * Creates a CloudFoundryInfoEndpointWebExtension bean if there is no existing bean of
	 * the same type. This bean is conditional on the availability of the InfoEndpoint and
	 * GitProperties beans. It is also conditional on the availability of the endpoint
	 * itself.
	...
	/**
	 * Creates a {@link CloudFoundryWebEndpointServletHandlerMapping} bean for mapping
	 * Cloud Foundry web endpoints.
	 * @param parameterMapper the {@link ParameterValueMapper} used for mapping parameter
	 * values
	 * @param endpointMediaTypes the {@link EndpointMediaTypes} used for determining media
	 * types
	 * @param restTemplateBuilder the {@link RestTemplateBuilder} used for building REST
	 * templates
	 * @param servletEndpointsSupplier the {@link ServletEndpointsSupplier} used for
	 * supplying servlet endpoints
	 * @param controllerEndpointsSupplier the {@link ControllerEndpointsSupplier} used for
	 * supplying controller endpoints
	 * @param applicationContext the {@link ApplicationContext} used for accessing the
	 * application context
	 ...
	 *
	 * This method creates a CloudFoundrySecurityInterceptor object by initializing the
	 * necessary dependencies such as CloudFoundrySecurityService, TokenValidator, and the
	 * application ID. The CloudFoundrySecurityInterceptor is used to intercept and
	 * validate security tokens in Cloud Foundry environments.
	 * @param restTemplateBuilder The RestTemplateBuilder object used to build
	 ...
	 * @return An instance of CloudFoundrySecurityService if the cloudControllerUrl
	 * property is not null, otherwise null.
	 */
	...
	public static class IgnoredCloudFoundryPathsWebSecurityConfiguration {
		...
		/**
		 * Creates an instance of IgnoredCloudFoundryPathsWebSecurityCustomizer with the
		 * provided CloudFoundryWebEndpointServletHandlerMapping. This customizer is used
		 * to ignore specific paths in Cloud Foundry when configuring web security.
		 * @param handlerMapping The CloudFoundryWebEndpointServletHandlerMapping used to
		 * map Cloud Foundry endpoints.
	...
	static class IgnoredCloudFoundryPathsWebSecurityCustomizer implements WebSecurityCustomizer {
		...
		/**
		 * Constructs a new IgnoredCloudFoundryPathsWebSecurityCustomizer with the
		 * specified CloudFoundryWebEndpointServletHandlerMapping.
		 * @param handlerMapping the CloudFoundryWebEndpointServletHandlerMapping used to
		...
		/**
		 * Customizes the web security configuration to ignore certain paths in Cloud
		 * Foundry.
