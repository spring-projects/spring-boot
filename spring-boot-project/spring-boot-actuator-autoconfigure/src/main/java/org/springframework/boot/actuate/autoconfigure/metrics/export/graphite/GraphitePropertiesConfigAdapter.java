...
class GraphitePropertiesConfigAdapter extends PropertiesConfigAdapter<GraphiteProperties> implements GraphiteConfig {
	...
	/**
     * Constructs a new GraphitePropertiesConfigAdapter with the specified GraphiteProperties.
     *
	...
	/**
     * Returns the prefix for the Graphite metrics export configuration.
     * The prefix is used to identify the properties related to Graphite metrics export in the configuration file.
     *
	...
	/**
     * Retrieves the value associated with the specified key from the GraphitePropertiesConfigAdapter.
     * 
     ...
     * 
     * @return {@code true} if the Graphite properties are enabled, {@code false} otherwise.
     */
    @Override
	...
	/**
     * Returns the host value for the GraphitePropertiesConfigAdapter.
     * If the host value is not present in the GraphiteProperties, it falls back to the default host value from GraphiteConfig.
     *
