...
public class PropertiesMeterFilter implements MeterFilter {
	...
	/**
     * Determines whether a meter should be accepted or denied based on the provided meter ID and the enable property.
     * 
     * @param id The meter ID to be checked.
     * @return The meter filter reply, either NEUTRAL if the meter is enabled or DENY if the meter is disabled.
     */
    @Override
	...
	/**
     * Converts an array of ServiceLevelObjectiveBoundary objects to an array of doubles based on the provided meter type.
     * 
     * @param meterType the type of meter
     * @param slo the array of ServiceLevelObjectiveBoundary objects
     * @return an array of doubles representing the converted ServiceLevelObjectiveBoundary values, or null if the input array is null or empty
     */
	...
	/**
     * Converts a meter value from a string representation to a double value based on the specified meter type.
     * 
	...
	/**
     * Looks up a value in the given map based on the provided id.
     ...
     * @return the value associated with the id in the map, or the default value if the map is empty
     */
	...
	/**
     * Looks up a value in the given map using the specified ID, with a fallback to the "all" key if the map is not empty.
     * 
     * @param <T> the type of the values in the map
     * @param values the map containing the values to be looked up
     * @param id the ID used to lookup the value in the map
     * @param defaultValue the default value to be returned if the map is empty or the lookup fails
     * @return the value associated with the specified ID, or the default value if the map is empty or the lookup fails
     */
     ...
     * @param defaultValue a supplier function that provides a default value if no match is found
