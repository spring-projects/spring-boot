...
public class ObservationProperties {
	 ...
	 * @param enable a map containing the enable status for each observation property. The
	 * key is the property name and the value is a boolean indicating whether the property
	 * is enabled or not.
	 */
	...
	public static class Http {
		...
		public static class Client {
			...
			/**
			 * Returns the ClientRequests object containing the requests made by the
			 * client.
			 * @return the ClientRequests object containing the requests made by the
			 * client
			 */
		...
		public static class Server {
			...
			/**
			 * Returns the ServerRequests object that contains the requests made to the
			 * server.
			 * @return the ServerRequests object containing the requests made to the
			 * server
			 */
