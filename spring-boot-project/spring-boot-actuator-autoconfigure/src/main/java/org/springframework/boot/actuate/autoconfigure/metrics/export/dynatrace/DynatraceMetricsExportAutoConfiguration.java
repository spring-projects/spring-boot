...
public class DynatraceMetricsExportAutoConfiguration {
	...
	/**
	 * Constructs a new DynatraceMetricsExportAutoConfiguration with the specified
	 * DynatraceProperties.
	...
	/**
	 * Creates a DynatraceConfig bean if no other bean of the same type is present. This
	 * bean is used to configure the Dynatrace metrics export.
	...
	/**
	 * Creates a DynatraceMeterRegistry bean if there is no existing bean of the same
	 * type.
	 * @param dynatraceConfig The DynatraceConfig object containing the configuration
	 * properties for Dynatrace.
