...
class DefaultEndpointObjectNameFactory implements EndpointObjectNameFactory {
	...
	/**
	 * Constructs a new DefaultEndpointObjectNameFactory with the specified properties,
	 * JMX properties, MBean server, and context ID.
	 ...
	 * @return a string representation of the static names, or an empty string if there
	 * are no static names
	 */
