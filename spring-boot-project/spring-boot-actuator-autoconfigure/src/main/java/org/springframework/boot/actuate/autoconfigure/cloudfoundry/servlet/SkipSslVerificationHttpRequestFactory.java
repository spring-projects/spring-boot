...
class SkipSslVerificationHttpRequestFactory extends SimpleClientHttpRequestFactory {
	...
	/**
	 * Prepares the HTTPS connection by setting the hostname verifier and SSL socket
	 * factory.
	...
	private static final class SkipX509TrustManager implements X509TrustManager {
		...
		/**
		 * Returns an array of X509Certificates that are accepted issuers for this trust
		 * manager.
		 * @return an array of X509Certificates that are accepted issuers for this trust
		 * manager.
		 */
		@Override
		...
		/**
		 * This method is used to check the trustworthiness of a client's X509
		 * certificate.
		...
		/**
		 * This method is used to check the trustworthiness of the server's X509
		 * certificate chain.
