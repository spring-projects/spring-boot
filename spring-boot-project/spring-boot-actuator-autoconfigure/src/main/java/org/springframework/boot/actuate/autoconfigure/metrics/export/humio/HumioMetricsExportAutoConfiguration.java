...
public class HumioMetricsExportAutoConfiguration {
	...
	/**
	 * Constructs a new instance of HumioMetricsExportAutoConfiguration with the specified
	 * HumioProperties.
	...
	/**
	 * Creates a HumioConfig bean if no other bean of the same type is present. This
	 * method is annotated with @ConditionalOnMissingBean to ensure that it is only
	 * executed if no other bean of the same type is already defined. It returns a new
	 * instance of HumioPropertiesConfigAdapter, which is an implementation of the
	 * HumioConfig interface. The properties parameter is used to initialize the
	 * HumioPropertiesConfigAdapter instance.
	 ...
	 * @param humioConfig The HumioConfig object used for configuring the
	 * HumioMeterRegistry.
