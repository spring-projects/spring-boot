...
public class SimpleMetricsExportAutoConfiguration {
	...
	/**
	 * Creates a new instance of SimpleMeterRegistry with the provided configuration and
	 * clock.
	 ...
	 * @param simpleProperties the SimpleProperties object used to configure the
	 * SimpleConfig bean
