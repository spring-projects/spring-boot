...
public class GraphiteMetricsExportAutoConfiguration {
	...
	/**
	 * Creates a GraphiteConfig bean if no other bean of the same type is present. Uses
	 * the provided GraphiteProperties to create a GraphitePropertiesConfigAdapter.
	 * @param graphiteProperties the GraphiteProperties used to create the GraphiteConfig
	 * bean
	...
	/**
	 * Creates a new instance of GraphiteMeterRegistry if no other bean of the same type
	 * is present.
