...
public class ElasticMetricsExportAutoConfiguration {
	...
	/**
	 * Constructs a new instance of ElasticMetricsExportAutoConfiguration with the
	 * specified ElasticProperties.
	 ...
	 *
	 * This method checks for mutually exclusive configuration properties and throws an
	 * exception if multiple non-null values are found.
	 *
	 * The first check is for the "api-key-credentials" and "user-name" properties. If
	 * both properties have non-null values, an exception is thrown.
	 *
	 * The second check is for the "api-key-credentials" and "password" properties. If
	 * both properties have non-null values, an exception is thrown.
	 *
	 * Finally, an instance of ElasticPropertiesConfigAdapter is created using the
	 * properties provided.
	...
	/**
	 * Creates an instance of ElasticMeterRegistry if no other bean of the same type is
	 * present.
	 * @param elasticConfig The ElasticConfig object containing the configuration for the
