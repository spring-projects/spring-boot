...
class ReactiveTokenValidator {
	...
	/**
	 * Constructs a new ReactiveTokenValidator with the specified
	 * ReactiveCloudFoundrySecurityService.
	 * @param securityService the ReactiveCloudFoundrySecurityService used for token
	 * validation
	 */
	 ...
	 * @throws CloudFoundryAuthorizationException if the algorithm is invalid or
	 * unsupported
	 */
	 ...
	 * @throws CloudFoundryAuthorizationException if the RSA signature does not match the
	 * content.
	 */
	 ...
	 * @throws CloudFoundryAuthorizationException if the key ID present in the token
	 * header does not match any of the fetched token keys.
	 */
	 ...
	 * @param token The token to be validated.
	 * @return A Mono that completes successfully if the token is not expired, or throws a
	 * CloudFoundryAuthorizationException if the token is expired.
	 */
	 ...
	 * @return a Mono that completes successfully if the audience is valid, or completes
	 * with an error if the audience is invalid
	 * @throws CloudFoundryAuthorizationException if the token does not have the required
	 * audience
	 */
