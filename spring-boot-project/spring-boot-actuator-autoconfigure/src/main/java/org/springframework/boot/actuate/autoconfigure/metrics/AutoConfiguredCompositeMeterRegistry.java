...
class AutoConfiguredCompositeMeterRegistry extends CompositeMeterRegistry {
	...
	/**
	 * Constructs a new AutoConfiguredCompositeMeterRegistry with the specified clock and
	 * list of meter registries.
	 * @param clock the clock used for measuring time
	 * @param registries the list of meter registries to be included in the composite
	 * meter registry
	 */
