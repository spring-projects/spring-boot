...
public final class EndpointRequest {
	...
	private abstract static class AbstractRequestMatcher
         ...
         * 
         * This constructor initializes the AbstractRequestMatcher by calling the constructor of its superclass, passing a WebApplicationContext as a parameter.
         * 
         * @param context the WebApplicationContext to be passed to the superclass constructor
         */
		...
		/**
         * Determines whether to ignore the application context based on the management port type and server namespace.
         * 
		...
		/**
         * Initializes the request matcher by creating a delegate object using the provided context.
         * 
		...
		/**
         * Determines if the given HttpServletRequest matches the request criteria defined by this RequestMatcher.
         * 
		...
		/**
         * Creates a delegate RequestMatcher using the provided WebApplicationContext and RequestMatcherFactory.
         * 
         * @param context the WebApplicationContext to use for creating the delegate RequestMatcher
         * @return the delegate RequestMatcher
         * @throws NoSuchBeanDefinitionException if the RequestMatcherFactory bean is not found in the context
         */
         ...
         * Creates a delegate RequestMatcher using the provided WebApplicationContext and RequestMatcherFactory.
         * 
         * @param context the WebApplicationContext used to create the delegate RequestMatcher
         * @param requestMatcherFactory the RequestMatcherFactory used to create the delegate RequestMatcher
         * @return the delegate RequestMatcher created using the provided context and requestMatcherFactory
         */
         ...
         * 
         * @param context the WebApplicationContext from which to retrieve the RequestMatcherProvider bean
         * @return the RequestMatcherProvider bean if found, otherwise a default AntPathRequestMatcher
         */
	...
	public static final class EndpointRequestMatcher extends AbstractRequestMatcher {
		...
		/**
         * Constructs a new EndpointRequestMatcher with the specified includeLinks parameter.
         *
		...
		/**
         * Constructs a new EndpointRequestMatcher with the specified endpoints and includeLinks flag.
         *
		...
		/**
         * Constructs a new EndpointRequestMatcher with the specified includes, excludes, and includeLinks.
         *
         ...
         * @param includeLinks a boolean indicating whether to include links in the matching process
         */
		...
		/**
         * Creates a new EndpointRequestMatcher with additional endpoints excluded from matching.
         * 
		...
		/**
         * Creates a new EndpointRequestMatcher with the same includes and excludes as the current instance,
         * but with the option to exclude links from the matching process.
         * 
         * @return a new EndpointRequestMatcher instance with the excludes and includes of the current instance,
         *         but with the option to exclude links
         */
		...
		/**
         * Creates a delegate RequestMatcher based on the provided WebApplicationContext and RequestMatcherFactory.
         * 
         * @param context The WebApplicationContext used to retrieve the PathMappedEndpoints bean.
         * @param requestMatcherFactory The RequestMatcherFactory used to create the delegate RequestMatcher.
	...
	public static final class LinksRequestMatcher extends AbstractRequestMatcher {
         ...
         * Creates a delegate RequestMatcher based on the provided WebApplicationContext and RequestMatcherFactory.
         * 
         * @param context The WebApplicationContext used to retrieve the WebEndpointProperties bean.
         * @param requestMatcherFactory The RequestMatcherFactory used to create the RequestMatchers.
	...
	private static final class RequestMatcherFactory {
         ...
         * 
         * @param matcherProvider the RequestMatcherProvider used to create the RequestMatcher
