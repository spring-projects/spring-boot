...
public class OpenTelemetrySlf4jBaggageApplicationListener implements ApplicationListener<ApplicationEvent> {

	private final Slf4JBaggageEventListener listener;

	OpenTelemetrySlf4jBaggageApplicationListener(List<String> correlationFields) {
