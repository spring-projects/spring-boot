...
class ObservationRegistryConfigurer {
	...
	/**
	 * Constructs a new ObservationRegistryConfigurer with the specified customizers,
	 * observation predicates, observation conventions, observation handlers, observation
	 * handler grouping, and observation filters.
	 * @param customizers the customizers to be applied to the observation registry
	 * @param observationPredicates the observation predicates to be used for filtering
	 * observations
	 * @param observationConventions the observation conventions to be applied to the
	 * observation registry
	 * @param observationHandlers the observation handlers to be registered with the
	 * observation registry
	 * @param observationHandlerGrouping the observation handler grouping to be used for
	 * grouping observation handlers
	 * @param observationFilters the observation filters to be applied to the observation
	 * registry
	 */
	...
	/**
	 * Configures the ObservationRegistry by registering observation predicates, global
	 * observation conventions, handlers, filters, and applying customizations.
	 ...
	 * @param registry the {@link ObservationRegistry} to register the observation
	 * predicates in
	 */
	...
	/**
	 * Registers the global observation conventions in the provided
	...
	/**
	 * Customizes the given ObservationRegistry by invoking the customize method of each
