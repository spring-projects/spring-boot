...
class BravePropagationConfigurations {
	...
	static class PropagationWithoutBaggage {
		...
		/**
         * Creates a composite propagation factory based on the provided tracing properties.
         * This method is annotated with @Bean to indicate that it is a bean definition method.
         * It is also annotated with @ConditionalOnMissingBean(Factory.class) to ensure that this bean is only created if there is no existing bean of type Factory.
         * Additionally, it is annotated with @ConditionalOnEnabledTracing to ensure that tracing is enabled before creating this bean.
         * 
         * @param properties the tracing properties used to configure the composite propagation factory
	...
	static class PropagationWithBaggage {
		...
		/**
         * Creates a BaggagePropagation.FactoryBuilder bean if no other bean of the same type is present.
         * This method is conditional on the absence of a bean of the same type.
         * 
         * The BaggagePropagation.FactoryBuilder is responsible for building a factory that creates instances of BaggagePropagation.
         * 
         * This method takes an ObjectProvider of BaggagePropagationCustomizer as a parameter, which allows for customizing the BaggagePropagation.FactoryBuilder.
         * 
         * The method first creates a throw-away builder with a throw-away factory, as there is a chicken-and-egg problem where the builder needs a factory, but the CompositePropagationFactory needs data from the builder.
         * 
         * It then iterates over the baggagePropagationCustomizers and applies each customizer to the throw-away builder.
         * 
         * Next, it creates a CompositePropagationFactory using the tracingProperties for propagation and a BraveBaggageManager for baggage.
         * 
         * After that, it creates the real builder using the CompositePropagationFactory and copies the configuration from the throw-away builder to the real builder.
         * 
         * Finally, it returns the real builder.
         * 
         * @param baggagePropagationCustomizers the ObjectProvider of BaggagePropagationCustomizer used for customizing the BaggagePropagation.FactoryBuilder
		...
		/**
         * Customizer for baggage propagation configuration.
         * Adds remote and local baggage fields to the builder based on the configuration properties.
         *
		...
		/**
         * Generates a factory for baggage propagation based on the provided factory builder.
         * This method is annotated with @Bean, @ConditionalOnMissingBean, and @ConditionalOnEnabledTracing.
         * 
         * @param factoryBuilder the factory builder used to build the baggage propagation factory
		...
		/**
         * Returns a builder for creating a {@link CorrelationScopeDecorator} with MDC (Mapped Diagnostic Context) support.
         * This builder is conditional on the absence of an existing bean of type {@link CorrelationScopeDecorator}.
         * 
         * @param correlationScopeCustomizers an object provider for {@link CorrelationScopeCustomizer} instances
         * @return a builder for creating a {@link CorrelationScopeDecorator} with MDC support
         */
        @Bean
		@ConditionalOnMissingBean
		...
		/**
         * Creates a customizer for correlation fields in the correlation scope.
         * This customizer is conditionally enabled based on the property "management.tracing.baggage.correlation.enabled".
         * If the property is not present, the customizer is enabled by default.
         * The customizer adds correlation fields to the correlation scope based on the configuration properties.
         * Each field is created as a baggage field and added to the correlation scope builder.
		...
		/**
         * Generates a new instance of ScopeDecorator if there is no existing bean of type CorrelationScopeDecorator.
         * 
         * @param builder the builder used to construct the CorrelationScopeDecorator instance
         * @return a new instance of ScopeDecorator if there is no existing bean of type CorrelationScopeDecorator
         */
        @Bean
	...
	static class NoPropagation {
		...
		/**
         * Creates a CompositePropagationFactory with a noop implementation if no other bean of type Factory is present.
         * 
