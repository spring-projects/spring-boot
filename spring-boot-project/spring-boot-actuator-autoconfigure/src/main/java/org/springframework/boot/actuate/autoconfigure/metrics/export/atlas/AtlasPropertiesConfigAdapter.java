...
class AtlasPropertiesConfigAdapter extends PropertiesConfigAdapter<AtlasProperties> implements AtlasConfig {
	...
	/**
	 * Returns the URI value from the AtlasProperties configuration, or falls back to the
	 * default URI value from the AtlasConfig interface.
	 ...
	 * @return {@code true} if the publish step should be ignored, {@code false}
	 * otherwise.
	 */
	@Override
