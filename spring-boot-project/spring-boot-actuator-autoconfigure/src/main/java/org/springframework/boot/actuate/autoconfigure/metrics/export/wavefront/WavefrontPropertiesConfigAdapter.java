...
public class WavefrontPropertiesConfigAdapter
	...
	/**
	 * Constructs a new WavefrontPropertiesConfigAdapter with the given
	 * WavefrontProperties.
	 * @param properties the WavefrontProperties object containing the configuration
	 * properties
	 */
	 ...
	 * @throws IllegalStateException if the API token is not found in the properties
	 * configuration
	 */
	@Override
	 ...
	 * @return {@code true} if the reportHourDistribution property is enabled,
