...
public class StartupEndpointAutoConfiguration {
	...
	/**
	 * Creates a new instance of the {@link StartupEndpoint} bean if no other bean of the
	 * same type is present.
	 * @param applicationStartup the {@link BufferingApplicationStartup} to be used by the
	 * {@link StartupEndpoint}
