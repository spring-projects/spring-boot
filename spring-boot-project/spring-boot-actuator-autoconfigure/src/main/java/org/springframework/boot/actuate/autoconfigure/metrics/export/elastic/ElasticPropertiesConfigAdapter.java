...
class ElasticPropertiesConfigAdapter extends StepRegistryPropertiesConfigAdapter<ElasticProperties>
	...
	/**
	 * Constructs a new ElasticPropertiesConfigAdapter with the specified
	 * ElasticProperties.
	...
	/**
	 * Returns the host value from ElasticPropertiesConfigAdapter. If the host value is
	 * not present in ElasticPropertiesConfigAdapter, it falls back to the default host
	 * value from ElasticConfig.
	 ...
	 * from the {@link ElasticProperties} interface, or falls back to the default
	 * implementation provided by the {@link ElasticConfig} interface by invoking the
	 * {@link ElasticConfig#super::index} method.
	...
	/**
	 * Returns the pipeline value from ElasticPropertiesConfigAdapter. If the pipeline
	 * value is not present in ElasticPropertiesConfigAdapter, it falls back to the
	 * default pipeline value from ElasticConfig.
