...
public class IncludeExcludeEndpointFilter<E extends ExposableEndpoint<?>> implements EndpointFilter<E> {
	...
	/**
	 * Binds the given name to a list of strings using the provided binder. If the binding
	 * is successful, returns the bound list of strings. If the binding fails, returns an
	 * empty ArrayList.
	...
	private static class EndpointPatterns {
		...
		/**
		 * Constructs a new instance of the EndpointPatterns class using the provided
		 * array of patterns.
		 * @param patterns an array of patterns to be used for constructing the
		 * EndpointPatterns object
		 */
		 ...
		 * @param patterns the collection of patterns to be used for constructing the
		 * EndpointPatterns object
		 */
		 ...
		 * @return {@code true} if the endpoint patterns are empty, {@code false}
		 * otherwise.
		 */
		boolean isEmpty() {
			return this.empty;
