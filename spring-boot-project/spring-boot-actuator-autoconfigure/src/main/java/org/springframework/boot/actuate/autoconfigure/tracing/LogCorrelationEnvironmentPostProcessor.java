...
class LogCorrelationEnvironmentPostProcessor implements EnvironmentPostProcessor {
	...
	/**
	 * Post-processes the environment by adding a LogCorrelationPropertySource if the
	 * Tracer class from Micrometer is present in the application's class loader.
	...
	private static class LogCorrelationPropertySource extends EnumerablePropertySource<Object> {
		...
		/**
		 * Constructs a new LogCorrelationPropertySource with the specified source and
		 * environment.
