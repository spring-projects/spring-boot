...
class HttpTraceEndpointDocumentationTests extends MockMvcEndpointDocumentationTests {
	...
	void traces() throws Exception {
		...
		this.mockMvc.perform(get("/actuator/httptrace"))
			...
			.andDo(document("httptrace", responseFields(
					...
					fieldWithPath("traces.[].timestamp").description("Timestamp of when the traced exchange occurred."),
					fieldWithPath("traces.[].principal").description("Principal of the exchange, if any.").optional(),
