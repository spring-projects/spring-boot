...
class RemoteDevtoolsSecurityConfiguration {
	...
	/**
	 * Constructs a new RemoteDevtoolsSecurityConfiguration object with the specified
	 * DevToolsProperties and ServerProperties.
	 * @param devToolsProperties the DevToolsProperties object containing the
	 * configuration for DevTools
	 * @param serverProperties the ServerProperties object containing the configuration
	 * for the server
	 */
	...
	/**
	 * Creates a security filter chain for the devtools endpoint. This filter chain allows
	 * anonymous access to all requests. CSRF protection is disabled for this endpoint.
