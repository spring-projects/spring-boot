...
public class Dispatcher {
	...
	/**
	 * Constructs a new Dispatcher with the specified AccessManager and collection of
	 * HandlerMappers.
	 * @param accessManager the AccessManager to be used by the Dispatcher (must not be
	 * null)
	 * @param mappers the collection of HandlerMappers to be used by the Dispatcher (must
	 * not be null)
	...
	/**
	 * Handles the incoming request by checking if the request is allowed based on the
	 * access manager. If the request is not allowed, sets the response status code to
	 * HttpStatus.FORBIDDEN. Otherwise, delegates the handling of the request to the
	 * provided handler.
