...
public class RestartScopeInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
	...
	private static final class RestartScope implements Scope {
		...
		/**
		 * Retrieves an attribute from the Restarter instance or adds it if it doesn't
		 * exist.
		 * @param name the name of the attribute to retrieve or add
		 * @param objectFactory the object factory used to create the attribute if it
		 * doesn't exist
		 ...
		 * @return the value of the removed attribute, or null if the attribute does not
		 * exist
		 */
		@Override
