...
public class HttpStatusHandler implements Handler {
	...
	/**
	 * Handles the server HTTP request and sets the status code of the server HTTP
	 * response.
	 * @param request the server HTTP request to be handled
	 * @param response the server HTTP response to be modified
	 * @throws IOException if an I/O error occurs while handling the request or modifying
	 * the response
	 */
	@Override
