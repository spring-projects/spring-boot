...
class ConditionEvaluationDeltaLoggingListener
	...
	/**
	 * This method is called when the application is ready to start. It checks if the
	 * application context is the same as the current context. If it is, it retrieves the
	 * condition evaluation report and compares it with the previous report. If there are
	 * any changes in the condition evaluation, it logs the delta. Otherwise, it logs that
	 * the condition evaluation is unchanged.
	 * @param event The ApplicationReadyEvent triggered when the application is ready to
	 * start.
	 */
	@Override
