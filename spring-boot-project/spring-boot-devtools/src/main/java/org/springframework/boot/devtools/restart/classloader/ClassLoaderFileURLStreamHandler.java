...
public class ClassLoaderFileURLStreamHandler extends URLStreamHandler {
	...
	/**
	 * Constructs a new ClassLoaderFileURLStreamHandler with the specified
	 * ClassLoaderFile.
	...
	private class Connection extends URLConnection {
		...
		/**
		 * Returns an input stream for reading the contents of the file associated with
		 * this connection.
		...
		/**
		 * Returns the last modified timestamp of the file associated with this
		 * Connection.
