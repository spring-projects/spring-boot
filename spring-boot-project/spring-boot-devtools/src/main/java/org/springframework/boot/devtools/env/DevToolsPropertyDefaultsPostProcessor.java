...
public class DevToolsPropertyDefaultsPostProcessor implements EnvironmentPostProcessor {
	...
	/**
	 * Checks if the application is running locally or remotely based on the presence of
	 * the "remoteUrl" property in the environment.
	 * @param environment the configurable environment
	 ...
	 * @throws RuntimeException if the "devtools-property-defaults.properties" file does
	 * not exist or fails to load
	 */
