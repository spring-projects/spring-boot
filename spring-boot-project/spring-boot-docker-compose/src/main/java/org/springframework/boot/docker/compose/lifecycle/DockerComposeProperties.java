...
public class DockerComposeProperties {
	...
	/**
	 * Returns the LifecycleManagement object associated with this DockerComposeProperties
	 * instance.
	...
	/**
	 * Retrieves the DockerComposeProperties object from the given Binder. If the
	 * DockerComposeProperties object is not found in the Binder, a new instance is
	 * created.
	 * @param binder the Binder object used for retrieving the DockerComposeProperties
	 * object
	 * @return the DockerComposeProperties object retrieved from the Binder, or a new
	...
	public static class Skip {
		 ...
		 * @param inTests the value indicating whether the code is running in a test
		 * environment
		 */
