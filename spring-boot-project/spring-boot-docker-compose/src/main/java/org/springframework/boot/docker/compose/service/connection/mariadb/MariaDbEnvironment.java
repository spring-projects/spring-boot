...
class MariaDbEnvironment {
	 ...
	 * @throws IllegalArgumentException if any of the required environment variables are
	 * missing or empty
	 */
	 ...
	 * @throws IllegalStateException if any unsupported environment variable is found or
	 * if no password is found and empty passwords are not allowed
	 */
