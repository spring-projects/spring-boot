...
class ConnectionNamePredicate implements Predicate<DockerComposeConnectionSource> {
	...
	/**
	 * Constructs a new ConnectionNamePredicate with the specified required connection
	 * names.
	...
	/**
	 * Tests if the given DockerComposeConnectionSource matches the required connection
	 * name.
	 * @param source the DockerComposeConnectionSource to test
	 * @return true if the connection name matches the required connection name, false
	 * otherwise
	 */
	@Override
	...
	/**
	 * Returns the actual connection name of the given RunningService. If the service has
	 * a label "org.springframework.boot.service-connection", it returns the canonical
	 * name of the label. Otherwise, it returns the name of the service image.
