...
class OracleXeR2dbcDockerComposeConnectionDetailsFactory extends OracleR2dbcDockerComposeConnectionDetailsFactory {
	 ...
	 *
	 * This constructor initializes the factory by calling the superclass constructor with
	 * the OracleContainer.XE parameter. The OracleContainer.XE parameter specifies the
	 * Oracle container to be used for the connection details.
	 */
