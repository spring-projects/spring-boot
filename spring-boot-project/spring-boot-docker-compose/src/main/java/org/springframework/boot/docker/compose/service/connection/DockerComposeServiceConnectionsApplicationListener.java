...
class DockerComposeServiceConnectionsApplicationListener
	...
	/**
     * Constructs a new DockerComposeServiceConnectionsApplicationListener with the default ConnectionDetailsFactories.
     */
	...
	/**
     * Constructs a new DockerComposeServiceConnectionsApplicationListener with the specified ConnectionDetailsFactories.
     *
	...
	/**
     * This method is called when the DockerComposeServicesReadyEvent is triggered.
     * It registers the connection details for the running services in the application context.
     * 
     ...
     * @param runningServices  the list of RunningService objects containing the details of the running services
     */
	...
	/**
     * Registers a bean definition in the given registry for the specified running service and connection details.
     * 
	...
	/**
     * Returns the bean name for the given RunningService and connectionDetailsType.
     * The bean name is generated by concatenating the short name of the connectionDetailsType,
     * the word "for", and the individual parts of the RunningService name (split by "-").
     * The generated bean name is then converted to lowercase.
     *
