...
public abstract class DockerComposeConnectionDetailsFactory<D extends ConnectionDetails>
	 ...
	 * @return the connection details for the given DockerComposeConnectionSource, or null
	 * if the source is not accepted
	 */
	@Override
	...
	/**
	 * Checks if the given DockerComposeConnectionSource is accepted based on the
	 * following criteria: - The required classes are available - The given predicate test
	 * passes for the source
