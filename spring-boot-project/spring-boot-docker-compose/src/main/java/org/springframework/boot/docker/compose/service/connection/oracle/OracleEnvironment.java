...
class OracleEnvironment {
	...
	/**
	 * Constructs a new OracleEnvironment object with the given environment variables and
	 * default database.
	 * @param env a map containing the environment variables
	 * @param defaultDatabase the default database to use if the ORACLE_DATABASE
	 ...
	 * @throws IllegalStateException if the required password information is not found in
	 * the environment map
	 */
