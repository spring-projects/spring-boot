...
public class SystemEnvironmentPropertyMapperTests extends AbstractPropertyMapperTests {
	...
	public void mapFromConfigurationShouldReturnBestGuess() {
		...
		assertThat(namesFromConfiguration("host.f00.name")).containsExactly("HOST_F00_NAME");
		assertThat(namesFromConfiguration("foo.the-bar")).containsExactly("FOO_THEBAR", "FOO_THE_BAR");
	}
