...
final class DelimitedStringToCollectionConverter implements ConditionalGenericConverter {
	...
	/**
	 * Constructs a new DelimitedStringToCollectionConverter with the specified
	 * ConversionService.
	 * @param conversionService the ConversionService to be used for converting the
	 * delimited string to a collection
	...
	/**
	 * Returns a set of convertible types for the DelimitedStringToCollectionConverter
	 * class.
	 * @return a set containing a single ConvertiblePair object representing the
	 * conversion from String to Collection.
	 */
	@Override
	...
	/**
	 * Creates a collection of objects based on the given target type, element descriptor,
	 * and length.
	...
	/**
	 * Splits the given source string into an array of elements using the specified
	 * delimiter.
	 * @param source the source string to be split
	 * @param delimiter the delimiter used to split the source string
	 * @return an array of elements obtained by splitting the source string using the
	 * delimiter
	 */
