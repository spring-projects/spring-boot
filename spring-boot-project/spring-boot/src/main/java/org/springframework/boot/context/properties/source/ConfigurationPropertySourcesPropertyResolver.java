...
class ConfigurationPropertySourcesPropertyResolver extends AbstractPropertyResolver {
	...
	/**
	 * Constructs a new ConfigurationPropertySourcesPropertyResolver with the specified
	 ...
	 * @return true if the key is present in the configuration property sources, false
	 * otherwise
	 */
	@Override
	 ...
	 * Retrieves the value of the property associated with the given key.
	 * @param key the key of the property to retrieve
	 * @param targetValueType the class representing the desired type of the property
	 * value
	 * @return the value of the property associated with the given key, or null if not
	 * found
	 * @throws IllegalArgumentException if the key is null or empty
	 * @throws ClassCastException if the value of the property cannot be cast to the
	 * specified targetValueType
	 */
	@Override
	 ...
	 * @param targetValueType the class representing the desired type of the property
	 * value
	 * @param resolveNestedPlaceholders a flag indicating whether nested placeholders
	 * should be resolved
	...
	/**
	 * Retrieves the attached ConfigurationPropertySourcesPropertySource from the
	 * propertySources.
	 * @return The attached ConfigurationPropertySourcesPropertySource, or null if not
	 * found.
	 */
	...
	static class DefaultResolver extends PropertySourcesPropertyResolver {
		 ...
		 * @param targetValueType the class representing the desired type of the property
		 * value
		 * @param resolveNestedPlaceholders indicates whether nested placeholders should
		 * be resolved
		 * @return the value of the property with the specified key, or null if the
