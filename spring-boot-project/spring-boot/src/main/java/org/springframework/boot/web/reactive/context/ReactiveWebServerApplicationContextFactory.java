...
class ReactiveWebServerApplicationContextFactory implements ApplicationContextFactory {
	 ...
	 * @return the environment type if the web application type is reactive, otherwise
	 * null
	 */
	@Override
	 ...
	 * @param webApplicationType the type of web application
	 * @return the created environment, or null if the web application type is not
	 * reactive
	 */
	@Override
	...
	/**
	 * Creates a new ConfigurableApplicationContext based on the specified
	 * WebApplicationType.
	 * @param webApplicationType the type of web application
	 * @return the created ConfigurableApplicationContext, or null if the web application
	 * type is not reactive
	 */
	@Override
	...
	/**
	 * Creates a new ConfigurableApplicationContext based on the current environment. If
	 * the AotDetector does not use generated artifacts, an
	 * AnnotationConfigReactiveWebServerApplicationContext is created. Otherwise, a
	 * ReactiveWebServerApplicationContext is created.
