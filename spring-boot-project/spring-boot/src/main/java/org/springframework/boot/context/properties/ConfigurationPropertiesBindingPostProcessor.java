...
public class ConfigurationPropertiesBindingPostProcessor
	...
	/**
	 * Returns the order of this ConfigurationPropertiesBindingPostProcessor. The order is
	 * determined by adding 1 to the highest precedence value.
	...
	/**
	 * This method is called before the initialization of a bean. It checks if the bean
	 * has a bound value object associated with it. If not, it binds the bean with the
	 * corresponding ConfigurationPropertiesBean using the ApplicationContext.
	...
	/**
	 * Binds the given ConfigurationPropertiesBean to its corresponding configuration
	 * properties.
	 * @param bean the ConfigurationPropertiesBean to bind
	 * @throws ConfigurationPropertiesBindException if an error occurs during the binding
	 * process
	 * @throws IllegalStateException if @ConstructorBinding has been applied to a regular
	 * bean
	 */
