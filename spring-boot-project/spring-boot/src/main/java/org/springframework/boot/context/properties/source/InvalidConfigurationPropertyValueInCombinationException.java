...
/**
 * Exception thrown when Individual property values are valid but the combination of
 * configuration property value are invalid.
 *
 * @author Stephen Barkley-Yeung
 * @since 3.5.0
 *
 * WIP
 */
@SuppressWarnings("serial")
public class InvalidConfigurationPropertyValueInCombinationException extends RuntimeException {
	 ...
	 * returns are allowed.
	 */
	public InvalidConfigurationPropertyValueInCombinationException(String name, Object value, String reason) {
