...
class DefaultBindConstructorProvider implements BindConstructorProvider {
	 ...
	 * @param isNestedConstructorBinding true if the bindable object is a nested
	 * constructor binding, false otherwise
	 ...
	 * @param isNestedConstructorBinding true if the constructor is a nested constructor
	...
	static final class Constructors {
		 ...
		 * @param hasAutowired a boolean indicating whether the class has autowired
		 * dependencies
		 * @param bind the constructor to bind to the class
		 * @param deducedBindConstructor a boolean indicating whether the bind constructor
		 * was deduced
		 * @param immutableType a boolean indicating whether the class is of immutable
		 * type
		 */
		 ...
		 * @return {@code true} if the bind constructor is deduced, {@code false}
		 * otherwise.
		 */
		...
		/**
		 * Retrieves the constructors for a given class, considering the specified
		 * parameters.
		 * @param type the class for which to retrieve the constructors
		 * @param isNestedConstructorBinding flag indicating whether the constructor
		 * binding is nested
		...
		/**
		 * Checks if the given class or any of its superclasses have the {@code Autowired}
		 * annotation present on any of its constructors.
		 * @param type the class to check
		 * @return {@code true} if the {@code Autowired} annotation is present on any
		...
		/**
		 * Returns the constructor annotated with {@link ConstructorBinding} from the
		 * given array of candidate constructors.
		 * @param type the class type
		 * @param candidates the array of candidate constructors
		 * @param mergedAnnotations the array of merged annotations for each candidate
		 * constructor
		 * @return the constructor annotated with {@link ConstructorBinding}, or null if
		 * none found
		 * @throws IllegalStateException if the class type declares
		 * {@link ConstructorBinding} on a no-args constructor
		 * @throws IllegalStateException if the class type has more than one constructor
		 * annotated with {@link ConstructorBinding}
		 */
