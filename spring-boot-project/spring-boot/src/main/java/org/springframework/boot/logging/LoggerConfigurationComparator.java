...
class LoggerConfigurationComparator implements Comparator<LoggerConfiguration> {
	 ...
	 * @return -1 if the rootLoggerName of o1 matches the rootLoggerName of the
	 * comparator, 1 if the rootLoggerName of o2 matches the rootLoggerName of the
	 * comparator, otherwise, returns the result of comparing the names of o1 and o2
	 */
	@Override
