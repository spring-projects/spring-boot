...
class SslConnectorCustomizer {
	...
	/**
	 * Constructs a new SslConnectorCustomizer with the specified logger, connector, and
	 ...
	 * @throws IllegalStateException if the connector's protocol handler is not an
	 * instance of AbstractHttp11JsseProtocol
	 */
	...
	/**
	 * Configures the enabled protocols for the SSLHostConfig object based on the provided
	 * SslOptions object.
	...
	/**
	 * Configures the SSL store provider for the given protocol, SSL host configuration,
	 * certificate, and store bundle.
	 * @param protocol The protocol to configure the SSL store provider for. Must be an
	 * instance of Http11NioProtocol.
