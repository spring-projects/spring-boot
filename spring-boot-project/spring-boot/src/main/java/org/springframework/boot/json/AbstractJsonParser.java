...
public abstract class AbstractJsonParser implements JsonParser {
	...
	/**
	 * Trims the given JSON string, checks if it starts with the specified prefix, and
	 * parses it using the provided parser function.
	 ...
	 * @throws JsonParseException if the trimmed JSON string does not start with the
	 * specified prefix
	 */
	...
	/**
	 * Tries to parse a value using the provided parser and handles any exceptions that
	 * occur.
	 * @param parser the parser to use for parsing the value
	 * @param check the exception class to check against
	 * @return the parsed value
	 * @throws JsonParseException if the parsing fails with an exception of the specified
	 * class
	 * @throws IllegalStateException if the parsing fails with an exception other than the
	 * specified class
	 */
