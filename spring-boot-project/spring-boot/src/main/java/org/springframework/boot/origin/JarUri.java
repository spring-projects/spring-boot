...
final class JarUri {
	...
	/**
	 * Returns the description of the existing string appended with the description of the
	 * JarUri object.
	 ...
	 * @return a JarUri object if the URI string starts with the JAR_SCHEME and contains
	 * the JAR_EXTENSION, otherwise returns null
	 */
