...
class AnnotationDependsOnDatabaseInitializationDetector implements DependsOnDatabaseInitializationDetector {
	...
	/**
	 * Detects beans in the given bean factory that have the
	 * {@link DependsOnDatabaseInitialization} annotation.
	 * @param beanFactory the bean factory to search for annotated beans
	 * @return a set of bean names that have the {@link DependsOnDatabaseInitialization}
	 * annotation
	 */
	@Override
