...
class InvalidConfigurationPropertyValueFailureAnalyzer
	...
	/**
     * Constructs a new InvalidConfigurationPropertyValueFailureAnalyzer with the specified environment.
     * 
     ...
     * @return a FailureAnalysis object containing the analysis of the failure, or null if no descriptors are found
     */
    @Override
	...
	/**
     * Appends details to the given StringBuilder message for an InvalidConfigurationPropertyValueException.
     * 
     ...
     * @param cause the InvalidConfigurationPropertyValueException that contains the reason for the validation failure
     */
     ...
     * @param descriptors the list of Descriptor objects representing the additional properties
     */
    ...
    private static final class Descriptor {
		...
		/**
         * Constructs a new Descriptor with the specified property source, value, and origin.
         * 
		...
		/**
         * Appends the origin of the message to the provided StringBuilder.
         * If the origin is not null, it appends the origin in the format: 
