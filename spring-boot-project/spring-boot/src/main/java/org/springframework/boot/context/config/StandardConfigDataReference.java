...
class StandardConfigDataReference {
	 ...
	 * @return true if the configuration data location is optional, or if the directory or
	 * profile is not null; false otherwise.
	 */
	boolean isSkippable() {
	...
	/**
	 * Compares this StandardConfigDataReference object to the specified object for
	 * equality. Returns true if the specified object is also a
	 * StandardConfigDataReference and their resourceLocation properties are equal.
