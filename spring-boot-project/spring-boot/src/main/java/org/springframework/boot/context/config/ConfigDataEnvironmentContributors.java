...
class ConfigDataEnvironmentContributors implements Iterable<ConfigDataEnvironmentContributor> {
	...
	/**
	 * Constructs a new instance of ConfigDataEnvironmentContributors with the specified
	 * logger, bootstrapContext, and root.
	 ...
	 * @param results the set of ConfigDataResolutionResult objects representing the
	 * imported resources
	...
	/**
	 * Returns the bootstrap context associated with this
	 * ConfigDataEnvironmentContributors instance.
	...
	/**
	 * Returns the next ConfigDataEnvironmentContributor to process from the given list of
	 * contributors.
	 ...
	 * @return {@code true} if the contributor is active with unprocessed imports,
	...
	/**
	 * Converts the imported {@link ConfigDataResolutionResult} and {@link ConfigData} map
	 * into a list of {@link ConfigDataEnvironmentContributor}. Each
	 * {@link ConfigDataEnvironmentContributor} represents a resolved configuration data
	 * source.
	 * @param imported the map of {@link ConfigDataResolutionResult} and
	 * {@link ConfigData} representing the imported configuration data
	 * @return the list of {@link ConfigDataEnvironmentContributor} representing the
	 * resolved configuration data sources
	 */
	...
	/**
	 * Returns a Binder object based on the provided activation context, filter, and
	 * options.
	...
	/**
	 * Returns an iterator of ConfigurationPropertySource objects obtained from the root
	 * contributors, filtered by the given predicate.
	...
	/**
	 * Checks if the given ConfigDataEnvironmentContributor has a configuration property
	 * source.
	 * @param contributor the ConfigDataEnvironmentContributor to check
	 * @return true if the contributor has a configuration property source, false
	 * otherwise
	 */
	...
	/**
	 * Returns an iterator over the elements in this ConfigDataEnvironmentContributors
	 * object.
	 * @return an iterator over the elements in this ConfigDataEnvironmentContributors
	 * object
	 */
	@Override
	...
	private static class ContributorDataLoaderContext implements ConfigDataLoaderContext {
		...
		/**
		 * Constructs a new instance of ContributorDataLoaderContext with the specified
		 * ConfigDataEnvironmentContributors.
		 * @param contributors the ConfigDataEnvironmentContributors to be used by the
	...
	private static class ContributorConfigDataLocationResolverContext implements ConfigDataLocationResolverContext {
		...
		/**
		 * Returns the binder associated with this
		 * ContributorConfigDataLocationResolverContext. If the binder is null, it
		 * retrieves the binder from the contributors using the activation context.
		 * @return the binder associated with this
		...
		/**
		 * Returns the parent ConfigDataResource of this
		 * ContributorConfigDataLocationResolverContext.
	...
	private class InactiveSourceChecker implements BindHandler {
		 ...
		 * @param activationContext the activation context to be used for checking
		 * inactive sources
		 */
		...
		/**
		 * This method is called when the binding process is successful. It checks if the
		 * given configuration property name is active for each
		 * ConfigDataEnvironmentContributor in the ConfigDataEnvironmentContributors list.
		 * If a contributor is not active, it throws an InactiveConfigDataAccessException
		 * if the property is found. Otherwise, it returns the result of the binding
		 * process.
