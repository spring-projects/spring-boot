...
public class UnsupportedDataSourcePropertyException extends RuntimeException {
	...
	/**
	 * Constructs a new UnsupportedDataSourcePropertyException with the specified detail
	 * message.
	...
	/**
	 * Throws an {@link UnsupportedDataSourcePropertyException} if the given test
	 * condition is true.
	 * @param test the boolean condition to test
	 * @param message a supplier that provides the error message to be used in the
	 * exception
