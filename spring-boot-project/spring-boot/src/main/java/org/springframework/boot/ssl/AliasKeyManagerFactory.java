...
final class AliasKeyManagerFactory extends KeyManagerFactory {
	...
	/**
	 * Constructs a new AliasKeyManagerFactory with the specified delegate, alias, and
	 * algorithm.
	...
	private static final class AliasKeyManagerFactorySpi extends KeyManagerFactorySpi {
		...
		/**
		 * Constructs a new AliasKeyManagerFactorySpi with the specified delegate
		 * KeyManagerFactory and alias.
		 ...
		 * @param managerFactoryParameters the ManagerFactoryParameters to initialize the
		 * engine with
		 * @throws InvalidAlgorithmParameterException if the ManagerFactoryParameters are
		 * unsupported
		 */
		@Override
		...
		/**
		 * Wraps the provided X509ExtendedKeyManager with an instance of
	...
	static final class AliasX509ExtendedKeyManager extends X509ExtendedKeyManager {
		...
		/**
		 * Constructs a new AliasX509ExtendedKeyManager with the specified
		 * X509ExtendedKeyManager and alias.
		...
		/**
		 * Returns the client alias to be used when selecting the certificate chain for
		 * the given SSL engine.
		...
		/**
		 * Returns the alias of the client certificate to be used for authentication
		 * during SSL/TLS handshake.
		 * @param keyType the acceptable key types for the client certificate, ordered by
		 * the client's preference
		 * @param issuers the acceptable certificate issuers for the client certificate,
		 * ordered by the client's preference
		 * @param socket the socket to be used for the SSL/TLS handshake
		 * @return the alias of the client certificate to be used for authentication, or
		 * null if no suitable client certificate is available
		 */
		@Override
