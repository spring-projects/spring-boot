...
class FilteredReactiveWebContextResource extends AbstractResource {
	...
	/**
	 * Creates a new resource by resolving the given relative path against the current
	 * resource's path.
	 * @param relativePath the relative path to resolve against the current resource's
	 * path
