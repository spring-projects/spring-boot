...
class ValueObjectBinder implements DataObjectBinder {
     ...
     *
     * @param constructorProvider the BindConstructorProvider to be used for binding value objects
     */
	...
	/**
     * Binds the given configuration property name to the target bindable object using the provided context and property binder.
     * 
	...
	/**
     * Creates a new instance of the specified target type using the provided binder context.
     * 
     * @param target the bindable target type
     * @param context the binder context
     * @return a new instance of the target type, or null if the value object could not be created
     */
    @Override
	...
	/**
     * This method is called when an instance of a bindable target cannot be created.
     * It attempts to retrieve the value object using the provided target, constructor provider, and context.
     * If an exception occurs during the retrieval process, it is added as a suppressed exception to the original exception.
     * 
     ...
     * @return a new instance of the default value for the given type, or null if not possible
     * @throws IllegalStateException if the parameter type does not allow empty default values
     */
     ...
     * @return {@code true} if the default value is allowed for an empty value of the given type, {@code false} otherwise
     */
	...
	/**
     * Checks if the given class is an aggregate type.
     * An aggregate type can be an array, a Map, or a Collection.
     * 
	...
	private abstract static class ValueObject<T> {
         ...
         *
         * @param constructor the constructor to be used for creating new instances of ValueObject
         */
		...
		/**
         * Instantiates a new instance of the ValueObject class using the provided arguments.
         * 
         ...
         *
         * @return a list of ConstructorParameter objects representing the constructor parameters
         */
         ...
         * @param constructorProvider     the BindConstructorProvider used to retrieve the bind constructor
         * @param context                 the Binder.Context object
         * @param parameterNameDiscoverer the ParameterNameDiscoverer used to discover parameter names
         * @param <T>                     the type of the ValueObject
         * @return the ValueObject for the given Bindable, or null if it cannot be retrieved
         */
        @SuppressWarnings("unchecked")
	...
	private static final class KotlinValueObject<T> extends ValueObject<T> {
		...
		/**
         * Constructs a new KotlinValueObject with the specified primary constructor, Kotlin constructor,
         * and type.
         *
         ...
         * @return a list of ConstructorParameter objects representing the parsed parameters
         */
		...
		/**
         * Returns a ValueObject instance based on the provided constructor, type, and parameter name discoverer.
         * 
         * @param bindConstructor the constructor to bind the ValueObject to
         * @param type the ResolvableType of the ValueObject
         * @param parameterNameDiscoverer the ParameterNameDiscoverer to use for resolving parameter names
	...
	private static final class DefaultValueObject<T> extends ValueObject<T> {
		...
		/**
         * Constructs a new DefaultValueObject with the specified constructor and constructor parameters.
         * 
         * @param constructor the constructor to be used for creating the DefaultValueObject
         * @param constructorParameters the list of constructor parameters to be used for creating the DefaultValueObject
         */
		...
		/**
         * Retrieves a ValueObject instance using the provided bindConstructor, type, and parameterNameDiscoverer.
         * 
         * @param bindConstructor The constructor to bind the ValueObject to.
         * @param type The ResolvableType of the ValueObject.
         * @param parameterNameDiscoverer The ParameterNameDiscoverer to use for retrieving parameter names.
         * @param <T> The type of the ValueObject.
         * @return A ValueObject instance with the specified bindConstructor and constructorParameters, or null if parameter names are not available.
         */
        @SuppressWarnings("unchecked")
		...
		/**
         * Parses the constructor parameters of a given constructor and returns a list of ConstructorParameter objects.
         * 
         ...
         * @return A list of ConstructorParameter objects representing the parsed constructor parameters.
         */
	...
	private static class ConstructorParameter {
		...
		/**
         * Constructs a new ConstructorParameter with the specified name, type, and annotations.
         * 
	...
	static final class Discoverer implements ParameterNameDiscoverer {
		...
		/**
         * Constructs a new Discoverer with the specified delegate and noParameterNamesHandler.
         *
         * @param delegate the ParameterNameDiscoverer delegate to be used
         * @param noParameterNamesHandler the Consumer<LogMessage> to handle cases where no parameter names are found
         */
         ...
         * @return an array of parameter names, or null if the parameter names cannot be discovered
