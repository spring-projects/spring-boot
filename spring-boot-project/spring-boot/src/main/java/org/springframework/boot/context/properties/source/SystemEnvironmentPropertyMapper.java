...
final class SystemEnvironmentPropertyMapper implements PropertyMapper {
	...
	/**
	 * Converts the given ConfigurationPropertyName to a string representation with the
	 * specified number of elements.
	 * @param name The ConfigurationPropertyName to convert
	 * @param numberOfElements The number of elements to include in the string
	 * representation
	...
	/**
	 * Converts a legacy name to a new name using the provided ConfigurationPropertyName
	 * object.
	...
	/**
	 * Converts a legacy name element to a standardized format. Replaces hyphens with
	 * underscores and converts the element to uppercase.
	...
	/**
	 * Returns a BiPredicate that checks if the first ConfigurationPropertyName is an
	 * ancestor of the second ConfigurationPropertyName.
	 * @return the BiPredicate that checks if the first ConfigurationPropertyName is an
	 * ancestor of the second ConfigurationPropertyName
	 */
	@Override
	...
	/**
	 * Checks if the given {@link ConfigurationPropertyName} is an ancestor of the
	 * candidate {@link ConfigurationPropertyName}. An ancestor is a property name that is
	 * a parent or grandparent of the candidate.
	 ...
	 * @return {@code true} if the given name is an ancestor of the candidate,
	...
	/**
	 * Checks if the given {@link ConfigurationPropertyName} is a legacy ancestor of the
	 * candidate {@link ConfigurationPropertyName}.
	 * @param name the {@link ConfigurationPropertyName} to check if it is a legacy
	 * ancestor
	 * @param candidate the candidate {@link ConfigurationPropertyName} to check against
	 * @return {@code true} if the given {@link ConfigurationPropertyName} is a legacy
	 * ancestor of the candidate, {@code false} otherwise
	 */
	...
	/**
	 * Builds a legacy compatible configuration property name by replacing dashes with
	 * dots.
