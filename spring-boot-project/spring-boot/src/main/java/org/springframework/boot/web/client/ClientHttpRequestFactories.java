...
public final class ClientHttpRequestFactories {
	...
	static class HttpComponents {
		...
		/**
		 * Returns an instance of {@link HttpComponentsClientHttpRequestFactory} with the
		 * specified settings.
		 * @param settings the {@link ClientHttpRequestFactorySettings} containing the
		...
		/**
		 * Creates a new {@link HttpComponentsClientHttpRequestFactory} with the specified
		 * read timeout and SSL bundle.
		 * @param readTimeout the read timeout for the HTTP request
		 * @param sslBundle the SSL bundle containing the SSL context, key store, and
		 * trust store
		 * @return a new {@link HttpComponentsClientHttpRequestFactory} with the specified
		 * read timeout and SSL bundle
		 */
		...
		/**
		 * Creates a new instance of HttpClient with the specified read timeout and SSL
		 * bundle.
	...
	static class OkHttp {
		...
		/**
		 * Creates an instance of {@link OkHttp3ClientHttpRequestFactory} with the
		 * provided {@link ClientHttpRequestFactorySettings}.
		 ...
		 * @param sslBundle the SSL bundle containing the SSL options, socket factory, and
		 * trust managers
		 ...
		 * @throws IllegalArgumentException if the trust material is not provided in the
		 * SSL bundle
		 */
	...
	static class Jetty {
		 ...
		 * @return a JettyClientHttpRequestFactory with the SSL context set, if sslBundle
		 * is not null; otherwise, a default JettyClientHttpRequestFactory
		 */
	...
	static class Jdk {
		...
		/**
		 * Creates a new instance of {@link java.net.http.HttpClient} with the specified
		 * connect timeout and SSL bundle.
		 * @param connectTimeout the duration to wait for a connection to be established
		 * @param sslBundle the SSL bundle containing the SSL context to be used for
		 * secure connections
	...
	static class Simple {
		...
		/**
		 * Returns a SimpleClientHttpRequestFactory based on the provided
		 * ClientHttpRequestFactorySettings. If an SslBundle is provided in the settings,
		 * a SimpleClientHttpsRequestFactory is created with the SslBundle. Otherwise, a
		 * SimpleClientHttpRequestFactory is created.
		 * @param settings the ClientHttpRequestFactorySettings to be used for creating
		 * the request factory
		 * @return a SimpleClientHttpRequestFactory based on the provided settings
		 * @throws IllegalStateException if SSL options are specified with Java
		 * connections
		 */
		...
		private static class SimpleClientHttpsRequestFactory extends SimpleClientHttpRequestFactory {
			...
			/**
			 * Constructs a new SimpleClientHttpsRequestFactory with the specified SSL
			 * bundle.
			 * @param sslBundle the SSL bundle containing the necessary SSL certificates
			 * and keys
			 */
	...
	static class Reflective {
		...
		/**
		 * Returns a client HTTP request factory based on the provided supplier and
		 * settings.
		 * @param requestFactorySupplier the supplier used to create the client HTTP
		 * request factory
		...
		/**
		 * Configures the given {@link ClientHttpRequestFactory} with the provided
		...
		/**
		 * Unwraps the given ClientHttpRequestFactory if it is an instance of
		 * AbstractClientHttpRequestFactoryWrapper. If the given requestFactory is not an
		 * instance of AbstractClientHttpRequestFactoryWrapper, it is returned as is.
		 ...
		 * @param factory the {@link ClientHttpRequestFactory} to set the connect timeout
		 * for
		 * @param connectTimeout the duration of the connect timeout
		 * @throws IllegalArgumentException if the connectTimeout is negative or exceeds
		 * the maximum value of an int
		 * @throws ReflectiveOperationException if an error occurs while invoking the
		 ...
		 * @throws IllegalArgumentException if the read timeout duration is negative or
		...
		/**
		 * Finds a method in the given {@link ClientHttpRequestFactory} class with the
		 * specified name and parameter types.
		 * @param requestFactory the {@link ClientHttpRequestFactory} instance to search
		 * for the method in
		 * @param methodName the name of the method to find
		 * @param parameters the parameter types of the method to find
		 * @return the found method
		 * @throws IllegalStateException if the request factory does not have a suitable
