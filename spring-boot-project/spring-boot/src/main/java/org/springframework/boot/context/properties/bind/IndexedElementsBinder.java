...
abstract class IndexedElementsBinder<T> extends AggregateBinder<T> {
	...
	/**
	 * Binds the indexed elements from the given configuration property source to the
	...
	/**
	 * Binds indexed elements from the given configuration property source to the
	...
	/**
	 * Retrieves the known indexed children of a given root configuration property name
	 * from a configuration property source.
	 * @param source The configuration property source to retrieve the children from.
	 * @param root The root configuration property name.
	 * @return A MultiValueMap containing the indexed children, where the key is the index
	 * and the value is the configuration property name.
	 */
	...
	/**
	 * Asserts that there are no unbound children in the given configuration property
	 * source.
	 * @param source the configuration property source
