...
public class Profiles implements Iterable<String> {
	...
	/**
	 * Returns a list of activated profiles based on the given environment, binder, and
	 * additional profiles.
	 ...
	 * @param additionalProfiles a collection of additional profiles to include in the
	 * result
	 ...
	 * @param environmentPropertyProfiles the set of profiles from the environment
	 * property
	...
	/**
	 * Expands the given list of profiles by recursively adding all the profiles that are
	 * included in the groups of the given profiles.
	...
	/**
	 * Returns a new list containing the elements of the input list in reverse order. If
	 * the input list is empty or null, an empty list is returned.
	 * @param list the input list to be reversed
	 * @return a new list with elements in reverse order, or an empty list if the input
	...
	/**
	 * Returns a list of unique items from the given profiles collection and additional
	 * collection.
	 * @param profiles the collection of profiles
	...
	private enum Type {
		 ...
		 * @param getter the function used to retrieve the profile values from the
		 * environment
		 * @param mergeWithEnvironmentProfiles true if the profile should be merged with
		 * environment profiles, false otherwise
		...
		/**
		 * Returns a boolean value indicating whether the profiles should be merged with
		 * environment profiles.
		 * @return {@code true} if the profiles should be merged with environment
		 * profiles, {@code false} otherwise.
		 */
