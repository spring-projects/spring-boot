...
public class LogFile {
	...
	/**
	 * Puts the specified value into the given properties object if the value is not
	 * empty.
	...
	/**
	 * Returns a string representation of the LogFile object. If the file path is not
	 * empty, it returns the file path. Otherwise, it returns the path of a default log
	 * file named "spring.log" in the specified directory.
