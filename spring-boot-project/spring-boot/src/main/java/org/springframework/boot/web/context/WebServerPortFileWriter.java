...
public class WebServerPortFileWriter implements ApplicationListener<WebServerInitializedEvent> {
	...
	/**
	 * This method is called when the web server is initialized. It creates a port file
	 * containing the port number of the web server.
	 * @param event The WebServerInitializedEvent object representing the web server
	 ...
	 * @param applicationContext the application context to retrieve the server namespace
	 * from
	 * @return the server namespace if the application context is an instance of
	 * WebServerApplicationContext, otherwise null
	 */
