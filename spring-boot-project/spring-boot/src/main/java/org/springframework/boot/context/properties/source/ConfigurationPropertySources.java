...
public final class ConfigurationPropertySources {
	 ...
	 * @return true if the property source is using the mutable property sources, false
	 * otherwise
	 */
	 ...
	 * @return the attached property source if found, or null if not found or if the
	 * sources parameter is null
	 */
	...
	/**
	 * Returns a stream of flattened and included property sources from the given
	...
	/**
	 * Flattens a given PropertySource into a Stream of PropertySource objects. If the
	 * source is an instance of ConfigurableEnvironment, it will extract and stream all
	 * the PropertySources from the ConfigurableEnvironment. Otherwise, it will return a
	 * Stream containing only the given PropertySource.
