...
public class ThreadPoolTaskExecutorBuilder {
	...
	/**
	 * Constructs a new ThreadPoolTaskExecutorBuilder with default values for all
	 * properties.
	 *
	 * The default values are as follows: - queueCapacity: null - corePoolSize: null -
	 * maxPoolSize: null - allowCoreThreadTimeOut: null - keepAlive: null -
	 * acceptTasksAfterContextClose: null - awaitTermination: null -
	 ...
	 * @param allowCoreThreadTimeOut whether core threads are allowed to time out and
	 * terminate
	 * @param keepAlive the amount of time that excess idle threads will wait for new
	 * tasks before terminating
	 * @param acceptTasksAfterContextClose whether to accept new tasks after the
	 * application context is closed
	 * @param awaitTermination whether to wait for the executor to terminate upon
	 * application context shutdown
	 * @param awaitTerminationPeriod the maximum amount of time to wait for the executor
	 * to terminate
	 * @param threadNamePrefix the prefix to use for thread names
	 * @param taskDecorator the task decorator to be applied to tasks executed by the
	 * executor
