...
public class Binder {
	...
	/**
	 * Binds the given configuration property name to the specified target using the
	 * provided bind handler.
	 * @param name the configuration property name to bind
	 * @param target the target to bind the configuration property to
	 * @param handler the bind handler to use for binding
	 * @param create a boolean indicating whether to create the target if it does not
	 * exist
	...
	/**
	 * Binds the given configuration property name to the specified target using the
	 * provided bind handler and context.
	 ...
	 * @param create flag indicating whether to create the target object if it does not
	 * exist
	 ...
	 * @param create a flag indicating whether to create a new instance if the result is
	 * null
	...
	/**
	 * Handles a binding error by invoking the appropriate handler and converting the
	 * result.
	...
	/**
	 * Binds the given configuration property name to the target object using the provided
	 * bind handler, context, and recursive binding flag.
	 * @param <T> the type of the target object
	 * @param name the configuration property name to bind
	 * @param target the target object to bind the configuration property to
	 ...
	 * @param allowRecursiveBinding flag indicating whether recursive binding is allowed
	 * @return the bound object, or null if the property is not found and the context
	 * depth is not 0
	 * @throws ConverterNotFoundException if a converter is not found for the property and
	 * recursive binding is not allowed
	 */
	...
	/**
	 * Returns the appropriate AggregateBinder based on the type of the target Bindable
	 * and the provided context.
	 * @param target the target Bindable object
	 * @param context the context object
	 * @return the appropriate AggregateBinder based on the type of the target Bindable
	 * and the provided context, or null if no appropriate binder is found
	 */
	...
	/**
	 * Binds an aggregate configuration property to a target object using the provided
	 * binder and handler.
	 * @param <T> the type of the target object
	 * @param name the name of the configuration property
	 * @param target the target object to bind the configuration property to
	...
	/**
	 * Finds a configuration property with the given name and target bindable in the given
	 * context.
	 * @param name the name of the configuration property
	 * @param target the target bindable
	...
	/**
	 * Binds a property to a target object using the provided context and configuration
	 * property.
	...
	/**
	 * Binds data to the specified target object using the given name, bind handler,
	 * context, and recursive binding flag.
	 * @param name The configuration property name to bind data from.
	 * @param target The target object to bind data to.
	 * @param handler The bind handler to use for binding.
	 * @param context The context for the binding operation.
	 * @param allowRecursiveBinding Flag indicating whether recursive binding is allowed.
	 * @return The bound data object, or null if the target object is unbindable or
	 * recursive binding is not allowed.
	 */
	...
	/**
	 * Binds the given data object using the specified bind method and applies the
	 * provided operation on the data object binder.
	 ...
	 * @return The result of the operation applied on the data object binder, or null if
	 * no result is found.
	 */
	...
	/**
	 * Determines if a bean can be unbound based on the given configuration property name,
	 * target bindable, and context.
	...
	/**
	 * Checks if none of the given configuration property sources contain any descendant
	 * of the specified configuration property name.
	 ...
	 * @return {@code true} if none of the sources contain any descendant of the specified
	...
	final class Context implements BindContext {
		...
		/**
		 * Increases the depth of the context. This method increments the depth variable
		 * by 1.
		 */
		...
		/**
		 * Decreases the depth of the context. This method decrements the depth variable
		 * by 1.
		 */
		...
		/**
		 * Executes the given supplier function with the provided
		 * ConfigurationPropertySource. If the source is null, the supplier function is
		 * executed without any source.
		 * @param source The ConfigurationPropertySource to be used during the execution
		 ...
		 * @return {@code true} if there are nested constructor bindings, {@code false}
		 * otherwise.
		 */
