...
public class InvalidConfigDataPropertyException extends ConfigDataException {
	...
	/**
	 * Constructs a new InvalidConfigDataPropertyException with the specified property,
	 * profileSpecific, replacement, and location.
	 ...
	 * @param replacement the ConfigurationPropertyName that should be used as a
	 * replacement
	 ...
	 * @param profileSpecific true if the property is in a profile specific resource,
	 * false otherwise
	 * @param replacement the replacement configuration property name, null if no
	 * replacement is needed
	 * @param location the location from which the property is imported, null if not
	 * imported
