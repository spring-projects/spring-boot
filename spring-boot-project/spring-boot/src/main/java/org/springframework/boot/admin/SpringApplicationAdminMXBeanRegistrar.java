...
public class SpringApplicationAdminMXBeanRegistrar implements ApplicationContextAware, GenericApplicationListener,
     ...
     * @throws IllegalStateException if the provided application context does not implement ConfigurableApplicationContext
     */
    @Override
	...
	/**
     * Returns the order of this bean in the bean execution order.
     ...
     * It checks if the application context of the event matches the current application context.
     * If they match, it sets the embeddedWebApplication flag to true.
     * 
     * @param event The WebServerInitializedEvent containing the initialized web server information.
     */
	...
	/**
     * This method is called after all properties have been set for the SpringApplicationAdminMXBeanRegistrar class.
     * It registers the SpringApplicationAdmin MBean with the MBeanServer using the provided objectName.
     * If debug logging is enabled, it logs a message indicating the registration of the MBean.
     *
     ...
     * It unregisters the MBean associated with the SpringApplicationAdminMXBeanRegistrar class from the platform MBean server.
     *
    ...
    private final class SpringApplicationAdmin implements SpringApplicationAdminMXBean {
		...
		/**
         * Returns a boolean value indicating whether the application is an embedded web application.
         * 
         ...
         * 
         * This method is called to initiate the shutdown of the application. It logs a message indicating that the shutdown has been requested and then closes the application context.
         * 
