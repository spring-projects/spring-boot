...
public final class CorrelationIdConverter extends LogEventPatternConverter {
	...
	/**
	 * Formats the given log event by appending the value of the context data to the
	 * provided StringBuilder.
	 * @param event the log event to be formatted
	 * @param toAppendTo the StringBuilder to which the formatted log event will be
	 * appended
	 */
	@Override
