...
public final class ConfigurationPropertyNameAliases implements Iterable<ConfigurationPropertyName> {
	...
	/**
	 * Constructs a new ConfigurationPropertyNameAliases object with the specified name
	 * and aliases.
	...
	/**
	 * Returns an iterator over the elements in this ConfigurationPropertyNameAliases
	 * object.
	 * @return an iterator over the elements in this ConfigurationPropertyNameAliases
	 * object
	 */
	@Override
