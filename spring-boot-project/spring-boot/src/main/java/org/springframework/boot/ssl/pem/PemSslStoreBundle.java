...
public class PemSslStoreBundle implements SslStoreBundle {
	...
	/**
	 * Constructs a new PemSslStoreBundle with the specified PEM key store, PEM trust
	 * store, and alias.
	 ...
	 * @param type the type of the KeyStore to create (optional, defaults to the default
	 * type)
	 ...
	 * @throws CertificateException if an error occurs while loading the KeyStore
	 * certificates
	 */
	...
	/**
	 * Adds a private key to the specified KeyStore with the given alias, key password,
	 ...
	 * @throws KeyStoreException if an error occurs while adding the private key to the
	 * KeyStore
	 */
