...
public final class ConfigurationPropertiesBean {
	...
	/**
	 * Constructs a new ConfigurationPropertiesBean with the specified name, instance, and
	 * bind target.
	...
	/**
	 * Retrieves all ConfigurationPropertiesBean instances from the given
	 * ConfigurableApplicationContext.
	 * @param applicationContext The ConfigurableApplicationContext from which to retrieve
	 * the ConfigurationPropertiesBean instances.
	 * @return A Map containing the ConfigurationPropertiesBean instances, with the bean
	 * name as the key and the ConfigurationPropertiesBean as the value.
	 */
	...
	/**
	 * Finds the factory method for the specified bean name in the given application
	 * context.
	 ...
	 * @throws IllegalStateException if the bean is not a {@code @ConfigurationProperties}
	 * value object
	 */
	...
	/**
	 * Finds and returns an array of annotations for the given instance, type, and factory
	 * method.
	 ...
	 * @param <A> the type of the annotation
	 * @return the merged annotation of the specified type, or a missing merged annotation
	 * if not found
	 */
	...
	/**
	 * Creates a new ConfigurationPropertiesBean with the specified name, instance, and
	 * bindTarget.
