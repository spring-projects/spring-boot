...
class ConfigDataResolutionResult {
	...
	/**
	 * Constructs a new ConfigDataResolutionResult with the specified location, resource,
	 * and profileSpecific flag.
	...
	/**
	 * Returns a boolean value indicating whether the configuration data resolution result
	 * is profile specific.
	 * @return true if the configuration data resolution result is profile specific, false
	 * otherwise
	 */
