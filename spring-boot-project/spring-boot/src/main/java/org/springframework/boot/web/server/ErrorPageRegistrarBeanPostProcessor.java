...
public class ErrorPageRegistrarBeanPostProcessor implements BeanPostProcessor, BeanFactoryAware {
     ...
     * <p>
     * This implementation checks if the provided beanFactory is an instance of ListableBeanFactory and throws
     * an IllegalArgumentException if it is not. It then assigns the provided beanFactory to the beanFactory
     * instance variable.
     *
     * @param beanFactory the BeanFactory that this bean runs in
     * @throws IllegalArgumentException if the provided beanFactory is not an instance of ListableBeanFactory
     */
    @Override
     ...
     * It checks if the bean is an instance of ErrorPageRegistry and if so, it calls the postProcessBeforeInitialization method with the errorPageRegistry as a parameter.
     * 
	...
	/**
     * Retrieves the collection of ErrorPageRegistrar instances.
     * If the collection is not already initialized, it initializes it by looking up the ErrorPageRegistrar beans
     * from the bean factory and sorting them based on their order.
     * The resulting collection is then made unmodifiable.
     *
