...
public class UndertowServletWebServerFactory extends AbstractServletWebServerFactory
	 ...
	 * @return {@code true} if the timeout duration is zero or less, {@code false}
	 * otherwise
	 */
	 ...
	 * @param deployment the DeploymentInfo object to which the locale mappings will be
	 * added
	 */
	...
	/**
	 * Registers the given ServletContextInitializers to drive the ServletContext
	 * initializers for the specified DeploymentInfo.
	 * @param deployment the DeploymentInfo to register the ServletContextInitializers
	 * with
	 ...
	 * Otherwise, the class loader of the UndertowServletWebServerFactory class is
	 * returned.
	...
	/**
	 * Returns the canonical document root for the given docBase. If docBase is null, a
	 * temporary directory is created and used as the document root.
	 ...
	 * @return the HttpHandlerFactory for handling cookies with SameSite attribute, or
	 * null if no SameSite attribute is configured
	 */
	...
	private static class Initializer implements ServletContainerInitializer {
		...
		/**
		 * Constructs a new Initializer with the specified array of
		 * ServletContextInitializers.
	...
	private static final class MetaInfResourcesResourceManager implements ResourceManager {
		...
		/**
		 * Constructs a new MetaInfResourcesResourceManager with the specified list of
		 * meta-inf resource jar URLs.
		 ...
		 * @return {@code false} if the resource change listener is not supported,
		 * {@code true} otherwise.
		 */
		@Override
		...
		/**
		 * Removes the specified resource change listener from this
		 ...
		 * @return the URLResource object representing the resource, or null if the
		 * resource is not found or an error occurs
		 */
	...
	private static final class LoaderHidingResourceManager implements ResourceManager {
		...
		/**
		 * Constructs a new LoaderHidingResourceManager with the specified delegate
		 * ResourceManager.
		 * @param delegate the delegate ResourceManager to be used by this
		 ...
		 * Retrieves a resource from the specified path.
		 * @param path the path of the resource to retrieve
		 * @return the retrieved resource, or null if the path starts with
		...
		/**
		 * Returns whether the resource change listener is supported by the underlying
		 * delegate.
		 * @return {@code true} if the resource change listener is supported,
	...
	private static class SuppliedSameSiteCookieHandler implements HttpHandler {
		...
		/**
		 * Constructs a new instance of SuppliedSameSiteCookieHandler with the specified
		 * HttpHandler and list of CookieSameSiteSupplier.
		 * @param next the HttpHandler to be invoked after processing the cookie
		 * @param suppliers the list of CookieSameSiteSupplier to be used for supplying
		 * the SameSite attribute value for cookies
		 */
		 ...
		 * @since 1.0
		 * @deprecated This method is marked for removal and should not be used in new
		 * code.
		 */
