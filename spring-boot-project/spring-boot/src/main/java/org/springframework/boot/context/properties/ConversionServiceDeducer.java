...
class ConversionServiceDeducer {
	 ...
	 * @param applicationContext the ApplicationContext to be used for dependency
	 * injection
	 */
	 ...
	 * @param applicationContext The ConfigurableApplicationContext to retrieve the
	 * ConversionServices from.
	 ...
	 * @return true if the application context contains a user-defined configuration
	 * service bean, false otherwise
	 */
	...
	private static class ConverterBeans {
		...
		/**
		 * Constructs a new ConverterBeans object with the given
		...
		/**
		 * Retrieves a list of beans of the specified type and qualifier from the given
		 * bean factory.
