...
class OriginTrackedYamlLoader extends YamlProcessor {
	...
	private class OriginTrackingConstructor extends SafeConstructor {
		...
		/**
		 * Constructs a new OriginTrackingConstructor object with the specified loading
		 * configuration.
		 * @param loadingConfig the loading configuration for the
		...
		/**
		 * Retrieves the data from the superclass and checks if it is an instance of
		 * CharSequence. If it is, it checks if the CharSequence is empty and returns null
		 * if it is. Otherwise, it returns the data.
	...
	private static class KeyScalarNode extends ScalarNode {
		...
		/**
		 * Constructs a new KeyScalarNode object by copying the properties of the provided
		 * ScalarNode.
		...
		/**
		 * Returns a new Node object based on the given Node. If the given Node is an
		 * instance of ScalarNode, it creates a new KeyScalarNode object based on it.
	...
	private static final class NoTimestampResolver extends Resolver {
		...
		/**
		 * Adds an implicit resolver for a specific tag with a given regular expression
		 * pattern, first match, and limit.
