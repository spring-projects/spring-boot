...
public class RootUriTemplateHandler implements UriTemplateHandler {
	...
	/**
	 * Applies the given URI template by appending it to the root URI. If the URI template
	 * starts with a forward slash, it is appended directly to the root URI. Otherwise,
	 * the URI template is returned as is.
