...
public final class LoggerGroups implements Iterable<LoggerGroup> {
	 ...
	 * @param namesAndMembers a Map containing the names of the logger groups as keys and
	 * a List of members as values
	 */
	 ...
	 * @param namesAndMembers the map containing the names and members of the logger
	 * groups
	 */
	...
	/**
	 * Adds a new LoggerGroup with the given name and members to the LoggerGroups
	 * collection.
	 ...
	 * @return the LoggerGroup object associated with the specified name, or null if no
	 * such LoggerGroup exists
	 */
