...
class NestedJarResourceSet extends AbstractSingleArchiveResourceSet {
	...
	/**
	 * Constructs a new NestedJarResourceSet with the specified URL, WebResourceRoot,
	 * webAppMount, and internalPath.
	...
	/**
	 * Initializes the internal state of the NestedJarResourceSet. This method is called
	 * during the initialization phase of the resource set's lifecycle. It establishes a
	 * connection to the JAR file and sets the manifest and base URL properties. If the
	 * connection does not use caches, the JAR file is closed after the necessary
	...
	/**
	 * Decreases the usage count of the JAR file and closes it. This method is
	...
	/**
	 * Performs garbage collection on the NestedJarResourceSet. This method is responsible
	 * for closing the archive if it is not being used and the useCaches flag is set to
	 * false. It also resets the archive and archiveEntries variables to null.
