...
public class IgnoreTopLevelConverterNotFoundBindHandler extends AbstractBindHandler {
	...
	/**
	 * This method is called when a binding fails due to a ConverterNotFoundException. It
	 * checks if the binding failure occurred at the top level and if so, returns null.
	 ...
	 * @return null if the binding failure occurred at the top level, otherwise rethrows
	 * the exception
