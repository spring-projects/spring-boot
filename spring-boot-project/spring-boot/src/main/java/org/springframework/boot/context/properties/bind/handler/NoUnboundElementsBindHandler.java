...
public class NoUnboundElementsBindHandler extends AbstractBindHandler {
	...
	/**
     * Constructs a new NoUnboundElementsBindHandler with the default BindHandler and a configuration property source filter that always returns true.
     */
	...
	/**
     * Constructs a new NoUnboundElementsBindHandler with the specified parent BindHandler and filter.
     * 
     * @param parent The parent BindHandler.
     * @param filter The filter function to determine if a ConfigurationPropertySource should be bound.
     */
	...
	/**
     * This method is overridden from the superclass BindHandler.
     * It is called when the binding process starts for a configuration property.
     * 
	...
	/**
     * This method is called when the binding process is successful for a configuration property.
     * It adds the bound property name to the list of bound names and returns the result of the super method.
     *
     * @param name    the name of the configuration property
	...
	/**
     * This method is called when a failure occurs during the binding process.
     * It handles the exception and returns the appropriate response.
     * 
	...
	/**
     * This method is called when the binding process is finished.
     * It checks if there are any unbound elements in the configuration and throws an exception if there are.
     * 
     * @param name the name of the configuration property
     * @param target the bindable target
     * @param context the bind context
	...
	/**
     * Checks if there are any unbound elements for the given configuration property name in the provided bind context.
     * Unbound elements refer to configuration properties that have not been successfully bound to any source.
     * 
     * @param name    the configuration property name to check for unbound elements
     * @param context the bind context containing the sources to check for unbound elements
     * @throws UnboundConfigurationPropertiesException if there are any unbound elements found
     */
	...
	/**
     * Collects unbound configuration properties from the given source based on the provided name.
     * 
	...
	/**
     * Checks if the given ConfigurationPropertyName candidate is an overridden collection element.
     * 
     ...
     * @return true if the nested zeroeth property is a valid property name, false otherwise
     */
     ...
     * @return an Indexed object if a numeric index is found in the candidate, null otherwise
     */
    ...
    private static final class Indexed {
		...
		/**
         * Constructs a new Indexed object with the specified name and nested property name.
         * 
