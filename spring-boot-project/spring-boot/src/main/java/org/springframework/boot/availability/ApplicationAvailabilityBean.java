...
public class ApplicationAvailabilityBean
	 ...
	 * @param defaultState the default state to return if the specified state type is not
	 * found
	 * @return the state of the specified availability state type, or the default state if
	 * not found
	 ...
	 * @param stateType the class representing the availability state type
	 * @return the last availability state of the specified type, or null if no state of
	 ...
	 * @param stateType the class representing the availability state type
	 * @return the last availability change event of the specified state type, or null if
	 * no event of the specified state type has occurred
	...
	/**
	 * This method is called when an AvailabilityChangeEvent is triggered. It stores the
	 * event in a map based on the state type.
