...
public class ErrorPage {
	 ...
	 * @return true if the specified object is equal to this ErrorPage object, false
	 * otherwise
	 */
	@Override
	 ...
	 *
	 * The hash code is calculated based on the exception name, path, and status code of
	 * the ErrorPage.
