...
public class EndpointWebMvcAutoConfigurationTests {
	...
	public void onSamePort() throws Exception {
		EnvironmentTestUtils.addEnvironment(this.applicationContext, "management.security.enabled:false");
	...
	public void onDifferentPort() throws Exception {
		...
		List<?> interceptors = (List<?>) ReflectionTestUtils
				.getField(managementContext.getBean(EndpointHandlerMapping.class), "interceptors");
		assertThat(interceptors).hasSize(2);
	}

	@Test
	public void onDifferentPortWithSpecificContainer() throws Exception {
		this.applicationContext.register(SpecificContainerConfig.class, RootConfig.class, DifferentPortConfig.class,
				EndpointConfig.class, BaseConfiguration.class, EndpointWebMvcAutoConfiguration.class,
		...
		EmbeddedServletContainerFactory managementContainerFactory = managementContext
				.getBean(EmbeddedServletContainerFactory.class);
		assertThat(parentContainerFactory).isInstanceOf(SpecificEmbeddedServletContainerFactory.class);
		assertThat(managementContainerFactory).isInstanceOf(SpecificEmbeddedServletContainerFactory.class);
	...
	public void onRandomPort() throws Exception {
		this.applicationContext.register(RootConfig.class, EndpointConfig.class, RandomPortConfig.class,
				BaseConfiguration.class, EndpointWebMvcAutoConfiguration.class, ErrorMvcAutoConfiguration.class);
	...
	public void disabled() throws Exception {
		this.applicationContext.register(RootConfig.class, EndpointConfig.class, DisableConfig.class,
				BaseConfiguration.class, EndpointWebMvcAutoConfiguration.class);
		this.applicationContext.refresh();
		assertContent("/controller", ports.get().server, "controlleroutput");
		assertContent("/endpoint", ports.get().server, null);
	...
	public void specificPortsViaProperties() throws Exception {
		EnvironmentTestUtils.addEnvironment(this.applicationContext, "server.port:" + ports.get().server,
				"management.port:" + ports.get().management, "management.security.enabled:false");
		this.applicationContext.register(RootConfig.class, EndpointConfig.class, BaseConfiguration.class,
	...
	public void contextPath() throws Exception {
		...
		this.applicationContext.register(RootConfig.class, EndpointConfig.class, ServerPortConfig.class,
				...
				EmbeddedServletContainerAutoConfiguration.class, HttpMessageConvertersAutoConfiguration.class,
	...
	public void portPropertiesOnSamePort() throws Exception {
		this.applicationContext.register(RootConfig.class, BaseConfiguration.class, ServerPortConfig.class,
	...
	public void portPropertiesOnDifferentPort() throws Exception {
		...
		assertThat(this.applicationContext.getBean(ServerPortConfig.class).getCount()).isEqualTo(2);
	}
	...
	public void endpointsAllDisabled() throws Exception {
		this.applicationContext.register(RootConfig.class, BaseConfiguration.class, ServerPortConfig.class,
				EndpointWebMvcAutoConfiguration.class);
		EnvironmentTestUtils.addEnvironment(this.applicationContext, "ENDPOINTS_ENABLED:false");
		this.applicationContext.refresh();
	...
	public void shutdownEndpointEnabled() {
		this.applicationContext.register(RootConfig.class, BaseConfiguration.class, ServerPortConfig.class,
				EndpointWebMvcAutoConfiguration.class);
		EnvironmentTestUtils.addEnvironment(this.applicationContext, "endpoints.shutdown.enabled:true");
		this.applicationContext.refresh();
		assertThat(this.applicationContext.getBeansOfType(ShutdownMvcEndpoint.class)).hasSize(1);
	}
	...
	public void actuatorEndpointEnabledIndividually() {
		...
		this.applicationContext.refresh();
		assertThat(this.applicationContext.getBeansOfType(HalJsonMvcEndpoint.class)).hasSize(1);
	}

	@Test
	public void managementSpecificSslUsingDifferentPort() throws Exception {
		EnvironmentTestUtils.addEnvironment(this.applicationContext, "management.ssl.enabled=true",
				"management.ssl.key-store=classpath:test.jks", "management.ssl.key-password=password");
		this.applicationContext.register(RootConfig.class, EndpointConfig.class, DifferentPortConfig.class,
				BaseConfiguration.class, EndpointWebMvcAutoConfiguration.class, ErrorMvcAutoConfiguration.class);
		this.applicationContext.refresh();
		assertContent("/controller", ports.get().server, "controlleroutput");
	...
	public void managementSpecificSslUsingSamePortFails() throws Exception {
		EnvironmentTestUtils.addEnvironment(this.applicationContext, "management.ssl.enabled=true",
				"management.ssl.key-store=classpath:test.jks", "management.ssl.key-password=password");
		this.applicationContext.register(RootConfig.class, EndpointConfig.class, BaseConfiguration.class,
				EndpointWebMvcAutoConfiguration.class, ErrorMvcAutoConfiguration.class, ServerPortConfig.class);
	...
	@Test
	public void samePortCanBeUsedWhenManagementSslIsExplicitlyDisabled() throws Exception {
		EnvironmentTestUtils.addEnvironment(this.applicationContext, "management.ssl.enabled=false");
		this.applicationContext.register(RootConfig.class, EndpointConfig.class, BaseConfiguration.class,
				EndpointWebMvcAutoConfiguration.class, ErrorMvcAutoConfiguration.class, ServerPortConfig.class);
		this.applicationContext.refresh();
	}
	...
	public void managementServerCanDisableSslWhenUsingADifferentPort() throws Exception {
		EnvironmentTestUtils.addEnvironment(this.applicationContext, "server.ssl.enabled=true",
				"server.ssl.key-store=classpath:test.jks", "server.ssl.key-password=password",
	...
	public void tomcatManagementAccessLogUsesCustomPrefix() throws Exception {
		this.applicationContext.register(TomcatContainerConfig.class, RootConfig.class, EndpointConfig.class,
				DifferentPortConfig.class, BaseConfiguration.class, EndpointWebMvcAutoConfiguration.class,
				ErrorMvcAutoConfiguration.class);
		...
		EmbeddedServletContainerFactory servletContainerFactory = managementContext
				.getBean(EmbeddedServletContainerFactory.class);
		assertThat(servletContainerFactory).isInstanceOf(TomcatEmbeddedServletContainerFactory.class);
	...
	public void undertowManagementAccessLogUsesCustomPrefix() throws Exception {
		this.applicationContext.register(UndertowContainerConfig.class, RootConfig.class, EndpointConfig.class,
				DifferentPortConfig.class, BaseConfiguration.class, EndpointWebMvcAutoConfiguration.class,
				ErrorMvcAutoConfiguration.class);
		EnvironmentTestUtils.addEnvironment(this.applicationContext, "server.undertow.accesslog.enabled: true");
		this.applicationContext.refresh();
		ApplicationContext managementContext = this.applicationContext.getBean(ManagementContextResolver.class)
				.getApplicationContext();
		EmbeddedServletContainerFactory servletContainerFactory = managementContext
				.getBean(EmbeddedServletContainerFactory.class);
		assertThat(servletContainerFactory).isInstanceOf(UndertowEmbeddedServletContainerFactory.class);
		assertThat(((UndertowEmbeddedServletContainerFactory) servletContainerFactory).getAccessLogPrefix())
	...
	private void endpointDisabled(String name, Class<? extends MvcEndpoint> type) {
		this.applicationContext.register(RootConfig.class, BaseConfiguration.class, ServerPortConfig.class,
				EndpointWebMvcAutoConfiguration.class);
		EnvironmentTestUtils.addEnvironment(this.applicationContext, String.format("endpoints.%s.enabled:false", name));
		this.applicationContext.refresh();
	...
	private void assertHttpsContent(String url, int port, Object expected) throws Exception {
	...
	public boolean hasHeader(String url, int port, String header) throws Exception {
		...
		ClientHttpRequest request = clientHttpRequestFactory.createRequest(new URI("http://localhost:" + port + url),
				HttpMethod.GET);
		ClientHttpResponse response = request.execute();
	...
	private static class GrabManagementPort implements ApplicationListener<EmbeddedServletContainerInitializedEvent> {
	...
	private static class SpecificEmbeddedServletContainerFactory extends TomcatEmbeddedServletContainerFactory {
