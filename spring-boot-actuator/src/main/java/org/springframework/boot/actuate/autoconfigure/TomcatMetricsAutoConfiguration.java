...
/**
 * {@link EnableAutoConfiguration Auto-configuration} that provides metrics on tomcat
 * usage.
 *
 * @author Johannes Stelzer
 * @since 1.2.0
 */
@ConditionalOnBean(EmbeddedTomcat.class)
@AutoConfigureAfter(EmbeddedTomcat.class)
