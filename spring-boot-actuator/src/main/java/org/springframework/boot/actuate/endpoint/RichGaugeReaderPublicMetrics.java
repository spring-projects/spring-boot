...
public class RichGaugeReaderPublicMetrics implements PublicMetrics {
	...
	private List<Metric<?>> convert(RichGauge richGauge) {
		...
		result.add(new Metric<Double>(richGauge.getName() + ".avg", richGauge
				.getAverage()));
		result.add(new Metric<Double>(richGauge.getName() + ".val", richGauge.getValue()));
		result.add(new Metric<Double>(richGauge.getName() + ".min", richGauge.getMin()));
		result.add(new Metric<Double>(richGauge.getName() + ".max", richGauge.getMax()));
		result.add(new Metric<Double>(richGauge.getName() + ".alpha", richGauge
				.getAlpha()));
		result.add(new Metric<Long>(richGauge.getName() + ".count", richGauge.getCount()));
