...
public class UserVehicleService {
	...
	/**
	 * Constructs a new UserVehicleService with the specified UserRepository and
	 ...
	 * @throws UserNameNotFoundException if the username is not found in the user
	 * repository
	 * @throws VehicleIdentificationNumberNotFoundException if the vehicle identification
	 * number (VIN) is not found for the user
