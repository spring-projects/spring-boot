...
class VersionOption {
	...
	static final class AlignedVersionOption extends VersionOption {
		...
		/**
		 * Constructs a new AlignedVersionOption with the specified DependencyVersion and
		 * VersionAlignment.
		 ...
		 * @return a string representation of the AlignedVersionOption object, including
		 * the alignment information with another version
		 */
		@Override
		public String toString() {
	...
	static final class ResolvedVersionOption extends VersionOption {
		...
		/**
		 * Constructs a new ResolvedVersionOption object with the specified dependency
		 * version and list of missing modules.
		 * @param version the dependency version for this ResolvedVersionOption
		 * @param missingModules the list of missing modules for this
		...
		/**
		 * Returns a string representation of the ResolvedVersionOption object. If there
		 * are no missing modules, the string representation is the same as the default
		 * toString() method. If there are missing modules, the string representation
		 * includes the missing modules in addition to the default toString() output.
