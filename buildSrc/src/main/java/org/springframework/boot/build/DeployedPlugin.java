...
public class DeployedPlugin implements Plugin<Project> {
	 ...
	 * Adds the Java component to the MavenPublication if the JAR task is enabled. Adds
	 * the JavaPlatform component to the MavenPublication if the JavaPlatformPlugin is
	 * applied.
