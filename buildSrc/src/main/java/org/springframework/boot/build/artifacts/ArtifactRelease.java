...
public final class ArtifactRelease {
	...
	/**
	 * Returns the download repository for the artifact release. If the release is a
	 * stable release, it returns the Maven repository. If the release is a snapshot
	 * release, it returns the Spring repository with the specified type.
