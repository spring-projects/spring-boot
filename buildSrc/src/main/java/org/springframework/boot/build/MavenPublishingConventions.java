...
class MavenPublishingConventions {
	...
	/**
	 * Applies the MavenPublishPlugin to the given project and customizes the
	 * MavenPublication.
	...
	/**
	 * Customizes the Maven publication by customizing the POM, Java Maven publication,
	 * and suppressing Maven optional feature warnings.
	 ...
	 * @param organization the MavenPomOrganization object containing the organization
	 * details
	 */
	 ...
	 * @param licences The MavenPomLicenseSpec object representing the licenses to be
	 * customized.
	 */
	 ...
	 * @param developers the MavenPomDeveloperSpec object representing the developers
	 * section
	 */
	...
	/**
	 * Checks if the given project is inherited from the "spring-boot-starter-parent" or
	 * "spring-boot-dependencies".
	 * @param project the project to check
	 * @return true if the project is inherited from "spring-boot-starter-parent" or
	 * "spring-boot-dependencies", false otherwise
	 */
