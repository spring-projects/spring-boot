...
/**
 * Configuration properties for the JDBC-backed OAuth2 authorization consent service.
 *
 * @author Chaitanya
 * @since 4.2.0
 */
@ConfigurationProperties("spring.security.oauth2.authorizationserver.consent.jdbc")
public class OAuth2AuthorizationConsentJdbcProperties extends DatabaseInitializationProperties {
