...
public class RegisteredClientDataSourceScriptDatabaseInitializer
		extends PropertiesBasedDataSourceScriptDatabaseInitializer<RegisteredClientJdbcProperties> {

	/**
	 * Create a new {@link RegisteredClientDataSourceScriptDatabaseInitializer} instance.
	 * @param dataSource the registered client data source
	 * @param properties the registered client JDBC properties
	 * @see #getSettings
	 */
	public RegisteredClientDataSourceScriptDatabaseInitializer(DataSource dataSource,
