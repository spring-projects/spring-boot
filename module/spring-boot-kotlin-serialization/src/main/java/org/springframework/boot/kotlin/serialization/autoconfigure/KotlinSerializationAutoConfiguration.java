...
public class KotlinSerializationAutoConfiguration {

	@Bean
	@ConditionalOnMissingBean
	public Json kotlinSerializationJson(List<KotlinSerializationJsonBuilderCustomizer> customizers) {
	...
	@Bean
	public StandardKotlinSerializationJsonBuilderCustomizer standardKotlinSerializationJsonBuilderCustomizer(
