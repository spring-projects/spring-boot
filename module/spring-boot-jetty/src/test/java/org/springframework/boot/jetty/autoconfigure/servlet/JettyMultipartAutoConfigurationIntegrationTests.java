...
/**
 * Tests for {@link MultipartAutoConfiguration} integrated in jetty. Tests an empty
 ...
 */
@DirtiesUrlFactories
class JettyMultipartAutoConfigurationIntegrationTests {
	...
	@Test
	void jettyWebServerWithoutAnyController() throws Exception {
		this.context = new AnnotationConfigServletWebServerApplicationContext(
				MultipartJettyIntegrationTestConfiguration.class);
	...
	@Test
	@ForkedClassPath
	void jettyWebServerWithNoMultipartConfiguration() {
	...
	@Test
	@ForkedClassPath
	void jettyWebServerWithAutomatedMultipartConfiguration() {
		this.context = new AnnotationConfigServletWebServerApplicationContext(ControllerConfiguration.class,
				MultipartConfiguration.class, MultipartJettyIntegrationTestConfiguration.class);
	...
	@Import({ JettyServletWebServerAutoConfiguration.class, MultipartAutoConfiguration.class })
	static class MultipartJettyIntegrationTestConfiguration {
