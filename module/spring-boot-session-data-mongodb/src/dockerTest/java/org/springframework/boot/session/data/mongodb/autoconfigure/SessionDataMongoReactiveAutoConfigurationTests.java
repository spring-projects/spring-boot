...
/**
 * Tests for the reactive support of {@link SessionDataMongoAutoConfiguration}.
 *
 * @author Andy Wilkinson
 * @author Weix Sun
 */
@Testcontainers(disabledWithoutDocker = true)
class SessionDataMongoReactiveAutoConfigurationTests extends AbstractSessionReactiveAutoConfigurationTests {
	...
	void prepareContextRunner() {
		this.contextRunner = new ReactiveWebApplicationContextRunner().withConfiguration(
				AutoConfigurations.of(SessionAutoConfiguration.class, SessionDataMongoAutoConfiguration.class,
