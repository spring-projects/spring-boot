...
/**
 * Tests for the servlet support of {@link SessionDataMongoAutoConfiguration}.
 *
 * @author Andy Wilkinson
 */
@Testcontainers(disabledWithoutDocker = true)
class SessionDataMongoAutoConfigurationTests extends AbstractSessionAutoConfigurationTests {
	...
	void prepareContextRunner() {
		this.contextRunner = new WebApplicationContextRunner()
			.withConfiguration(AutoConfigurations.of(MongoAutoConfiguration.class, DataMongoAutoConfiguration.class,
					SessionAutoConfiguration.class, SessionDataMongoAutoConfiguration.class))
