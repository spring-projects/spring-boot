...
/**
 * Tests for {@link RabbitMqAmqpContainerConnectionDetailsFactory}.
 *
 * @author Stephane Nicoll
 */
@SpringJUnitConfig
@Testcontainers(disabledWithoutDocker = true)
class RabbitMqAmqpContainerConnectionDetailsFactoryIntegrationTests {
	...
	void connectionCanBeMadeToRabbitMqContainer() throws Exception {
		...
		String address = container.createRandomQueue();
