...
/**
 * Tests for {@link ArtemisAmqpDockerComposeConnectionDetailsFactory}.
 *
 * @author Stephane Nicoll
 */
class ArtemisAmqpDockerComposeConnectionDetailsFactoryTests {
	...
	void getUserWhenHasActiveMqUser() {
		AmqpEnvironment environment = getAmqpEnvironment(Map.of("ARTEMIS_USER", "me"));
	...
	void getPasswordWhenHasActiveMqPassword() {
		AmqpEnvironment environment = getAmqpEnvironment(Map.of("ARTEMIS_PASSWORD", "secret"));
	...
	private AmqpEnvironment getAmqpEnvironment(Map<String, String> env) {
		...
		return new ArtemisAmqpDockerComposeConnectionDetailsFactory().getAmqpEnvironment(runningService);
	}
