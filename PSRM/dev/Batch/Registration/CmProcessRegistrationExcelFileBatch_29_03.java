...
import com.splwg.base.domain.common.foreignKeyReference.ForeignKeyReference_Id;
           ...
           // COTSInstanceNode documentsForm = boInstance.getGroup("documentsForm");*/
            ...
            while(count == 0) {
                ...
                employerQuery.getGroupFromPath("nineaNumber").set(AS_CURRENT, 
                		new BigDecimal(listesValues.get(count).toString()));
                count++;
              ...
              //------------------------------EmployeeRegistrationForm BO Creation----------------------------------------------------//
				...
				employeeRegistrationForm.getGroupFromPath("country").set(AS_CURRENT, getCounrtyCode(listesValues.get(count).toString()));
                count++;
