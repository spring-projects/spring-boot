...
public class SampleWsApplicationTests {
	...
	public void setUp() {
		this.webServiceTemplate
				.setDefaultUri("http://localhost:" + this.serverPort + "/Service/Hello");
	}

	@Test
	public void testHelloRequest() {
		final String request = "<q0:sayHello xmlns:q0=\"http://service.ws.sample/\"><myname>Raja</myname></q0:sayHello>";
