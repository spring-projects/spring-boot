...
case "$1" in
	...
	;;
	java15)
		 echo "https://github.com/AdoptOpenJDK/openjdk15-binaries/releases/download/jdk15u-2020-08-19-01-38/OpenJDK15U-jdk_x64_linux_hotspot_2020-08-19-01-38.tar.gz"
	;;
  *)
