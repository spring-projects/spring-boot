...
case "$1" in
	...
	;;
	java13)
		 echo "https://github.com/AdoptOpenJDK/openjdk13-binaries/releases/download/jdk13u-2019-08-10-12-43/OpenJDK13U-jdk_x64_linux_hotspot_2019-08-10-12-43.tar.gz"
	;;
  *)
