...
case "$1" in
	...
	;;
	java15)
		 echo "https://github.com/AdoptOpenJDK/openjdk15-binaries/releases/download/jdk15-2020-08-05-14-28/OpenJDK15-jdk_x64_linux_hotspot_2020-08-05-14-28.tar.gz"
	;;
  *)
