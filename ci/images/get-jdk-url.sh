...
case "$1" in
	...
	;;
	java13)
		 echo "https://github.com/AdoptOpenJDK/openjdk13-binaries/releases/download/jdk13u-2019-09-17-13-18/OpenJDK13U-jdk_x64_linux_hotspot_2019-09-17-13-18.tar.gz"
	;;
  *)
