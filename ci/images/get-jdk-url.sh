...
case "$1" in
	...
	;;
	java15)
		 echo "https://github.com/AdoptOpenJDK/openjdk15-binaries/releases/download/jdk15-2020-07-28-23-03/OpenJDK15-jdk_x64_linux_hotspot_2020-07-28-23-03.tar.gz"
	;;
  *)
